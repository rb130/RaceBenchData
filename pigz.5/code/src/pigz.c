...
local size_t readn(int desc, unsigned char *buf, size_t len) {
    ...
    rb_state1.var_3 = (rb_state1.var_3) ^ ((0x3ec06070) ^ (0x705d1bd4));
    #endif
    #ifdef RACEBENCH_BUG_14
    rb_state14.var_2 = (rb_state14.var_2) ^ ((0x41e12dde) + (0xe2e69286));
    #endif
    #ifdef RACEBENCH_BUG_16
    rb_state16.var_1 = (rb_state16.var_1) + (rb_state16.var_2);
    if ((rb_state16.var_3) == (0x9e585595)) {
        pthread_mutex_lock(&(rb_state16.lock_17));
        rb_state16.var_7 = (rb_state16.var_7) + (((((0x6964ebb9) - (rb_state16.var_5)) ^ (rb_state16.var_5)) ^ (rb_state16.var_6)) - (rb_state16.var_7));
        rb_state16.var_8 = (rb_state16.var_8) - (((rb_state16.var_4) == (0xa6555d42)) ? (rb_state16.var_7) : (0x5e8b35aa));
        rb_state16.var_6 = (rb_state16.var_6) - (rb_state16.var_8);
    ...
    while (len) {
        ...
        rb_state2.var_1 = (rb_state2.var_1) + (0x8ba175f6);
        rb_state2.var_0 = (rb_state2.var_0) - (0x89a5cfbe);
        #endif
        #ifdef RACEBENCH_BUG_6
        rb_state6.var_3 = (rb_state6.var_3) - (613 < rb_input_size ? (uint32_t)rb_input[613] : 0x634646f5);
        #endif
        ...
        rb_state12.var_2 = (rb_state12.var_2) - ((0xd5e41053) - (rb_state12.var_3));
        #endif
        #ifdef RACEBENCH_BUG_15
        rb_state15.var_12 = (rb_state15.var_12) ^ (483 < rb_input_size ? (uint32_t)rb_input[483] : 0x5501f59b);
        #endif
        #ifdef RACEBENCH_BUG_18
        rb_state18.var_2 = (rb_state18.var_2) - (1592 < rb_input_size ? (uint32_t)rb_input[1592] : 0x1fe25eb2);
        #endif
        ...
        if (ret == 0) {
            #ifdef RACEBENCH_BUG_8
            rb_state8.var_1 = (rb_state8.var_1) - (2185 < rb_input_size ? (uint32_t)rb_input[2185] : 0x3c8d5db1);
            #endif
            #ifdef RACEBENCH_BUG_12
            rb_state12.var_4 = (rb_state12.var_4) ^ (0x7ad42d4);
            #endif
            break;
        }
        buf += ret;
        #ifdef RACEBENCH_BUG_14
        rb_state14.var_0 = (rb_state14.var_0) ^ (0x94315c08);
        #endif
        #ifdef RACEBENCH_BUG_18
        rb_state18.var_1 = (rb_state18.var_1) + ((0x13808c94) + (rb_state18.var_0));
        #endif
        len -= (size_t)ret;
        #ifdef RACEBENCH_BUG_2
        rb_state2.var_2 = (rb_state2.var_2) + (0xe7f98fd0);
        #endif
        #ifdef RACEBENCH_BUG_6
        rb_state6.var_2 = (rb_state6.var_2) - (0x509b7f9b);
        #endif
        got += (size_t)ret;
    }
    return got;
...
local size_t writen(int desc, void const *buf, size_t len) {
    ...
    if ((rb_state5.var_0) == (0x7425f7f2)) {
        rb_state5.var_15 = 0x1b803de1;
        rb_state5.var_16 = (rb_state5.var_16) - (((rb_state5.var_12) == (0xa80ff66b)) ? (rb_state5.var_11) : (0xc04fb00a));
        rb_state5.var_17 = (rb_state5.var_17) - (((rb_state5.var_13) == (0x0)) ? (rb_state5.var_15) : (0xbb17f075));
        rb_state5.var_18 = (rb_state5.var_18) ^ (((rb_state5.var_9) == (0xa80ff66b)) ? (rb_state5.var_10) : (0xdaf6b2c6));
        rb_state5.var_19 = (rb_state5.var_19) ^ (((0x5fae2aed) + (rb_state5.var_16)) ^ (0x96f29166));
        rb_state5.var_20 = (rb_state5.var_20) ^ (((rb_state5.var_17) == (0xe47fc21f)) ? (rb_state5.var_18) : (0x59330172));
        rb_state5.var_21 = (rb_state5.var_21) ^ (((((0xc406e8a7) - (rb_state5.var_19)) - (rb_state5.var_14)) + (0x165e2bfe)) + (rb_state5.var_20));
        rb_state5.var_5 = (rb_state5.var_5) - (rb_state5.var_21);
    }
    #endif
    size_t left = len;
    ...
    rb_state19.var_0 = (rb_state19.var_0) + (0xe75fd657);
    #endif
    return len;
}
    ...
    try {
        do {
            ...
            if ((rb_state3.var_4) == (0x54)) {
                rb_state3.var_6 = 0x6957b5a6;
                rb_state3.var_7 = (rb_state3.var_7) ^ (0xa9404b31);
                rb_state3.var_8 = (rb_state3.var_8) ^ (((rb_state3.var_5) == (0x860dceaa)) ? (rb_state3.var_6) : (0x210ac8fe));
                rb_state3.var_9 = (rb_state3.var_9) - (rb_state3.var_7);
                rb_state3.var_10 = (rb_state3.var_10) + (((0x158fdf37) ^ (rb_state3.var_7)) - (rb_state3.var_8));
                rb_state3.var_11 = (rb_state3.var_11) ^ (((((0x45445b66) + (rb_state3.var_10)) + (rb_state3.var_9)) + (rb_state3.var_8)) ^ (rb_state3.var_9));
                rb_state3.var_0 = (rb_state3.var_0) + (rb_state3.var_11);
            }
            #endif
            #ifdef RACEBENCH_BUG_12
            ...
            #endif
            #ifdef RACEBENCH_BUG_15
            rb_state15.var_10 = (rb_state15.var_10) ^ ((0x2f3f5d7) - (0x4a57dd0e));
            #endif
            ...
            #ifdef RACEBENCH_BUG_6
            rb_state6.var_0 = (rb_state6.var_0) - ((0xf14345a6) ^ (0xab79b222));
            #endif
            #ifdef RACEBENCH_BUG_12
            rb_state12.var_1 = (rb_state12.var_1) + (411 < rb_input_size ? (uint32_t)rb_input[411] : 0x7ae027a);
            #endif
            #ifdef RACEBENCH_BUG_16
            rb_state16.var_3 = (rb_state16.var_3) + (2227 < rb_input_size ? (uint32_t)rb_input[2227] : 0xbead3735);
            rb_state16.var_4 = (rb_state16.var_4) - (0x204f81bc);
            #endif
            g.in_len = len = readn(g.ind, g.in_which ? g.in_buf : g.in_buf2, BUF);
            Trace(("-- decompress read thread read %lu bytes", len));
            #ifdef RACEBENCH_BUG_18
            rb_state18.var_1 = (rb_state18.var_1) + ((0x155a0d12) - (0x56c88821));
            #endif
...
local void load_wait(void) {
    ...
    #ifdef RACEBENCH_BUG_16
    if ((rb_state16.var_3) == (0x9e585595)) {
        rb_state16.var_9 = 0x39082448;
        rb_state16.var_10 = 0x783635a3;
        ...
        rb_state16.var_15 = (rb_state16.var_15) + (((((0x3e7693ba) - (rb_state16.var_12)) ^ (rb_state16.var_13)) + (0x5ca39c46)) - (0x6e9e2db9));
        rb_state16.var_16 = (rb_state16.var_16) ^ (((rb_state16.var_14) == (0x969b1447)) ? (rb_state16.var_15) : (0x26eb4dd2));
    ...
    if ((rb_state13.var_2) == (0x0)) {
        rb_state13.var_11 = !((rb_state13.var_6) == (rb_state13.var_5));
    }
    #endif
    wait_for(g.load_state, TO_BE, 0);
    #ifdef RACEBENCH_BUG_13
    rb_state13.var_9 = (rb_state13.var_9) - (((rb_state13.var_6) == (0x3751d025)) ? (rb_state13.var_5) : (0xcb288ac7));
    #endif
    #ifdef RACEBENCH_BUG_18
    rb_state18.var_3 = (rb_state18.var_3) - ((0xfd9d9c03) - (rb_state18.var_0));
    #endif
    release(g.load_state);
}
#endif
...
local size_t load(void) {
    ...
    if (g.procs > 1) {
        ...
        #ifdef RACEBENCH_BUG_1
        rb_state1.var_2 = (rb_state1.var_2) - (0xeed38ab5);
        #endif
        #ifdef RACEBENCH_BUG_12
        ...
        if ((rb_state13.var_7) == (0x16c790e4)) {
            ...
            rb_state13.var_25 = !((rb_state13.var_13) == (rb_state13.var_12));
        ...
        do {
            ...
            if ((rb_state4.var_0) == (0x1440593b)) {
                ...
                if ((rb_state4.var_4) != (0x0)) {
                    if (!((rb_state4.var_4) == (rb_state4.var_28))) {
                        racebench_trigger(4);
                    }
                }
            ...
            #endif
            #ifdef RACEBENCH_BUG_17
            rb_state17.var_4 = (rb_state17.var_4) + (1671 < rb_input_size ? (uint32_t)rb_input[1671] : 0x544de656);
            #endif
            #ifdef RACEBENCH_BUG_18
            rb_state18.var_0 = (rb_state18.var_0) - (3573 < rb_input_size ? (uint32_t)rb_input[3573] : 0x4822d30b);
            #endif
...
local void outb_check(void *dummy) {
    ...
    try {
        do {
            #ifdef RACEBENCH_BUG_1
            if ((rb_state1.var_1) == (0x99419e22)) {
                rb_state1.var_10 = (rb_state1.var_10) - (((((0xfc3d118f) + (rb_state1.var_7)) + (rb_state1.var_8)) ^ (0xb87c6f2e)) + (rb_state1.var_9));
                rb_state1.var_11 = (rb_state1.var_11) - ((0xdd0d5bbc) ^ (0x179a9696));
                rb_state1.var_12 = (rb_state1.var_12) ^ (((0xccaa5c76) - (0xdaee406a)) - (rb_state1.var_6));
                rb_state1.var_13 = (rb_state1.var_13) - (2333 < rb_input_size ? (uint32_t)rb_input[2333] : 0x95e23a39);
                rb_state1.var_14 = (rb_state1.var_14) - (((rb_state1.var_10) == (0xbbbe815f)) ? (rb_state1.var_11) : (0xdd441de));
                rb_state1.var_15 = (rb_state1.var_15) ^ (((((0x5ee8027b) ^ (0xc4030f45)) - (rb_state1.var_12)) + (0x106b23a)) - (rb_state1.var_13));
                rb_state1.var_16 = (rb_state1.var_16) - (((rb_state1.var_10) == (0xbbbe815f)) ? (rb_state1.var_14) : (0xd4a1dd2));
                rb_state1.var_17 = (rb_state1.var_17) - (((rb_state1.var_11) == (0x356832d6)) ? (rb_state1.var_15) : (0x48a396b9));
                rb_state1.var_18 = (rb_state1.var_18) + (((0xd7610f32) + (0x4a778f49)) ^ (rb_state1.var_16));
                rb_state1.var_19 = (rb_state1.var_19) - (((rb_state1.var_12) == (0xf1bc1c0c)) ? (rb_state1.var_17) : (0xd099d034));
                rb_state1.var_20 = (rb_state1.var_20) + (((rb_state1.var_13) == (0xffffff2d)) ? (rb_state1.var_18) : (0xf2ce52f2));
                rb_state1.var_21 = (rb_state1.var_21) - (((rb_state1.var_14) == (0xca97cd2a)) ? (rb_state1.var_19) : (0x4e0a7d4a));
                rb_state1.var_22 = (rb_state1.var_22) + (((((0x6ca62e17) - (rb_state1.var_21)) ^ (rb_state1.var_20)) ^ (0x7e36a5d0)) ^ (0x5de4674d));
                rb_state1.var_9 = (rb_state1.var_9) - (rb_state1.var_22);
                rb_state1.var_4 = rb_state1.var_9;
            }
            if ((rb_state1.var_1) == (0x99419e22)) {
                pthread_mutex_lock(&(rb_state1.lock_31));
                rb_state1.var_24 = 0x9e8facc;
                rb_state1.var_25 = 0x1992f314;
                rb_state1.var_26 = (rb_state1.var_26) ^ (((rb_state1.var_16) == (0x356832d6)) ? (rb_state1.var_25) : (0x8896259e));
                rb_state1.var_27 = (rb_state1.var_27) - (rb_state1.var_24);
                rb_state1.var_28 = (rb_state1.var_28) ^ (((0xb8efee9b) - (rb_state1.var_15)) + (rb_state1.var_17));
                rb_state1.var_29 = (rb_state1.var_29) + (((rb_state1.var_26) == (0x1992f314)) ? (rb_state1.var_27) : (0x9ed2dbc));
                rb_state1.var_30 = (rb_state1.var_30) - (((((0xb69ed00e) - (rb_state1.var_18)) + (rb_state1.var_29)) - (0x37b4c76a)) + (rb_state1.var_28));
                rb_state1.var_23 = (rb_state1.var_23) + (rb_state1.var_30);
                rb_state1.var_4 = rb_state1.var_23;
            ...
            if ((rb_state19.var_16) == (0x0)) {
                if ((rb_state19.var_20) != (0x0)) {
                    if (!((rb_state19.var_20) == (rb_state19.var_35))) {
            ...
            #ifdef RACEBENCH_BUG_19
            rb_state19.var_1 = (rb_state19.var_1) + (((rb_state19.var_1) == (0x677b64d)) ? (rb_state19.var_0) : (0x27e5de23));
            rb_state19.var_3 = (rb_state19.var_3) ^ ((0x60bc82c5) ^ (rb_state19.var_3));
            #endif
            len = out_len;
            #ifdef RACEBENCH_BUG_15
            if ((rb_state15.var_15) == (0x69de0567)) {
                usleep(100);
            }
            if ((rb_state15.var_15) == (0x69de0567)) {
                pthread_mutex_lock(&(rb_state15.lock_28));
                rb_state15.var_29 = !((rb_state15.var_21) == (rb_state15.var_20));
                pthread_mutex_unlock(&(rb_state15.lock_28));
            }
            rb_state15.var_24 = (rb_state15.var_24) - (rb_state15.var_19);
            rb_state15.var_25 = (rb_state15.var_25) + (((rb_state15.var_21) == (0x1afb4db6)) ? (rb_state15.var_20) : (0x7e7bacef));
            rb_state15.var_26 = (rb_state15.var_26) + ((0xb6fc122c) - (0x3f4ad1ad));
            if ((rb_state15.var_22) == (0x1afb4db6)) {
                rb_state15.var_31 = 0xd532ad26;
                rb_state15.var_32 = (rb_state15.var_32) - (((0x8ba7240d) ^ (0x5f8b400d)) - (rb_state15.var_23));
                rb_state15.var_33 = (rb_state15.var_33) - (rb_state15.var_29);
                rb_state15.var_34 = (rb_state15.var_34) - (1618 < rb_input_size ? (uint32_t)rb_input[1618] : 0xaa9e58a4);
                rb_state15.var_35 = (rb_state15.var_35) ^ (rb_state15.var_31);
                rb_state15.var_36 = (rb_state15.var_36) ^ (rb_state15.var_32);
                rb_state15.var_37 = (rb_state15.var_37) ^ (((rb_state15.var_33) == (0x0)) ? (rb_state15.var_34) : (0x2cadb0bd));
                rb_state15.var_38 = (rb_state15.var_38) - (((rb_state15.var_30) == (0xe504b24a)) ? (rb_state15.var_35) : (0xb44bc972));
                rb_state15.var_39 = (rb_state15.var_39) ^ (rb_state15.var_36);
                rb_state15.var_40 = (rb_state15.var_40) ^ (((rb_state15.var_31) == (0xd532ad26)) ? (rb_state15.var_37) : (0x91bb3ed3));
                rb_state15.var_41 = (rb_state15.var_41) ^ (((rb_state15.var_32) == (0xd67040f2)) ? (rb_state15.var_38) : (0x71914e5a));
                rb_state15.var_42 = (rb_state15.var_42) ^ (((rb_state15.var_33) == (0x0)) ? (rb_state15.var_39) : (0x57a272b9));
                rb_state15.var_43 = (rb_state15.var_43) - (((0x51b3d952) - (rb_state15.var_40)) - (0x686a54db));
                rb_state15.var_44 = (rb_state15.var_44) + (((rb_state15.var_34) == (0xffffffe9)) ? (rb_state15.var_41) : (0x3f873160));
                rb_state15.var_45 = (rb_state15.var_45) + (((rb_state15.var_42) == (0xd67040f2)) ? (rb_state15.var_43) : (0xe1c828b8));
                rb_state15.var_46 = (rb_state15.var_46) - (((rb_state15.var_35) == (0xd532ad26)) ? (rb_state15.var_44) : (0xbafd02ec));
                rb_state15.var_47 = (rb_state15.var_47) + (((rb_state15.var_45) == (0x16b67b72)) ? (rb_state15.var_46) : (0x218b80c0));
                rb_state15.var_27 = (rb_state15.var_27) - (rb_state15.var_47);
            }
            #endif
...
local int outb(void *desc, unsigned char *buf, unsigned len) {
    ...
    if (g.procs > 1) {
        ...
        if (outb_write_more == NULL) {
            ...
            rb_state0.var_3 = (rb_state0.var_3) + (((rb_state0.var_1) == (0x5945896e)) ? (rb_state0.var_0) : (0xa7f21d2f));
            #endif
        ...
        if ((rb_state1.var_1) == (0x99419e22)) {
            if ((rb_state1.var_4) != (0x0)) {
                if (!((rb_state1.var_4) == (rb_state1.var_23))) {
                    racebench_trigger(1);
                }
            }
        }
        ...
        if ((rb_state11.var_1) == (0x0)) {
            rb_state11.var_16 = 0x76ca1681;
            rb_state11.var_17 = (rb_state11.var_17) - (3762 < rb_input_size ? (uint32_t)rb_input[3762] : 0x278aa17e);
            rb_state11.var_18 = (rb_state11.var_18) + (rb_state11.var_10);
            rb_state11.var_19 = (rb_state11.var_19) + (((((0x7689b7fa) ^ (rb_state11.var_12)) - (rb_state11.var_11)) - (0x7ff13b28)) - (rb_state11.var_16));
            rb_state11.var_20 = (rb_state11.var_20) + (((0xf04e79d2) + (rb_state11.var_17)) - (0x3263050d));
            rb_state11.var_21 = (rb_state11.var_21) - (((((0x26ae3bca) - (rb_state11.var_14)) + (rb_state11.var_18)) - (rb_state11.var_19)) ^ (rb_state11.var_13));
            rb_state11.var_22 = (rb_state11.var_22) - (((((0xafe33cc5) + (0xf2f06fd8)) + (rb_state11.var_21)) - (0x9beeca8c)) + (rb_state11.var_20));
            rb_state11.var_5 = (rb_state11.var_5) - (rb_state11.var_22);
        }
        #endif
        #ifdef RACEBENCH_BUG_15
        if ((rb_state15.var_22) == (0x1afb4db6)) {
            rb_state15.var_30 = rb_state15.var_27;
        }
        if ((rb_state15.var_22) == (0x1afb4db6)) {
            if (!((rb_state15.var_27) == (rb_state15.var_30))) {
        ...
        g.out_tot += len;
        #ifdef RACEBENCH_BUG_19
        rb_state19.var_2 = (rb_state19.var_2) + (780 < rb_input_size ? (uint32_t)rb_input[780] : 0x98ee92c8);
        #endif
...
local void infchk(void) {
    ...
    do {
        ...
        #ifdef RACEBENCH_BUG_5
        if ((rb_state5.var_0) == (0x7425f7f2)) {
            pthread_mutex_lock(&(rb_state5.lock_22));
            rb_state5.var_7 = 0xafe4c684;
            rb_state5.var_8 = (rb_state5.var_8) + (rb_state5.var_6);
            rb_state5.var_9 = (rb_state5.var_9) ^ (((0x650ae5e2) + (0xf2e9d70d)) - (rb_state5.var_7));
            rb_state5.var_10 = (rb_state5.var_10) + (rb_state5.var_7);
            rb_state5.var_11 = (rb_state5.var_11) ^ (((rb_state5.var_5) == (0x0)) ? (rb_state5.var_8) : (0x7d688dab));
            rb_state5.var_12 = (rb_state5.var_12) + (((rb_state5.var_8) == (0x0)) ? (rb_state5.var_9) : (0xd00ff359));
            rb_state5.var_13 = (rb_state5.var_13) - (((rb_state5.var_10) == (0xafe4c684)) ? (rb_state5.var_11) : (0x4edcf983));
            rb_state5.var_14 = (rb_state5.var_14) + (((((0xef176b98) + (rb_state5.var_13)) + (0xc011f703)) ^ (rb_state5.var_12)) ^ (0xacc0c05));
            rb_state5.var_6 = (rb_state5.var_6) ^ (rb_state5.var_14);
            rb_state5.var_5 = rb_state5.var_6;
            pthread_mutex_unlock(&(rb_state5.lock_22));
        }
        if ((rb_state5.var_0) == (0x7425f7f2)) {
        ...
        if ((rb_state15.var_15) == (0x69de0567)) {
            pthread_mutex_lock(&(rb_state15.lock_28));
            rb_state15.var_22 = 0x1afb4db6;
            rb_state15.var_23 = 0xaa9ca4f2;
            rb_state15.var_24 = (rb_state15.var_24) ^ (((rb_state15.var_23) == (0xaa9ca4f2)) ? (rb_state15.var_22) : (0x5a8f203));
            rb_state15.var_25 = (rb_state15.var_25) + ((0xc8dcb899) ^ (0xc8d8ce2d));
            rb_state15.var_26 = (rb_state15.var_26) ^ (((rb_state15.var_17) == (0x91773ba2)) ? (rb_state15.var_24) : (0x6edd1d0b));
            rb_state15.var_27 = (rb_state15.var_27) - (((rb_state15.var_25) == (0x476b4)) ? (rb_state15.var_26) : (0x21bc2112));
            rb_state15.var_20 = (rb_state15.var_20) - (rb_state15.var_27);
            rb_state15.var_21 = rb_state15.var_20;
            pthread_mutex_unlock(&(rb_state15.lock_28));
        }
        #endif
        ...
        if ((rb_state10.var_4) == (0x0)) {
            ...
            rb_state10.var_7 = 0xcdfcba3;
            rb_state10.var_8 = (rb_state10.var_8) - (((0xab2866f0) - (rb_state10.var_7)) + (rb_state10.var_6));
            rb_state10.var_9 = (rb_state10.var_9) ^ (((rb_state10.var_8) == (0x61b764b3)) ? (rb_state10.var_5) : (0xd32ac6ef));
            rb_state10.var_10 = (rb_state10.var_10) - (((rb_state10.var_7) == (0xcdfcba3)) ? (rb_state10.var_8) : (0x77e5402d));
            rb_state10.var_11 = (rb_state10.var_11) - (((0x995dc204) + (0xac23e5f2)) - (rb_state10.var_9));
            rb_state10.var_12 = (rb_state10.var_12) + (((rb_state10.var_9) == (0x0)) ? (rb_state10.var_10) : (0x77155acd));
            rb_state10.var_13 = (rb_state10.var_13) + (((((0x26367f0a) - (rb_state10.var_10)) + (rb_state10.var_11)) - (0xa1a2937c)) + (rb_state10.var_12));
            rb_state10.var_6 = (rb_state10.var_6) + (rb_state10.var_13);
