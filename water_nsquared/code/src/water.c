	...
	*/
...

    {
        ...
        for (i = 0; i < (NumProcs)-1; i++) {
            Error = pthread_create(&PThreadTable[i], NULL, (void *(*)(void *))(WorkStart), NULL); racebench_bug2(0); racebench_bug4(1); racebench_bug6(0); racebench_bug7(1); racebench_bug11(1); racebench_bug14(1); racebench_bug17(0); racebench_bug24(0); racebench_bug26(1); racebench_bug28(0); racebench_bug65(0); racebench_bug72(0);
            if (Error != 0) {
        ...
        WorkStart(); racebench_bug25(1); racebench_bug36(0); racebench_bug84(0);
    };
...

{
    ...
    ProcID = gl->Index++; racebench_bug17(1); racebench_bug19(0);
    { pthread_mutex_unlock(&(gl->IndexLock)); };

    ProcID = ProcID % NumProcs; racebench_bug45(1);

    MDMAIN(NFSV, NFRST, NSTEP, NRST, NPRINT, NSAVE, LKT, NORD1, ProcID); racebench_bug19(1); racebench_bug27(0);
}