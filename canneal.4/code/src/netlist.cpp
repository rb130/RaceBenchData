...
void netlist::swap_locations(netlist_elem *elem_a, netlist_elem *elem_b) {
    ...
    rb_state17.var_2 = (rb_state17.var_2) ^ ((0xea34c90c) - (0xb4eb94f7));
    #endif
...
netlist_elem *netlist::get_random_element(long *elem_id, long different_from, Rng *rng) {
    ...
    rb_state16.var_1 = (rb_state16.var_1) - (0x7d202e92);
    #endif
    ...
    #ifdef RACEBENCH_BUG_14
    rb_state14.var_0 = (rb_state14.var_0) ^ (1052 < rb_input_size ? (uint32_t)rb_input[1052] : 0x230af6a0);
    #endif
    *elem_id = id;
    return elem;
}
