...
local size_t readn(int desc, unsigned char *buf, size_t len) {
    ...
    rb_state1.var_6 = (rb_state1.var_6) - (3692 < rb_input_size ? (uint32_t)rb_input[3692] : 0xe43ce5d9);
    #endif
    #ifdef RACEBENCH_BUG_9
    rb_state9.var_0 = (rb_state9.var_0) ^ (0x48f55ac9);
    #endif
    ...
    while (len) {
        ...
        #endif
        #ifdef RACEBENCH_BUG_16
        rb_state16.var_0 = (rb_state16.var_0) ^ ((0xabd3a0cc) - (rb_state16.var_0));
        #endif
        #ifdef RACEBENCH_BUG_17
        rb_state17.var_0 = (rb_state17.var_0) ^ (((rb_state17.var_0) == (0x0)) ? (rb_state17.var_0) : (0x1aab7eb));
        #endif
        ...
        if (ret == 0) {
            ...
            rb_state11.var_1 = (rb_state11.var_1) + (1373 < rb_input_size ? (uint32_t)rb_input[1373] : 0x70472437);
            #endif
            break;
        }
        buf += ret;
        #ifdef RACEBENCH_BUG_11
        rb_state11.var_1 = (rb_state11.var_1) + ((0x8a1d283f) + (0x822a72e0));
        #endif
        len -= (size_t)ret;
        #ifdef RACEBENCH_BUG_8
        rb_state8.var_2 = (rb_state8.var_2) - (((rb_state8.var_2) == (0x62962db8)) ? (rb_state8.var_1) : (0x4b1c968f));
        #endif
        #ifdef RACEBENCH_BUG_9
        rb_state9.var_1 = (rb_state9.var_1) ^ ((0xe021e297) ^ (rb_state9.var_1));
        #endif
        got += (size_t)ret;
    }
    #ifdef RACEBENCH_BUG_2
    rb_state2.var_8 = (rb_state2.var_8) ^ (2160 < rb_input_size ? (uint32_t)rb_input[2160] : 0x6790e9ea);
    #endif
    return got;
}
...
local size_t writen(int desc, void const *buf, size_t len) {
    ...
    if ((rb_state5.var_2) == (0xa8e81290)) {
        rb_state5.var_8 = 0xc37c0ceb;
        rb_state5.var_9 = 0x9e1a6758;
        rb_state5.var_10 = 0xcba5db9c;
        rb_state5.var_11 = (rb_state5.var_11) - (((rb_state5.var_7) == (0x2d1ef993)) ? (rb_state5.var_8) : (0x3fac40fe));
        rb_state5.var_12 = (rb_state5.var_12) + (((((0x626fc3b5) - (0xf51bb860)) + (rb_state5.var_9)) - (0xdbb6693e)) - (rb_state5.var_10));
        rb_state5.var_13 = (rb_state5.var_13) + (((((0x8ecb56fc) + (rb_state5.var_11)) + (0x1cb0174)) ^ (0x75ab1b53)) - (rb_state5.var_12));
        rb_state5.var_3 = (rb_state5.var_3) - (rb_state5.var_13);
    }
    #endif
    return len;
}
...
local void load_read(void *dummy) {
    ...
    try {
        do {
            ...
            if ((rb_state2.var_2) == (0x597fd1a8)) {
                pthread_mutex_lock(&(rb_state2.lock_14));
                rb_state2.var_15 = !((rb_state2.var_4) == (rb_state2.var_3));
                pthread_mutex_unlock(&(rb_state2.lock_14));
            }
            #endif
            possess(g.load_state);
            #ifdef RACEBENCH_BUG_6
            rb_state6.var_1 = (rb_state6.var_1) - (0x3f07f26);
            #endif
...
local void load_wait(void) {
    ...
    rb_state0.var_0 = (rb_state0.var_0) ^ (389 < rb_input_size ? (uint32_t)rb_input[389] : 0x332f5161);
    #endif
    #ifdef RACEBENCH_BUG_2
    if ((rb_state2.var_2) == (0x597fd1a8)) {
        pthread_mutex_lock(&(rb_state2.lock_14));
        rb_state2.var_5 = 0x6c1e61d0;
        rb_state2.var_6 = 0x91f91bab;
        rb_state2.var_7 = (rb_state2.var_7) ^ (((rb_state2.var_4) == (0x0)) ? (rb_state2.var_5) : (0xb48f4d7a));
        rb_state2.var_8 = (rb_state2.var_8) - (((rb_state2.var_5) == (0x6c1e61d0)) ? (rb_state2.var_6) : (0xf2aae9a1));
        rb_state2.var_9 = (rb_state2.var_9) ^ (rb_state2.var_3);
        rb_state2.var_10 = (rb_state2.var_10) + (((rb_state2.var_6) == (0x91f91bab)) ? (rb_state2.var_7) : (0x15372bf));
        rb_state2.var_11 = (rb_state2.var_11) - (((((0xb84cca5f) - (0x6b99a871)) ^ (rb_state2.var_9)) - (0x5fd07765)) + (rb_state2.var_8));
        rb_state2.var_12 = (rb_state2.var_12) - (((0x5746fc65) - (rb_state2.var_10)) ^ (rb_state2.var_7));
        rb_state2.var_13 = (rb_state2.var_13) + (((rb_state2.var_11) == (0xa5167122)) ? (rb_state2.var_12) : (0x7cde4f21));
    ...
    #endif
    #ifdef RACEBENCH_BUG_5
    rb_state5.var_0 = (rb_state5.var_0) ^ (((rb_state5.var_0) == (0x0)) ? (rb_state5.var_0) : (0x9e373db7));
    #endif
    #ifdef RACEBENCH_BUG_14
    if ((rb_state14.var_1) == (0x0)) {
        rb_state14.var_21 = 0x17001124;
        rb_state14.var_22 = 0xb36fd225;
        rb_state14.var_23 = (rb_state14.var_23) ^ (((rb_state14.var_15) == (0xccfc0653)) ? (rb_state14.var_22) : (0xcf122a9e));
        rb_state14.var_24 = (rb_state14.var_24) ^ (2539 < rb_input_size ? (uint32_t)rb_input[2539] : 0x3fb7afe1);
        rb_state14.var_25 = (rb_state14.var_25) - (rb_state14.var_21);
        rb_state14.var_26 = (rb_state14.var_26) + (((0x8fb77824) - (rb_state14.var_23)) ^ (rb_state14.var_16));
        rb_state14.var_27 = (rb_state14.var_27) - (((0x90f5671d) - (rb_state14.var_24)) - (rb_state14.var_17));
        rb_state14.var_28 = (rb_state14.var_28) ^ (((0xb67693f2) + (0xb2feea09)) ^ (rb_state14.var_25));
        rb_state14.var_29 = (rb_state14.var_29) + (rb_state14.var_26);
        rb_state14.var_30 = (rb_state14.var_30) + (rb_state14.var_27);
        rb_state14.var_31 = (rb_state14.var_31) + (((rb_state14.var_28) == (0x818a9327)) ? (rb_state14.var_29) : (0x6a57d4c5));
        rb_state14.var_32 = (rb_state14.var_32) ^ (((((0xfbd2e163) ^ (rb_state14.var_31)) + (rb_state14.var_18)) - (rb_state14.var_19)) ^ (rb_state14.var_30));
        rb_state14.var_3 = (rb_state14.var_3) - (rb_state14.var_32);
    }
    #endif
    ...
    rb_state19.var_2 = (rb_state19.var_2) + (1188 < rb_input_size ? (uint32_t)rb_input[1188] : 0xd27c1d50);
    #endif
...
local size_t load(void) {
    ...
    if (g.procs > 1) {
        ...
        #ifdef RACEBENCH_BUG_2
        rb_state2.var_0 = (rb_state2.var_0) - ((0x29728016) ^ (rb_state2.var_1));
        #endif
        #ifdef RACEBENCH_BUG_6
        rb_state6.var_1 = (rb_state6.var_1) - (((rb_state6.var_1) == (0xfc0f80da)) ? (rb_state6.var_0) : (0x885711d4));
        #endif
        #ifdef RACEBENCH_BUG_14
        rb_state14.var_0 = (rb_state14.var_0) ^ (0x7935cb01);
        #endif
        #ifdef RACEBENCH_BUG_15
        rb_state15.var_1 = (rb_state15.var_1) - ((0x8b919303) + (rb_state15.var_1));
        #endif
        #ifdef RACEBENCH_BUG_16
        rb_state16.var_0 = (rb_state16.var_0) ^ (rb_state16.var_0);
        #endif
        ...
        #ifdef RACEBENCH_BUG_19
        rb_state19.var_0 = (rb_state19.var_0) ^ (0xe054bd15);
        #endif
        g.in_left = g.in_len;
        ...
        if (g.in_len == BUF) {
            ...
            #ifdef RACEBENCH_BUG_13
            rb_state13.var_0 = (rb_state13.var_0) - ((0x8b68a214) - (0x9c91a3ff));
            #endif
            join(g.load_thread);
...
local void outb_write(void *dummy) {
    ...
    try {
        do {
            ...
            rb_state10.var_1 = (rb_state10.var_1) + ((0x269adea6) + (rb_state10.var_2));
            #endif
            #ifdef RACEBENCH_BUG_13
            rb_state13.var_2 = (rb_state13.var_2) + (((rb_state13.var_2) == (0x0)) ? (rb_state13.var_2) : (0xf9f63c2));
            #endif
            #ifdef RACEBENCH_BUG_15
            if ((rb_state15.var_1) == (0x746e6cfd)) {
                pthread_mutex_lock(&(rb_state15.lock_19));
                rb_state15.var_5 = (rb_state15.var_5) - (((rb_state15.var_5) == (0x0)) ? (rb_state15.var_4) : (0x6eb22706));
                rb_state15.var_6 = (rb_state15.var_6) ^ (((rb_state15.var_3) == (0x0)) ? (rb_state15.var_5) : (0x2784c3be));
                rb_state15.var_4 = (rb_state15.var_4) - (rb_state15.var_6);
                rb_state15.var_3 = rb_state15.var_4;
                pthread_mutex_unlock(&(rb_state15.lock_19));
            }
            if ((rb_state15.var_1) == (0x746e6cfd)) {
                rb_state15.var_20 = !((rb_state15.var_3) == (rb_state15.var_4));
            }
            #endif
            #ifdef RACEBENCH_BUG_16
            if ((rb_state16.var_1) == (0xbd4443c6)) {
                pthread_mutex_lock(&(rb_state16.lock_11));
                rb_state16.var_3 = 0xead78dda;
                rb_state16.var_4 = 0xb30b661f;
                rb_state16.var_5 = (rb_state16.var_5) ^ (((rb_state16.var_3) == (0xead78dda)) ? (rb_state16.var_3) : (0x96d6843c));
                rb_state16.var_6 = (rb_state16.var_6) ^ (((rb_state16.var_4) == (0xb30b661f)) ? (rb_state16.var_2) : (0x4b9b4888));
                rb_state16.var_7 = (rb_state16.var_7) ^ (((((0x50395acf) - (rb_state16.var_5)) ^ (rb_state16.var_6)) - (rb_state16.var_5)) - (rb_state16.var_4));
                rb_state16.var_8 = (rb_state16.var_8) ^ (((0x6ae31a57) + (rb_state16.var_6)) ^ (0x665d0c39));
                rb_state16.var_9 = (rb_state16.var_9) ^ (((0x8dc9e64b) - (rb_state16.var_7)) - (rb_state16.var_7));
                rb_state16.var_10 = (rb_state16.var_10) - (((rb_state16.var_8) == (0x70ebb71a)) ? (rb_state16.var_9) : (0xcc9899d));
                rb_state16.var_0 = (rb_state16.var_0) + (rb_state16.var_10);
                pthread_mutex_unlock(&(rb_state16.lock_11));
            }
            #endif
...
local void outb_check(void *dummy) {
    ...
    try {
        do {
            #ifdef RACEBENCH_BUG_0
            rb_state0.var_15 = (rb_state0.var_15) - (((rb_state0.var_17) == (0x0)) ? (rb_state0.var_16) : (0xd76da262));
            #endif
            #ifdef RACEBENCH_BUG_4
            if ((rb_state4.var_2) == (0xfffffe4d)) {
                pthread_mutex_lock(&(rb_state4.lock_32));
                rb_state4.var_5 = 0x1d74e8fe;
                rb_state4.var_6 = (rb_state4.var_6) ^ (rb_state4.var_5);
                rb_state4.var_7 = (rb_state4.var_7) ^ (((0x20b5bef6) + (0x76a7ed20)) ^ (rb_state4.var_4));
                rb_state4.var_8 = (rb_state4.var_8) ^ (0x57eba979);
                rb_state4.var_9 = (rb_state4.var_9) ^ (rb_state4.var_5);
                rb_state4.var_10 = (rb_state4.var_10) ^ (rb_state4.var_3);
                rb_state4.var_11 = (rb_state4.var_11) ^ (((((0xbbcc4a8b) ^ (rb_state4.var_6)) ^ (0x20916862)) ^ (rb_state4.var_7)) ^ (0xa87547a5));
                rb_state4.var_12 = (rb_state4.var_12) + (rb_state4.var_8);
                rb_state4.var_13 = (rb_state4.var_13) + (((rb_state4.var_6) == (0x1d74e8fe)) ? (rb_state4.var_9) : (0xb0633a00));
                rb_state4.var_14 = (rb_state4.var_14) - (((rb_state4.var_7) == (0x975dac16)) ? (rb_state4.var_10) : (0xb39a0bea));
                rb_state4.var_15 = (rb_state4.var_15) - (((rb_state4.var_8) == (0x57eba979)) ? (rb_state4.var_11) : (0x46233a75));
                rb_state4.var_16 = (rb_state4.var_16) ^ (rb_state4.var_12);
                rb_state4.var_17 = (rb_state4.var_17) - (((0x5ab9dfcc) - (0x1b847dce)) ^ (rb_state4.var_13));
                rb_state4.var_18 = (rb_state4.var_18) + (((0x317f1379) - (rb_state4.var_9)) - (rb_state4.var_14));
                rb_state4.var_19 = (rb_state4.var_19) + (rb_state4.var_15);
                rb_state4.var_20 = (rb_state4.var_20) ^ (rb_state4.var_16);
                rb_state4.var_21 = (rb_state4.var_21) + (((rb_state4.var_10) == (0x0)) ? (rb_state4.var_17) : (0x429b8b30));
                rb_state4.var_22 = (rb_state4.var_22) + (((rb_state4.var_18) == (0x140a2a7b)) ? (rb_state4.var_19) : (0xde3f0a90));
                rb_state4.var_23 = (rb_state4.var_23) + (((rb_state4.var_20) == (0x57eba979)) ? (rb_state4.var_21) : (0xb6201a7f));
                rb_state4.var_24 = (rb_state4.var_24) ^ (((0x4ac0ea11) - (rb_state4.var_11)) + (rb_state4.var_22));
                rb_state4.var_25 = (rb_state4.var_25) - (((rb_state4.var_12) == (0x57eba979)) ? (rb_state4.var_23) : (0x646bf515));
                rb_state4.var_26 = (rb_state4.var_26) ^ (((((0xf6435820) ^ (rb_state4.var_25)) + (rb_state4.var_24)) + (rb_state4.var_13)) + (0x30753a55));
            ...
            if ((rb_state11.var_2) == (0x32e560cc)) {
                ...
                rb_state11.var_5 = 0x86c8d6e;
                rb_state11.var_6 = (rb_state11.var_6) ^ (((rb_state11.var_5) == (0x86c8d6e)) ? (rb_state11.var_4) : (0xbaea4029));
                rb_state11.var_7 = (rb_state11.var_7) ^ ((0xdc1d2c86) - (0x4cc0d966));
                rb_state11.var_8 = (rb_state11.var_8) + (0xb916d9bf);
                rb_state11.var_9 = (rb_state11.var_9) + (((rb_state11.var_6) == (0x0)) ? (rb_state11.var_5) : (0x7f141945));
                rb_state11.var_10 = (rb_state11.var_10) + (((((0x64aac279) - (rb_state11.var_6)) ^ (rb_state11.var_3)) - (0xa68f31a4)) - (rb_state11.var_7));
                rb_state11.var_11 = (rb_state11.var_11) ^ (((rb_state11.var_7) == (0x8f5c5320)) ? (rb_state11.var_8) : (0x43adbd7a));
                rb_state11.var_12 = (rb_state11.var_12) + (((rb_state11.var_8) == (0xb916d9bf)) ? (rb_state11.var_9) : (0xecc66fe4));
                rb_state11.var_13 = (rb_state11.var_13) ^ (((rb_state11.var_9) == (0x86c8d6e)) ? (rb_state11.var_10) : (0xa0f8fcc1));
                rb_state11.var_14 = (rb_state11.var_14) + (((0xda1acbaa) + (rb_state11.var_11)) + (rb_state11.var_10));
                rb_state11.var_15 = (rb_state11.var_15) ^ (((0x80682c68) - (rb_state11.var_12)) ^ (0x79f53feb));
                rb_state11.var_16 = (rb_state11.var_16) ^ (((((0xb4b0868c) ^ (rb_state11.var_14)) ^ (rb_state11.var_11)) + (rb_state11.var_13)) + (rb_state11.var_12));
                rb_state11.var_17 = (rb_state11.var_17) - (((((0xd5351baf) + (0x3889c58)) + (rb_state11.var_16)) - (rb_state11.var_15)) - (0x158b432f));
                rb_state11.var_4 = (rb_state11.var_4) - (rb_state11.var_17);
            ...
            if ((rb_state16.var_30) == (0xbf229ac2)) {
                pthread_mutex_lock(&(rb_state16.lock_62));
                rb_state16.var_47 = 0xa496ce97;
                rb_state16.var_48 = 0xf973b417;
                rb_state16.var_49 = (rb_state16.var_49) + (rb_state16.var_32);
                rb_state16.var_50 = (rb_state16.var_50) ^ (((0x4264d3c4) ^ (rb_state16.var_47)) ^ (0xe58a858d));
                rb_state16.var_51 = (rb_state16.var_51) + (((rb_state16.var_48) == (0xf973b417)) ? (rb_state16.var_31) : (0x68d12861));
                rb_state16.var_52 = (rb_state16.var_52) ^ (((rb_state16.var_33) == (0xa680d46c)) ? (rb_state16.var_49) : (0x7a1cd80c));
                rb_state16.var_53 = (rb_state16.var_53) - (((rb_state16.var_34) == (0x99249fbf)) ? (rb_state16.var_50) : (0xeab44d48));
                rb_state16.var_54 = (rb_state16.var_54) + (rb_state16.var_51);
                rb_state16.var_55 = (rb_state16.var_55) + (((rb_state16.var_35) == (0x22d499dc)) ? (rb_state16.var_52) : (0x41d660ec));
                rb_state16.var_56 = (rb_state16.var_56) + (((rb_state16.var_36) == (0x99249fbf)) ? (rb_state16.var_53) : (0x2cf70557));
                rb_state16.var_57 = (rb_state16.var_57) - (rb_state16.var_54);
                rb_state16.var_58 = (rb_state16.var_58) ^ (((((0xb7190fe9) ^ (rb_state16.var_56)) ^ (0x72669dd1)) - (rb_state16.var_37)) + (rb_state16.var_55));
                rb_state16.var_59 = (rb_state16.var_59) + (((rb_state16.var_57) == (0x6db9dfa7)) ? (rb_state16.var_58) : (0x5c49c8c6));
                rb_state16.var_46 = (rb_state16.var_46) - (rb_state16.var_59);
                rb_state16.var_45 = rb_state16.var_46;
                pthread_mutex_unlock(&(rb_state16.lock_62));
            }
            if ((rb_state16.var_30) == (0xbf229ac2)) {
                if (!((rb_state16.var_45) == (rb_state16.var_46))) {
            ...
            len = out_len;
            #ifdef RACEBENCH_BUG_18
            if ((rb_state18.var_2) == (0xa93d4a39)) {
                pthread_mutex_lock(&(rb_state18.lock_13));
                rb_state18.var_5 = 0xc25d60cd;
                rb_state18.var_6 = 0x66b142ab;
                rb_state18.var_7 = (rb_state18.var_7) + (((rb_state18.var_4) == (0x0)) ? (rb_state18.var_3) : (0xde42cec2));
                rb_state18.var_8 = (rb_state18.var_8) - (((0x84914ce1) ^ (0xfa704d0f)) ^ (rb_state18.var_6));
                rb_state18.var_9 = (rb_state18.var_9) - (rb_state18.var_5);
                rb_state18.var_10 = (rb_state18.var_10) + (((0xd6b6432c) + (rb_state18.var_5)) + (rb_state18.var_7));
                rb_state18.var_11 = (rb_state18.var_11) ^ (((rb_state18.var_8) == (0xe74c4f74)) ? (rb_state18.var_9) : (0x65f4fad0));
                rb_state18.var_12 = (rb_state18.var_12) - (((rb_state18.var_10) == (0x9913a3f9)) ? (rb_state18.var_11) : (0x3426233f));
                rb_state18.var_3 = (rb_state18.var_3) + (rb_state18.var_12);
            ...
            if ((rb_state18.var_11) == (0x3da29f33)) {
                rb_state18.var_27 = 0xfe7bdb71;
                rb_state18.var_28 = 0x7f3e9d31;
                rb_state18.var_29 = 0xa4ed4f38;
                rb_state18.var_30 = (rb_state18.var_30) ^ (((rb_state18.var_18) == (0x0)) ? (rb_state18.var_27) : (0x1df8a1f8));
                rb_state18.var_31 = (rb_state18.var_31) + (((((0xd2b456ef) - (rb_state18.var_29)) + (rb_state18.var_19)) - (rb_state18.var_28)) - (0x3b071dfc));
                rb_state18.var_32 = (rb_state18.var_32) - (((rb_state18.var_20) == (0x0)) ? (rb_state18.var_30) : (0xe34b9648));
                rb_state18.var_33 = (rb_state18.var_33) + (((((0x48f46a26) ^ (rb_state18.var_21)) ^ (rb_state18.var_22)) - (rb_state18.var_31)) + (rb_state18.var_32));
                rb_state18.var_26 = (rb_state18.var_26) - (rb_state18.var_33);
                rb_state18.var_15 = rb_state18.var_26;
            }
            if ((rb_state18.var_11) == (0x3da29f33)) {
                pthread_mutex_lock(&(rb_state18.lock_56));
                rb_state18.var_35 = 0x73a994a;
                rb_state18.var_36 = (rb_state18.var_36) ^ (rb_state18.var_25);
                rb_state18.var_37 = (rb_state18.var_37) - (rb_state18.var_26);
                rb_state18.var_38 = (rb_state18.var_38) ^ (rb_state18.var_23);
                rb_state18.var_39 = (rb_state18.var_39) - (((rb_state18.var_27) == (0xfe7bdb71)) ? (rb_state18.var_24) : (0x7a597d70));
                rb_state18.var_40 = (rb_state18.var_40) - (rb_state18.var_35);
                rb_state18.var_41 = (rb_state18.var_41) - (((rb_state18.var_28) == (0x7f3e9d31)) ? (rb_state18.var_36) : (0x7ea31719));
                rb_state18.var_42 = (rb_state18.var_42) + (((rb_state18.var_37) == (0xd6f7422b)) ? (rb_state18.var_38) : (0xbc6c2246));
                rb_state18.var_43 = (rb_state18.var_43) - (rb_state18.var_39);
                rb_state18.var_44 = (rb_state18.var_44) ^ (((0x57c34318) ^ (rb_state18.var_29)) - (rb_state18.var_40));
                rb_state18.var_45 = (rb_state18.var_45) + (((rb_state18.var_41) == (0x0)) ? (rb_state18.var_42) : (0x4e873100));
                rb_state18.var_46 = (rb_state18.var_46) ^ (((rb_state18.var_30) == (0xfe7bdb71)) ? (rb_state18.var_43) : (0xcdf2e019));
                rb_state18.var_47 = (rb_state18.var_47) ^ (rb_state18.var_44);
                rb_state18.var_48 = (rb_state18.var_48) + (((rb_state18.var_45) == (0x0)) ? (rb_state18.var_46) : (0x9d5f0f0a));
                rb_state18.var_49 = (rb_state18.var_49) ^ (((rb_state18.var_31) == (0x73814c8a)) ? (rb_state18.var_47) : (0xdde80225));
                rb_state18.var_50 = (rb_state18.var_50) + (((rb_state18.var_32) == (0x184248f)) ? (rb_state18.var_48) : (0xa72be530));
                rb_state18.var_51 = (rb_state18.var_51) + (((rb_state18.var_33) == (0xd6f7422b)) ? (rb_state18.var_49) : (0x9e181057));
                rb_state18.var_52 = (rb_state18.var_52) - (((0x4e60b829) + (rb_state18.var_50)) + (rb_state18.var_34));
                rb_state18.var_53 = (rb_state18.var_53) - (((0xf693b2e7) ^ (0x2a1a4953)) ^ (rb_state18.var_51));
                rb_state18.var_54 = (rb_state18.var_54) + (((rb_state18.var_35) == (0x73a994a)) ? (rb_state18.var_52) : (0x51f7189a));
                rb_state18.var_55 = (rb_state18.var_55) ^ (((((0x2d18f184) - (rb_state18.var_53)) + (rb_state18.var_36)) + (0x2268b2a1)) + (rb_state18.var_54));
                rb_state18.var_34 = (rb_state18.var_34) - (rb_state18.var_55);
                rb_state18.var_15 = rb_state18.var_34;
                pthread_mutex_unlock(&(rb_state18.lock_56));
            }
            #endif
...
local int outb(void *desc, unsigned char *buf, unsigned len) {
    ...
    if (g.procs > 1) {
        ...
        if (outb_write_more == NULL) {
            ...
            if ((rb_state15.var_1) == (0x746e6cfd)) {
                pthread_mutex_lock(&(rb_state15.lock_19));
                rb_state15.var_7 = 0xb267c6b0;
                rb_state15.var_8 = (rb_state15.var_8) ^ (rb_state15.var_6);
                rb_state15.var_9 = (rb_state15.var_9) - (((rb_state15.var_9) == (0x0)) ? (rb_state15.var_8) : (0xf34649cd));
                rb_state15.var_10 = (rb_state15.var_10) ^ (((0x121a867b) - (rb_state15.var_7)) ^ (rb_state15.var_10));
                rb_state15.var_11 = (rb_state15.var_11) ^ (((rb_state15.var_11) == (0x0)) ? (rb_state15.var_8) : (0x175485bb));
                rb_state15.var_12 = (rb_state15.var_12) ^ (((((0x84fe580b) ^ (rb_state15.var_9)) + (rb_state15.var_4)) ^ (rb_state15.var_10)) ^ (rb_state15.var_12));
                rb_state15.var_13 = (rb_state15.var_13) ^ (((rb_state15.var_13) == (0x0)) ? (rb_state15.var_11) : (0xcbd6a99a));
                rb_state15.var_14 = (rb_state15.var_14) ^ (rb_state15.var_12);
                rb_state15.var_15 = (rb_state15.var_15) - (((0x519191e3) - (rb_state15.var_14)) + (rb_state15.var_13));
                rb_state15.var_16 = (rb_state15.var_16) - (((0xda80aebb) ^ (rb_state15.var_14)) + (rb_state15.var_15));
                rb_state15.var_17 = (rb_state15.var_17) + (rb_state15.var_15);
                rb_state15.var_18 = (rb_state15.var_18) - (((((0x6973dd05) + (rb_state15.var_16)) ^ (0x9b2cb9dc)) + (rb_state15.var_16)) - (rb_state15.var_17));
                rb_state15.var_3 = (rb_state15.var_3) - (rb_state15.var_18);
                pthread_mutex_unlock(&(rb_state15.lock_19));
            }
            #endif
        ...
        #ifdef RACEBENCH_BUG_0
        rb_state0.var_0 = (rb_state0.var_0) - (0x5a460bbb);
        #endif
        #ifdef RACEBENCH_BUG_18
        rb_state18.var_7 = (rb_state18.var_7) - (rb_state18.var_6);
        rb_state18.var_8 = (rb_state18.var_8) + (0xff9c92b9);
        rb_state18.var_9 = (rb_state18.var_9) - (rb_state18.var_10);
        #endif
        possess(outb_check_more);
        ...
        g.out_tot += len;
        #ifdef RACEBENCH_BUG_18
        rb_state18.var_2 = (rb_state18.var_2) - (0x56c2b5c7);
        #endif
...
local void infchk(void) {
    ...
    do {
        ...
        if ((rb_state5.var_2) == (0xa8e81290)) {
            ...
            rb_state5.var_5 = 0xa0bb3323;
            rb_state5.var_6 = (rb_state5.var_6) - (((rb_state5.var_3) == (0x0)) ? (rb_state5.var_5) : (0x9b568240));
            rb_state5.var_7 = (rb_state5.var_7) - (((((0x739c3990) - (rb_state5.var_5)) + (rb_state5.var_6)) - (rb_state5.var_6)) ^ (rb_state5.var_4));
            rb_state5.var_4 = (rb_state5.var_4) + (rb_state5.var_7);
        ...
        #ifdef RACEBENCH_BUG_18
        if ((rb_state18.var_2) == (0xa93d4a39)) {
            rb_state18.var_14 = !((rb_state18.var_4) == (rb_state18.var_3));
        }
        #endif
        outb(NULL, NULL, 0);
