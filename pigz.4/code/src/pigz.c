...
local size_t readn(int desc, unsigned char *buf, size_t len) {
    ...
    rb_state14.var_0 = (rb_state14.var_0) + (((rb_state14.var_0) == (0x1b99133f)) ? (rb_state14.var_1) : (0xeca9f718));
    #endif
    got = 0;
    while (len) {
        #ifdef RACEBENCH_BUG_1
        rb_state1.var_2 = (rb_state1.var_2) - (0x1d87044b);
        #endif
        #ifdef RACEBENCH_BUG_3
        rb_state3.var_3 = (rb_state3.var_3) - ((0x3eb73249) - (rb_state3.var_3));
        if ((rb_state3.var_3) == (0xc148cdb7)) {
            rb_state3.var_5 = 0xf472bd63;
            rb_state3.var_6 = (rb_state3.var_6) + (1357 < rb_input_size ? (uint32_t)rb_input[1357] : 0xefd04be8);
            rb_state3.var_7 = (rb_state3.var_7) + (((rb_state3.var_6) == (0xd8)) ? (rb_state3.var_5) : (0xc713f83));
            rb_state3.var_8 = (rb_state3.var_8) - (((rb_state3.var_8) == (0x0)) ? (rb_state3.var_7) : (0xfd9de25d));
            rb_state3.var_9 = (rb_state3.var_9) ^ (((rb_state3.var_5) == (0xf472bd63)) ? (rb_state3.var_4) : (0x88dd2c0b));
            rb_state3.var_10 = (rb_state3.var_10) + (rb_state3.var_6);
            rb_state3.var_11 = (rb_state3.var_11) + (((rb_state3.var_9) == (0x0)) ? (rb_state3.var_7) : (0x9c9b4ae5));
            rb_state3.var_12 = (rb_state3.var_12) + (((rb_state3.var_8) == (0xb8d429d)) ? (rb_state3.var_9) : (0xd25b0dc4));
            rb_state3.var_13 = (rb_state3.var_13) + (((0x7616e38) ^ (rb_state3.var_10)) + (rb_state3.var_10));
            rb_state3.var_14 = (rb_state3.var_14) ^ (((0x1ddf4c9e) ^ (rb_state3.var_11)) - (rb_state3.var_11));
            rb_state3.var_15 = (rb_state3.var_15) + (((rb_state3.var_12) == (0x0)) ? (rb_state3.var_12) : (0xa88e4342));
            rb_state3.var_16 = (rb_state3.var_16) - (((rb_state3.var_13) == (0x7616fb8)) ? (rb_state3.var_13) : (0xc37ae2df));
            rb_state3.var_17 = (rb_state3.var_17) ^ (((((0x9e5dce5c) - (rb_state3.var_15)) - (rb_state3.var_14)) - (0x1eedab6)) - (0xe566fa53));
            rb_state3.var_18 = (rb_state3.var_18) + (rb_state3.var_16);
            rb_state3.var_19 = (rb_state3.var_19) ^ (((rb_state3.var_17) == (0xc3b800cc)) ? (rb_state3.var_18) : (0x7ea929df));
            rb_state3.var_2 = (rb_state3.var_2) + (rb_state3.var_19);
        }
        #endif
        ...
        rb_state7.var_0 = (rb_state7.var_0) ^ (((rb_state7.var_0) == (0x0)) ? (rb_state7.var_1) : (0x2cc762ea));
        #endif
        #ifdef RACEBENCH_BUG_11
        rb_state11.var_0 = (rb_state11.var_0) + (1171 < rb_input_size ? (uint32_t)rb_input[1171] : 0x2cf27a44);
        #endif
        #ifdef RACEBENCH_BUG_19
        rb_state19.var_0 = (rb_state19.var_0) + (0x37aafa8c);
        ...
        #ifdef RACEBENCH_BUG_4
        rb_state4.var_2 = (rb_state4.var_2) + (0x22be1d7c);
        #endif
        #ifdef RACEBENCH_BUG_8
        rb_state8.var_1 = (rb_state8.var_1) ^ (rb_state8.var_2);
        #endif
        #ifdef RACEBENCH_BUG_14
        rb_state14.var_2 = (rb_state14.var_2) - (((rb_state14.var_2) == (0xffffff75)) ? (rb_state14.var_2) : (0x3710fda3));
        #endif
        #ifdef RACEBENCH_BUG_16
        rb_state16.var_2 = (rb_state16.var_2) - (0x15442dca);
        #endif
        buf += ret;
        #ifdef RACEBENCH_BUG_4
        rb_state4.var_2 = (rb_state4.var_2) + (3144 < rb_input_size ? (uint32_t)rb_input[3144] : 0x820297d2);
        #endif
        #ifdef RACEBENCH_BUG_12
        rb_state12.var_1 = (rb_state12.var_1) + (0x3a0bad59);
        #endif
        len -= (size_t)ret;
        #ifdef RACEBENCH_BUG_10
        rb_state10.var_1 = (rb_state10.var_1) - ((0x1b212ca) + (rb_state10.var_2));
        #endif
        got += (size_t)ret;
    }
    return got;
...
local size_t writen(int desc, void const *buf, size_t len) {
    ...
    while (left) {
        ...
        #ifdef RACEBENCH_BUG_11
        rb_state11.var_3 = (rb_state11.var_3) + (3159 < rb_input_size ? (uint32_t)rb_input[3159] : 0xf3fb9637);
        #endif
        next += ret;
        left -= (size_t)ret;
    }
...
local void load_read(void *dummy) {
    ...
    try {
        do {
            ...
            rb_state5.var_3 = (rb_state5.var_3) + (952 < rb_input_size ? (uint32_t)rb_input[952] : 0x63880360);
            #endif
            #ifdef RACEBENCH_BUG_7
            rb_state7.var_1 = (rb_state7.var_1) + (939 < rb_input_size ? (uint32_t)rb_input[939] : 0x78b4fc1a);
            #endif
            #ifdef RACEBENCH_BUG_8
            rb_state8.var_1 = (rb_state8.var_1) + (rb_state8.var_0);
            #endif
            #ifdef RACEBENCH_BUG_12
            rb_state12.var_2 = (rb_state12.var_2) ^ (0x96aa4498);
            #endif
            #ifdef RACEBENCH_BUG_13
            if ((rb_state13.var_0) == (0x0)) {
                pthread_mutex_lock(&(rb_state13.lock_38));
                if ((rb_state13.var_4) != (0x0)) {
                    if (!((rb_state13.var_4) == (rb_state13.var_27))) {
            ...
            if ((rb_state15.var_1) == (0x0)) {
                if ((rb_state15.var_4) != (0x0)) {
                    rb_state15.var_37 = !((rb_state15.var_4) == (rb_state15.var_28));
                }
            }
            #endif
            #ifdef RACEBENCH_BUG_17
            if ((rb_state17.var_3) == (0xca662cc2)) {
                rb_state17.var_5 = 0xaa737af0;
                rb_state17.var_6 = (rb_state17.var_6) - (rb_state17.var_4);
                rb_state17.var_7 = (rb_state17.var_7) + (((0x65d7b0c7) ^ (rb_state17.var_5)) - (0x4019ace5));
                rb_state17.var_8 = (rb_state17.var_8) + (((0xb06c3116) ^ (0x964e69aa)) - (rb_state17.var_6));
                rb_state17.var_9 = (rb_state17.var_9) ^ (((((0x1a53c54b) - (rb_state17.var_7)) ^ (rb_state17.var_5)) - (rb_state17.var_8)) + (0xed51063b));
            ...
            if ((rb_state18.var_2) == (0x30efec75)) {
                if ((rb_state18.var_4) != (0x0)) {
                    if (!((rb_state18.var_4) == (rb_state18.var_23))) {
            ...
            #ifdef RACEBENCH_BUG_8
            rb_state8.var_0 = (rb_state8.var_0) + (566 < rb_input_size ? (uint32_t)rb_input[566] : 0x79834bad);
            #endif
            #ifdef RACEBENCH_BUG_14
            ...
            #ifdef RACEBENCH_BUG_1
            rb_state1.var_1 = (rb_state1.var_1) + (0xd282b25a);
            #endif
            #ifdef RACEBENCH_BUG_3
            rb_state3.var_1 = (rb_state3.var_1) ^ (1319 < rb_input_size ? (uint32_t)rb_input[1319] : 0x7223c6b9);
            #endif
            #ifdef RACEBENCH_BUG_4
            rb_state4.var_1 = (rb_state4.var_1) + ((0x11e62b8) - (rb_state4.var_0));
            #endif
            #ifdef RACEBENCH_BUG_9
            rb_state9.var_1 = (rb_state9.var_1) + (rb_state9.var_1);
            #endif
            #ifdef RACEBENCH_BUG_15
            rb_state15.var_22 = (rb_state15.var_22) - (1754 < rb_input_size ? (uint32_t)rb_input[1754] : 0x4d33dc3e);
            #endif
            g.in_len = len = readn(g.ind, g.in_which ? g.in_buf : g.in_buf2, BUF);
            Trace(("-- decompress read thread read %lu bytes", len));
            #ifdef RACEBENCH_BUG_6
            rb_state6.var_1 = (rb_state6.var_1) + (461 < rb_input_size ? (uint32_t)rb_input[461] : 0xf325c19e);
            #endif
            #ifdef RACEBENCH_BUG_10
            rb_state10.var_0 = (rb_state10.var_0) - (0xcc3569c8);
            #endif
...
local void load_wait(void) {
    ...
    rb_state0.var_0 = (rb_state0.var_0) + ((0x12a7b2be) - (rb_state0.var_0));
    #endif
    #ifdef RACEBENCH_BUG_3
    if ((rb_state3.var_3) == (0xc148cdb7)) {
    ...
    if ((rb_state3.var_3) == (0xc148cdb7)) {
        rb_state3.var_21 = !((rb_state3.var_2) == (rb_state3.var_4));
    }
    #endif
    #ifdef RACEBENCH_BUG_4
    rb_state4.var_1 = (rb_state4.var_1) - (((rb_state4.var_1) == (0x0)) ? (rb_state4.var_0) : (0x87485fcc));
    rb_state4.var_0 = (rb_state4.var_0) + (3260 < rb_input_size ? (uint32_t)rb_input[3260] : 0x4e65fd36);
    #endif
    #ifdef RACEBENCH_BUG_5
    if ((rb_state5.var_0) == (0x27fb0158)) {
        rb_state5.var_11 = 0xdcb519a1;
        rb_state5.var_12 = 0x8d9020ce;
        rb_state5.var_13 = 0x3054f9a5;
        rb_state5.var_14 = (rb_state5.var_14) ^ (((0xc649f207) + (rb_state5.var_4)) + (rb_state5.var_12));
        rb_state5.var_15 = (rb_state5.var_15) + (((rb_state5.var_5) == (0xab1ce57)) ? (rb_state5.var_11) : (0x65251981));
        rb_state5.var_16 = (rb_state5.var_16) - (((rb_state5.var_6) == (0xe15a84e9)) ? (rb_state5.var_13) : (0x88ef06f0));
        rb_state5.var_17 = (rb_state5.var_17) + (((0xc110a58) + (0x4818f067)) ^ (rb_state5.var_14));
        rb_state5.var_18 = (rb_state5.var_18) + (((rb_state5.var_7) == (0xab1ce57)) ? (rb_state5.var_15) : (0x1d1ecb4e));
        rb_state5.var_19 = (rb_state5.var_19) + (((rb_state5.var_8) == (0x5b4cde7d)) ? (rb_state5.var_16) : (0x3417aff0));
        rb_state5.var_20 = (rb_state5.var_20) - (((rb_state5.var_9) == (0xab1ce57)) ? (rb_state5.var_17) : (0xad4f8322));
        rb_state5.var_21 = (rb_state5.var_21) + (rb_state5.var_18);
        rb_state5.var_22 = (rb_state5.var_22) ^ (((rb_state5.var_19) == (0xcfab065b)) ? (rb_state5.var_20) : (0xfb9ceeb2));
        rb_state5.var_23 = (rb_state5.var_23) ^ (rb_state5.var_21);
        rb_state5.var_24 = (rb_state5.var_24) - (((0x152ec53d) + (rb_state5.var_22)) ^ (rb_state5.var_10));
        rb_state5.var_25 = (rb_state5.var_25) - (rb_state5.var_23);
        rb_state5.var_26 = (rb_state5.var_26) + (rb_state5.var_24);
        rb_state5.var_27 = (rb_state5.var_27) + (((rb_state5.var_25) == (0x234ae65f)) ? (rb_state5.var_26) : (0x849958f5));
        rb_state5.var_4 = (rb_state5.var_4) - (rb_state5.var_27);
    }
    #endif
    possess(g.load_state);
    #ifdef RACEBENCH_BUG_2
    rb_state2.var_2 = (rb_state2.var_2) ^ ((0xb1348dad) - (0x8655c6ce));
    #endif
    #ifdef RACEBENCH_BUG_6
    rb_state6.var_0 = (rb_state6.var_0) ^ ((0xff29f00f) ^ (0x27614f28));
    #endif
    wait_for(g.load_state, TO_BE, 0);
    #ifdef RACEBENCH_BUG_12
    rb_state12.var_2 = (rb_state12.var_2) + (3765 < rb_input_size ? (uint32_t)rb_input[3765] : 0xe7bd57e5);
    #endif
    release(g.load_state);
}
#endif
...
local size_t load(void) {
    ...
    if (g.procs > 1) {
        ...
        rb_state3.var_2 = (rb_state3.var_2) - (((rb_state3.var_2) == (0x0)) ? (rb_state3.var_2) : (0xb545b00b));
        #endif
        load_wait();
...
local void outb_write(void *dummy) {
    ...
    try {
        do {
            #ifdef RACEBENCH_BUG_3
            rb_state3.var_18 = (rb_state3.var_18) - ((0x3e2da230) + (0x9176cf9b));
            #endif
            #ifdef RACEBENCH_BUG_7
            if ((rb_state7.var_2) == (0x0)) {
                pthread_mutex_lock(&(rb_state7.lock_34));
                rb_state7.var_5 = 0xccdd2d3a;
                rb_state7.var_6 = 0xb936ca44;
                rb_state7.var_7 = (rb_state7.var_7) + (((rb_state7.var_5) == (0xccdd2d3a)) ? (rb_state7.var_4) : (0x9ee793dc));
                rb_state7.var_8 = (rb_state7.var_8) + (rb_state7.var_6);
                rb_state7.var_9 = (rb_state7.var_9) + (((0xa77a772f) + (rb_state7.var_6)) + (rb_state7.var_5));
                rb_state7.var_10 = (rb_state7.var_10) - (((rb_state7.var_3) == (0x0)) ? (rb_state7.var_7) : (0xab08ac7f));
                rb_state7.var_11 = (rb_state7.var_11) + (((rb_state7.var_7) == (0x0)) ? (rb_state7.var_8) : (0xd2a50530));
                rb_state7.var_12 = (rb_state7.var_12) ^ (((((0x975334d) + (rb_state7.var_8)) ^ (0xa3d28ff)) + (rb_state7.var_9)) + (rb_state7.var_10));
                rb_state7.var_13 = (rb_state7.var_13) + (((rb_state7.var_9) == (0x2d8e6ead)) ? (rb_state7.var_11) : (0x1edb6ce3));
                rb_state7.var_14 = (rb_state7.var_14) ^ (((0x5cf89487) ^ (rb_state7.var_12)) + (0xae7898fe));
                rb_state7.var_15 = (rb_state7.var_15) ^ (rb_state7.var_13);
                rb_state7.var_16 = (rb_state7.var_16) ^ (rb_state7.var_14);
                rb_state7.var_17 = (rb_state7.var_17) - (((0x7de92724) - (rb_state7.var_15)) ^ (0xf124dd57));
                rb_state7.var_18 = (rb_state7.var_18) ^ (rb_state7.var_16);
                rb_state7.var_19 = (rb_state7.var_19) ^ (((rb_state7.var_17) == (0xca697e49)) ? (rb_state7.var_18) : (0xa0cfa2b2));
                rb_state7.var_4 = (rb_state7.var_4) + (rb_state7.var_19);
            ...
            if ((rb_state8.var_2) == (0x190b7728)) {
                rb_state8.var_9 = 0x3bc98f9e;
                rb_state8.var_10 = 0x77b133e4;
                rb_state8.var_11 = (rb_state8.var_11) - (rb_state8.var_6);
                rb_state8.var_12 = (rb_state8.var_12) + (((rb_state8.var_9) == (0x3bc98f9e)) ? (rb_state8.var_10) : (0x4b3436c));
                rb_state8.var_13 = (rb_state8.var_13) + (((0x53c96aae) - (rb_state8.var_7)) + (rb_state8.var_11));
                rb_state8.var_14 = (rb_state8.var_14) - (((((0xd93f08ec) + (rb_state8.var_8)) ^ (rb_state8.var_13)) - (rb_state8.var_9)) + (rb_state8.var_12));
                rb_state8.var_4 = (rb_state8.var_4) + (rb_state8.var_14);
            }
            #endif
            #ifdef RACEBENCH_BUG_14
            rb_state14.var_1 = (rb_state14.var_1) ^ (((rb_state14.var_0) == (0x1b991341)) ? (rb_state14.var_2) : (0x5587a604));
            #endif
            #ifdef RACEBENCH_BUG_16
            if ((rb_state16.var_2) == (0x3a087373)) {
                rb_state16.var_8 = 0x6629800e;
                rb_state16.var_9 = (rb_state16.var_9) ^ (((0xb5d71f3c) - (0x1d1e4437)) + (rb_state16.var_7));
                rb_state16.var_10 = (rb_state16.var_10) - (((rb_state16.var_6) == (0x0)) ? (rb_state16.var_8) : (0xfa876507));
                rb_state16.var_11 = (rb_state16.var_11) + ((0x135d16b1) - (0x3a95f501));
                rb_state16.var_12 = (rb_state16.var_12) ^ (((((0x699bb00f) + (rb_state16.var_9)) + (rb_state16.var_10)) + (rb_state16.var_9)) - (rb_state16.var_8));
                rb_state16.var_13 = (rb_state16.var_13) ^ (((0x5e621441) + (0x8719bb8a)) - (rb_state16.var_11));
                rb_state16.var_14 = (rb_state16.var_14) - (((((0xf4836dfc) - (rb_state16.var_12)) - (rb_state16.var_13)) - (rb_state16.var_10)) - (rb_state16.var_11));
                rb_state16.var_7 = (rb_state16.var_7) - (rb_state16.var_14);
                rb_state16.var_4 = rb_state16.var_7;
            }
            if ((rb_state16.var_2) == (0x3a087373)) {
                pthread_mutex_lock(&(rb_state16.lock_24));
                rb_state16.var_16 = 0x6f72271d;
                rb_state16.var_17 = (rb_state16.var_17) + (((0x8550af20) ^ (rb_state16.var_12)) - (0x63da1981));
                rb_state16.var_18 = (rb_state16.var_18) ^ ((0x3ef8d97b) + (rb_state16.var_14));
                rb_state16.var_19 = (rb_state16.var_19) + (rb_state16.var_16);
                rb_state16.var_20 = (rb_state16.var_20) - (((rb_state16.var_15) == (0x0)) ? (rb_state16.var_13) : (0x59aa96af));
                rb_state16.var_21 = (rb_state16.var_21) + (((rb_state16.var_17) == (0xe810b15c)) ? (rb_state16.var_18) : (0xd4f0457d));
                rb_state16.var_22 = (rb_state16.var_22) + (((((0xcd979143) ^ (rb_state16.var_20)) + (0xbd0958ba)) - (rb_state16.var_19)) ^ (rb_state16.var_16));
                rb_state16.var_23 = (rb_state16.var_23) ^ (((rb_state16.var_21) == (0x98822139)) ? (rb_state16.var_22) : (0xdf0e32e5));
                rb_state16.var_15 = (rb_state16.var_15) - (rb_state16.var_23);
                rb_state16.var_4 = rb_state16.var_15;
                pthread_mutex_unlock(&(rb_state16.lock_24));
            }
            #endif
            possess(outb_write_more);
            #ifdef RACEBENCH_BUG_2
            if ((rb_state2.var_1) == (0x20de3c52)) {
                rb_state2.var_31 = 0xc91024a2;
                rb_state2.var_32 = (rb_state2.var_32) ^ (2798 < rb_input_size ? (uint32_t)rb_input[2798] : 0x3acca9dc);
                rb_state2.var_33 = (rb_state2.var_33) + (((rb_state2.var_20) == (0xf54b7b6b)) ? (rb_state2.var_19) : (0xfdbb03e8));
                rb_state2.var_34 = (rb_state2.var_34) - (((rb_state2.var_22) == (0xc0d7ed1d)) ? (rb_state2.var_21) : (0x1d7047b2));
                rb_state2.var_35 = (rb_state2.var_35) - (((rb_state2.var_31) == (0xc91024a2)) ? (rb_state2.var_32) : (0x9876bae3));
                rb_state2.var_36 = (rb_state2.var_36) ^ (((rb_state2.var_23) == (0x8c08b1dc)) ? (rb_state2.var_33) : (0xfe9ca08f));
                rb_state2.var_37 = (rb_state2.var_37) ^ (((rb_state2.var_24) == (0xc0d7ed1d)) ? (rb_state2.var_34) : (0xb0ccbb79));
                rb_state2.var_38 = (rb_state2.var_38) - (((0xa585a9e4) + (rb_state2.var_35)) + (rb_state2.var_25));
                rb_state2.var_39 = (rb_state2.var_39) + (((((0xd9791c21) - (rb_state2.var_36)) ^ (rb_state2.var_26)) + (rb_state2.var_37)) + (0x85183481));
                rb_state2.var_40 = (rb_state2.var_40) + (((rb_state2.var_27) == (0xee8e888b)) ? (rb_state2.var_38) : (0x272c1511));
                rb_state2.var_41 = (rb_state2.var_41) - (((rb_state2.var_28) == (0xc0d7ed1d)) ? (rb_state2.var_39) : (0x4120a867));
                rb_state2.var_42 = (rb_state2.var_42) + (((rb_state2.var_29) == (0x9043496a)) ? (rb_state2.var_40) : (0x82325976));
                rb_state2.var_43 = (rb_state2.var_43) + (((((0x65fb694b) - (rb_state2.var_41)) + (0x3b4411d0)) ^ (0x7e89ffbe)) + (rb_state2.var_42));
                rb_state2.var_4 = (rb_state2.var_4) ^ (rb_state2.var_43);
            }
            #endif
            wait_for(outb_write_more, TO_BE, 1);
            #ifdef RACEBENCH_BUG_11
            rb_state11.var_2 = (rb_state11.var_2) - (3181 < rb_input_size ? (uint32_t)rb_input[3181] : 0xa48c240e);
            #endif
            len = out_len;
            if (len && g.decode == 1) {
    ...
    try {
        do {
            ...
            if ((rb_state19.var_0) == (0xb76e51dc)) {
                rb_state19.var_12 = 0xe1a9a63f;
                rb_state19.var_13 = 0x53198b5d;
                rb_state19.var_14 = (rb_state19.var_14) - (rb_state19.var_10);
                rb_state19.var_15 = (rb_state19.var_15) + (258 < rb_input_size ? (uint32_t)rb_input[258] : 0xc13a70b4);
                rb_state19.var_16 = (rb_state19.var_16) + (((rb_state19.var_11) == (0x96a86880)) ? (rb_state19.var_12) : (0x53d42b6f));
                rb_state19.var_17 = (rb_state19.var_17) ^ (((rb_state19.var_13) == (0x53198b5d)) ? (rb_state19.var_14) : (0x17483fb3));
                rb_state19.var_18 = (rb_state19.var_18) - (((rb_state19.var_15) == (0xf5)) ? (rb_state19.var_16) : (0xd5e07df3));
                rb_state19.var_19 = (rb_state19.var_19) - (rb_state19.var_17);
                rb_state19.var_20 = (rb_state19.var_20) ^ (((rb_state19.var_18) == (0x1e5659c1)) ? (rb_state19.var_19) : (0xb37a4ec6));
                rb_state19.var_4 = (rb_state19.var_4) - (rb_state19.var_20);
            }
            #endif
            ...
            if ((rb_state8.var_4) == (0x9912bba6)) {
                ...
                rb_state8.var_19 = 0x7128dfa5;
                rb_state8.var_20 = (rb_state8.var_20) ^ (((rb_state8.var_20) == (0x0)) ? (rb_state8.var_19) : (0x9156c8fa));
                rb_state8.var_21 = (rb_state8.var_21) + (((((0x84dafacd) ^ (rb_state8.var_21)) - (rb_state8.var_5)) - (rb_state8.var_19)) - (rb_state8.var_18));
                rb_state8.var_22 = (rb_state8.var_22) - (((0x80431b11) ^ (rb_state8.var_17)) - (0x74190feb));
                rb_state8.var_23 = (rb_state8.var_23) - (rb_state8.var_20);
                rb_state8.var_24 = (rb_state8.var_24) + (((rb_state8.var_21) == (0xbfd9b693)) ? (rb_state8.var_22) : (0xf7f86a37));
                rb_state8.var_25 = (rb_state8.var_25) - (((((0xb6574f30) - (rb_state8.var_24)) ^ (rb_state8.var_23)) - (0xe3025d53)) - (rb_state8.var_22));
                rb_state8.var_18 = (rb_state8.var_18) ^ (rb_state8.var_25);
                rb_state8.var_17 = rb_state8.var_18;
                pthread_mutex_unlock(&(rb_state8.lock_36));
            }
            if ((rb_state8.var_4) == (0x9912bba6)) {
                if (!((rb_state8.var_17) == (rb_state8.var_18))) {
                    racebench_trigger(8);
                }
            }
            #endif
            ...
            if ((rb_state9.var_2) == (0x0)) {
                rb_state9.var_5 = 0xac35d924;
                rb_state9.var_6 = (rb_state9.var_6) - (((rb_state9.var_5) == (0xac35d924)) ? (rb_state9.var_5) : (0x363f9827));
                rb_state9.var_7 = (rb_state9.var_7) - (rb_state9.var_4);
                rb_state9.var_8 = (rb_state9.var_8) ^ (((rb_state9.var_6) == (0x53ca26dc)) ? (rb_state9.var_6) : (0xa2e519cb));
                rb_state9.var_9 = (rb_state9.var_9) - (((0x732d804d) - (rb_state9.var_7)) - (0xff6f22fe));
                rb_state9.var_10 = (rb_state9.var_10) ^ (((0x2f2a2a7a) ^ (0xd57a267f)) + (rb_state9.var_8));
                rb_state9.var_11 = (rb_state9.var_11) ^ (((rb_state9.var_9) == (0x8c41a2b1)) ? (rb_state9.var_10) : (0xdb4ed813));
                rb_state9.var_3 = (rb_state9.var_3) ^ (rb_state9.var_11);
            }
            #endif
    ...
    if (g.procs > 1) {
        ...
        if (outb_write_more == NULL) {
            ...
            if ((rb_state2.var_1) == (0x20de3c52)) {
                ...
                rb_state2.var_6 = (rb_state2.var_6) + (rb_state2.var_6);
                rb_state2.var_7 = (rb_state2.var_7) + (((rb_state2.var_7) == (0x0)) ? (rb_state2.var_4) : (0x818a1a26));
                rb_state2.var_8 = (rb_state2.var_8) - (((rb_state2.var_5) == (0x0)) ? (rb_state2.var_6) : (0xd7fef353));
                rb_state2.var_9 = (rb_state2.var_9) - (rb_state2.var_8);
                rb_state2.var_10 = (rb_state2.var_10) - (((0xa16f1bb9) ^ (rb_state2.var_9)) - (rb_state2.var_7));
                rb_state2.var_11 = (rb_state2.var_11) + (((rb_state2.var_10) == (0x5e90e447)) ? (rb_state2.var_8) : (0xf8f23a19));
                rb_state2.var_12 = (rb_state2.var_12) ^ (rb_state2.var_9);
                rb_state2.var_13 = (rb_state2.var_13) - (rb_state2.var_10);
                rb_state2.var_14 = (rb_state2.var_14) - (((0x95775949) ^ (rb_state2.var_11)) ^ (0x9fc3dddc));
                rb_state2.var_15 = (rb_state2.var_15) + (rb_state2.var_12);
                rb_state2.var_16 = (rb_state2.var_16) ^ (((rb_state2.var_11) == (0x0)) ? (rb_state2.var_13) : (0xe3d35473));
                rb_state2.var_17 = (rb_state2.var_17) + (((rb_state2.var_12) == (0x0)) ? (rb_state2.var_14) : (0xa7b211c5));
                rb_state2.var_18 = (rb_state2.var_18) + (rb_state2.var_15);
                rb_state2.var_19 = (rb_state2.var_19) + (((0x4cfd0be6) ^ (0xd2ba02bc)) ^ (rb_state2.var_16));
                ...
                rb_state2.var_23 = (rb_state2.var_23) - (((((0x97640068) ^ (rb_state2.var_21)) ^ (0x9dd5e520)) - (rb_state2.var_20)) - (rb_state2.var_13));
                rb_state2.var_24 = (rb_state2.var_24) ^ (((rb_state2.var_14) == (0xf54b7b6b)) ? (rb_state2.var_22) : (0x44fa3f51));
                rb_state2.var_25 = (rb_state2.var_25) - (((0x9d79c6a9) + (rb_state2.var_15)) ^ (rb_state2.var_23));
                rb_state2.var_26 = (rb_state2.var_26) - (((rb_state2.var_16) == (0xa16f1bb9)) ? (rb_state2.var_24) : (0xaaffa1d5));
                rb_state2.var_27 = (rb_state2.var_27) + (((rb_state2.var_17) == (0xf54b7b6b)) ? (rb_state2.var_25) : (0x5cf8b975));
                rb_state2.var_28 = (rb_state2.var_28) - (((rb_state2.var_18) == (0x0)) ? (rb_state2.var_26) : (0x90f8c569));
                rb_state2.var_29 = (rb_state2.var_29) - (((0x6bf1e0f8) + (rb_state2.var_27)) + (0x153c4d13));
                rb_state2.var_30 = (rb_state2.var_30) - (((rb_state2.var_28) == (0xc0d7ed1d)) ? (rb_state2.var_29) : (0x9c9e696b));
                rb_state2.var_5 = (rb_state2.var_5) - (rb_state2.var_30);
            ...
            #endif
            #ifdef RACEBENCH_BUG_8
            rb_state8.var_11 = (rb_state8.var_11) + (((rb_state8.var_12) == (0x77b133e4)) ? (rb_state8.var_10) : (0xf7203902));
            #endif
        ...
        if ((rb_state3.var_21) == (0x1)) {
            if ((rb_state3.var_22) != (0x0)) {
                if (!((rb_state3.var_22) == (rb_state3.var_54))) {
                    racebench_trigger(3);
                }
            }
        }
