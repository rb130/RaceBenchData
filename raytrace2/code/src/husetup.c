...
VOID IntersectHuniformPrimlist(intersectPrim, hit, v, r, pid) INT *intersectPrim;
IRECORD *hit;
VOXEL *v;
RAY *r;
INT pid;
...
REAL HuniformShadowIntersect(r, lightlength, pe, pid) RAY *r;
REAL lightlength;
ELEMENT *pe;
INT pid;
{
...
BOOL TraverseHierarchyUniform(r, hit, pid) RAY *r;
IRECORD *hit;
INT pid;
{
    INT status;
