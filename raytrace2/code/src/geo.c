...
ELEMENT **MakeElementArray(totalElements) INT *totalElements;
{
    INT i;
    OBJECT *po;
...
VOID NormalizeGeo(po, model, modelInvT) OBJECT *po;
MATRIX model;
MATRIX modelInvT;
{
    REAL norm_minx;
...
VOID ReadGeoFile(GeoFileName) CHAR *GeoFileName;
{
    INT i;
    INT dummy;
    INT stat;
