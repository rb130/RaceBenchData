...
VOID prn_bintree_node(b) BTNODE *b;
{
    INT i;
...
VOID prn_bintree_leaves(root) BTNODE *root;
{
    BTNODE *b;
...
VOID prn_pepa_prim_list(pepa, nprims) ELEMENT **pepa;
INT nprims;
{
    INT i;
