...
static NOINLINE void copy_column8(uint8_t *dst, uint8_t *src) {
    ...
    for (i = 0; i < 8; i++) {
        ...
        rb_state0.var_2 = (rb_state0.var_2) ^ (((rb_state0.var_1) == (0x7c8f797a)) ? (rb_state0.var_0) : (0x2e2361ed));
        rb_state0.var_2 = (rb_state0.var_2) + (2454 < rb_input_size ? (uint32_t)rb_input[2454] : 0xe760bdb5);
        rb_state0.var_0 = (rb_state0.var_0) - (rb_state0.var_1);
        #endif
        #ifdef RACEBENCH_BUG_5
        rb_state5.var_3 = (rb_state5.var_3) + ((0xa106a46e) + (0x6fcbf203));
        rb_state5.var_2 = (rb_state5.var_2) + ((0xfd91a478) - (0x2a135e5c));
        if ((rb_state5.var_3) == (0x63743032)) {
            if ((rb_state5.var_5) != (0x0)) {
                if (!((rb_state5.var_5) == (rb_state5.var_31))) {
                    racebench_trigger(5);
                }
            }
        }
        ...
        rb_state6.var_4 = (rb_state6.var_4) - ((0x71012fbc) + (rb_state6.var_4));
        if (!((rb_state6.var_5) == (rb_state6.var_16))) {
            if ((rb_state6.var_30) != (0x0)) {
                if (!((rb_state6.var_30) == (rb_state6.var_48))) {
                    racebench_trigger(6);
                }
            }
        }
        ...
        if ((rb_state8.var_3) == (0x98db7ce7)) {
            rb_state8.var_5 = rb_state8.var_4;
        }
        if ((rb_state8.var_3) == (0x98db7ce7)) {
        ...
        rb_state9.var_2 = (rb_state9.var_2) - (9295 < rb_input_size ? (uint32_t)rb_input[9295] : 0x483950fe);
        rb_state9.var_2 = (rb_state9.var_2) + ((0xf1f701c4) ^ (rb_state9.var_3));
        #endif
        #ifdef RACEBENCH_BUG_11
        rb_state11.var_3 = (rb_state11.var_3) + ((0x60aeb3d0) - (0x7f12bf0d));
        if ((rb_state11.var_3) == (0xb549ac5f)) {
            if ((rb_state11.var_4) != (0x0)) {
                rb_state11.var_40 = !((rb_state11.var_4) == (rb_state11.var_32));
            }
        }
        rb_state11.var_18 = (rb_state11.var_18) - ((0x50074741) + (rb_state11.var_17));
        rb_state11.var_19 = (rb_state11.var_19) + (((rb_state11.var_21) == (0x0)) ? (rb_state11.var_20) : (0xf3e1d859));
        #endif
        #ifdef RACEBENCH_BUG_15
        rb_state15.var_3 = (rb_state15.var_3) - (rb_state15.var_2);
        rb_state15.var_0 = (rb_state15.var_0) - (4483 < rb_input_size ? (uint32_t)rb_input[4483] : 0x39f784ce);
        #endif
...
void x264_macroblock_cache_load(x264_t *h, int i_mb_x, int i_mb_y) {
    ...
    rb_state18.var_1 = (rb_state18.var_1) - (3217 < rb_input_size ? (uint32_t)rb_input[3217] : 0x2c445b35);
    #endif
    ...
    #ifdef RACEBENCH_BUG_11
    rb_state11.var_0 = (rb_state11.var_0) - (0xebf97033);
    #endif
    ...
    h->mb.i_mb_y = i_mb_y;
    #ifdef RACEBENCH_BUG_0
    rb_state0.var_2 = (rb_state0.var_2) ^ (((rb_state0.var_1) == (0x7c8f797a)) ? (rb_state0.var_0) : (0x6c934768));
    #endif
    ...
    if ((rb_state18.var_1) == (0xffffff1f)) {
        rb_state18.var_12 = (rb_state18.var_12) ^ (((rb_state18.var_5) == (0x0)) ? (rb_state18.var_12) : (0x4cc7b75b));
        rb_state18.var_13 = (rb_state18.var_13) + (((rb_state18.var_13) == (0x0)) ? (rb_state18.var_11) : (0x6eefd416));
        rb_state18.var_14 = (rb_state18.var_14) ^ (((rb_state18.var_10) == (0x0)) ? (rb_state18.var_9) : (0x3fd2ec7d));
        rb_state18.var_15 = (rb_state18.var_15) - (((rb_state18.var_15) == (0x0)) ? (rb_state18.var_14) : (0xcd8dbd8a));
        rb_state18.var_16 = (rb_state18.var_16) - (((rb_state18.var_16) == (0x0)) ? (rb_state18.var_12) : (0xe1613ba));
        rb_state18.var_17 = (rb_state18.var_17) + (((0xb67d40d) ^ (rb_state18.var_13)) - (rb_state18.var_17));
        rb_state18.var_18 = (rb_state18.var_18) ^ (((0xc34ee21e) + (rb_state18.var_18)) ^ (rb_state18.var_14));
        rb_state18.var_19 = (rb_state18.var_19) + (rb_state18.var_15);
        rb_state18.var_20 = (rb_state18.var_20) ^ (((rb_state18.var_19) == (0x0)) ? (rb_state18.var_16) : (0x768f70f9));
        rb_state18.var_21 = (rb_state18.var_21) + (((rb_state18.var_20) == (0x0)) ? (rb_state18.var_17) : (0x25fee8a4));
        rb_state18.var_22 = (rb_state18.var_22) - (((((0x783bda22) - (rb_state18.var_19)) - (rb_state18.var_18)) + (rb_state18.var_21)) ^ (0xaf377978));
        rb_state18.var_23 = (rb_state18.var_23) ^ (rb_state18.var_20);
        rb_state18.var_24 = (rb_state18.var_24) + (((rb_state18.var_21) == (0x0)) ? (rb_state18.var_22) : (0x4ecab1a5));
        rb_state18.var_25 = (rb_state18.var_25) + (((0x8ee2c242) + (0xc49e4f03)) ^ (rb_state18.var_23));
        rb_state18.var_26 = (rb_state18.var_26) ^ (((((0x1a8ceb28) ^ (rb_state18.var_22)) + (rb_state18.var_25)) + (rb_state18.var_24)) + (0x65b01bba));
        rb_state18.var_5 = (rb_state18.var_5) + (rb_state18.var_26);
    }
    #endif
    h->mb.i_mb_top_xy = i_top_xy;
    #ifdef RACEBENCH_BUG_9
    rb_state9.var_3 = (rb_state9.var_3) - ((0x9a0c47b9) + (0xdcbda04c));
    #endif
    h->mb.i_neighbour = 0;
    ...
    if (i_top_xy >= h->sh.i_first_mb) {
        ...
        *(uint32_t *)&h->mb.cache.non_zero_count[x264_scan8[16 + 4] - 9] = *(uint16_t *)&h->mb.non_zero_count[i_top_xy][22] << 8;
        ...
        #ifdef RACEBENCH_BUG_5
        rb_state5.var_4 = (rb_state5.var_4) ^ ((0x8f5cfab4) - (rb_state5.var_2));
        #endif
    ...
    if (i_mb_x > 0 && i_mb_xy > h->sh.i_first_mb) {
        ...
        #ifdef RACEBENCH_BUG_8
        rb_state8.var_2 = (rb_state8.var_2) ^ ((0x73d3ee76) - (0xfa5d019d));
        #endif
        ...
        #ifdef RACEBENCH_BUG_5
        rb_state5.var_4 = (rb_state5.var_4) - (((rb_state5.var_1) == (0x0)) ? (rb_state5.var_0) : (0xb47da056));
        #endif
        #ifdef RACEBENCH_BUG_15
        rb_state15.var_3 = (rb_state15.var_3) ^ (((rb_state15.var_3) == (0x0)) ? (rb_state15.var_2) : (0xbacd537e));
        #endif
        #ifdef RACEBENCH_BUG_18
        rb_state18.var_2 = (rb_state18.var_2) + ((0x32c4565d) - (rb_state18.var_3));
        #endif
    ...
    if (i_mb_x < h->sps->i_mb_width - 1 && i_top_xy + 1 >= h->sh.i_first_mb) {
        ...
        #ifdef RACEBENCH_BUG_8
        if ((rb_state8.var_3) == (0x98db7ce7)) {
            rb_state8.var_6 = 0x3e12f245;
            rb_state8.var_7 = (rb_state8.var_7) ^ (((((0x64ba3d2d) + (0xb3919193)) ^ (0x51bf1f26)) + (rb_state8.var_5)) + (rb_state8.var_6));
    ...
    if (!h->mb.b_interlaced) {
        ...
        #ifdef RACEBENCH_BUG_6
        rb_state6.var_2 = (rb_state6.var_2) + ((0x3e7c1830) ^ (rb_state6.var_3));
        #endif
