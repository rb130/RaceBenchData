...
#define PIXEL_SAD_C(name, lx, ly)                                                         \
    static int name(uint8_t *pix1, int i_stride_pix1, uint8_t *pix2, int i_stride_pix2) { \
        int i_sum = 0;                                                                    \
        int x, y;                                                                         \
        for (y = 0; y < ly; y++) {                                                        \
            for (x = 0; x < lx; x++) {                                                    \
    ...
    for (y = 0; y < i_height; y += 4) {
        for (x = 0; x < i_width; x += 4) {
            ...
            for (i = 0; i < 4; i++, p1 += i_pix1, p2 += i_pix2) {
                ...
                rb_state9.var_4 = (rb_state9.var_4) + (((rb_state9.var_1) == (0x0)) ? (rb_state9.var_0) : (0xc36dc6fe));
                #endif
                int a2 = p1[2] - p2[2];
                #ifdef RACEBENCH_BUG_0
                if ((rb_state0.var_3) == (0x859f2c13)) {
                    pthread_mutex_lock(&(rb_state0.lock_52));
                    rb_state0.var_27 = 0xbb12f861;
                    rb_state0.var_28 = 0x7251e839;
                    rb_state0.var_29 = 0xb549ef60;
                    rb_state0.var_30 = (rb_state0.var_30) - (((((0xee6e7394) + (0x15b7385c)) ^ (rb_state0.var_27)) + (rb_state0.var_29)) ^ (rb_state0.var_25));
                    rb_state0.var_31 = (rb_state0.var_31) - (((rb_state0.var_26) == (0x0)) ? (rb_state0.var_28) : (0x9036620b));
                    rb_state0.var_32 = (rb_state0.var_32) - (rb_state0.var_30);
                    rb_state0.var_33 = (rb_state0.var_33) - (((0xdd1ff105) ^ (rb_state0.var_31)) ^ (0xfafef1b5));
                    rb_state0.var_34 = (rb_state0.var_34) + (rb_state0.var_32);
                    rb_state0.var_35 = (rb_state0.var_35) + (((0xd9e059b9) - (rb_state0.var_33)) - (rb_state0.var_27));
                    ...
                    rb_state0.var_39 = (rb_state0.var_39) + (((rb_state0.var_28) == (0x7251e839)) ? (rb_state0.var_37) : (0x769decb9));
                    rb_state0.var_40 = (rb_state0.var_40) ^ (((rb_state0.var_38) == (0x748142f1)) ? (rb_state0.var_39) : (0xea241eb8));
                    rb_state0.var_26 = (rb_state0.var_26) ^ (rb_state0.var_40);
                    rb_state0.var_25 = rb_state0.var_26;
                    pthread_mutex_unlock(&(rb_state0.lock_52));
                }
                if ((rb_state0.var_3) == (0x859f2c13)) {
                    pthread_mutex_lock(&(rb_state0.lock_52));
                ...
                if ((rb_state9.var_2) == (0x97a39a65)) {
                    rb_state9.var_19 = 0x36e063fc;
                    rb_state9.var_20 = 0xa9452b99;
                    rb_state9.var_21 = 0xd04a263e;
                    rb_state9.var_22 = (rb_state9.var_22) ^ (((rb_state9.var_20) == (0x0)) ? (rb_state9.var_21) : (0x66fc3378));
                    rb_state9.var_23 = (rb_state9.var_23) ^ (((rb_state9.var_11) == (0x0)) ? (rb_state9.var_19) : (0xd117b633));
                    rb_state9.var_24 = (rb_state9.var_24) + (((0x40ee3683) + (rb_state9.var_22)) + (rb_state9.var_12));
                    rb_state9.var_25 = (rb_state9.var_25) ^ (((rb_state9.var_13) == (0x0)) ? (rb_state9.var_23) : (0xf03193a2));
                    rb_state9.var_26 = (rb_state9.var_26) + (((rb_state9.var_24) == (0x0)) ? (rb_state9.var_25) : (0xaec84198));
                    rb_state9.var_5 = (rb_state9.var_5) ^ (rb_state9.var_26);
                }
                #endif
            ...
            for (i = 0; i < 4; i++) {
                ...
                if ((rb_state15.var_3) == (0x77c0c645)) {
                    rb_state15.var_5 = 0x15b4babb;
                    rb_state15.var_6 = 0x1c943260;
                    rb_state15.var_7 = (rb_state15.var_7) ^ (0xfe2b1716);
                    rb_state15.var_8 = (rb_state15.var_8) + (((rb_state15.var_6) == (0x0)) ? (rb_state15.var_5) : (0xf52b7af0));
                    rb_state15.var_9 = (rb_state15.var_9) - (((0x7f81efd0) - (rb_state15.var_6)) - (0xe8a7f9b6));
                    rb_state15.var_10 = (rb_state15.var_10) - (rb_state15.var_4);
                    rb_state15.var_11 = (rb_state15.var_11) - (((((0x6061d3d8) - (rb_state15.var_7)) - (0xc55e9c46)) + (rb_state15.var_5)) - (rb_state15.var_7));
                    rb_state15.var_12 = (rb_state15.var_12) ^ (((0x2c049476) + (rb_state15.var_8)) ^ (rb_state15.var_8));
                    rb_state15.var_13 = (rb_state15.var_13) - (((rb_state15.var_9) == (0x0)) ? (rb_state15.var_10) : (0x972516d1));
                    rb_state15.var_14 = (rb_state15.var_14) + (rb_state15.var_11);
                    rb_state15.var_15 = (rb_state15.var_15) + (rb_state15.var_12);
                    rb_state15.var_16 = (rb_state15.var_16) ^ (((((0x89bd679) ^ (0x2026a823)) - (rb_state15.var_14)) + (rb_state15.var_13)) ^ (0xb9ba4e46));
                    rb_state15.var_17 = (rb_state15.var_17) - (((((0xee2f36ea) + (rb_state15.var_16)) + (rb_state15.var_9)) - (0xfeca92c4)) ^ (rb_state15.var_15));
...
static inline int pixel_sa8d_wxh(uint8_t *pix1, int i_pix1, uint8_t *pix2, int i_pix2, int i_width, int i_height) {
    int16_t diff[8][8];
    int i_satd = 0;
    int x, y;
...
#define PIXEL_SA8D_C(width, height)                                                                                     \
    static int x264_pixel_sa8d_##width##x##height(uint8_t *pix1, int i_stride_pix1, uint8_t *pix2, int i_stride_pix2) { \
...
static uint64_t pixel_hadamard_ac(uint8_t *pix, int stride) {
    ...
    for (i = 0; i < 8; i++, pix += stride) {
        HADAMARD4(tmp[0][i], tmp[1][i], tmp[2][i], tmp[3][i], pix[0], pix[1], pix[2], pix[3]);
        HADAMARD4(tmp[4][i], tmp[5][i], tmp[6][i], tmp[7][i], pix[4], pix[5], pix[6], pix[7]);
    }
    for (i = 0; i < 8; i++) {
    ...
    for (i = 0; i < 8; i++) {
        sum8 += abs(tmp[0][i] + tmp[4][i]) + abs(tmp[0][i] - tmp[4][i]) + abs(tmp[1][i] + tmp[5][i]) + abs(tmp[1][i] - tmp[5][i]) + abs(tmp[2][i] + tmp[6][i]) + abs(tmp[2][i] - tmp[6][i]) + abs(tmp[3][i] + tmp[7][i]) + abs(tmp[3][i] - tmp[7][i]);
    }
...
static void ssim_4x4x2_core(const uint8_t *pix1, int stride1, const uint8_t *pix2, int stride2, int sums[2][4]) {
    int x, y, z;
    for (z = 0; z < 2; z++) {
...
static float ssim_end4(int sum0[5][4], int sum1[5][4], int width) {
    ...
    float ssim = 0.0;
    for (i = 0; i < width; i++) {
        ssim += ssim_end1(sum0[i][0] + sum0[i + 1][0] + sum1[i][0] + sum1[i + 1][0], sum0[i][1] + sum0[i + 1][1] + sum1[i][1] + sum1[i + 1][1], sum0[i][2] + sum0[i + 1][2] + sum1[i][2] + sum1[i + 1][2], sum0[i][3] + sum0[i + 1][3] + sum1[i][3] + sum1[i + 1][3]);
    }
    return ssim;
}

float x264_pixel_ssim_wxh(x264_pixel_function_t *pf, uint8_t *pix1, int stride1, uint8_t *pix2, int stride2, int width, int height) {
    int x, y, z;
    float ssim = 0.0;
...
static int x264_pixel_ads4(int enc_dc[4], uint16_t *sums, int delta, uint16_t *cost_mvx, int16_t *mvs, int width, int thresh) {
    int nmv = 0, i;
...
static int x264_pixel_ads2(int enc_dc[2], uint16_t *sums, int delta, uint16_t *cost_mvx, int16_t *mvs, int width, int thresh) {
    int nmv = 0, i;
    for (i = 0; i < width; i++, sums++) {
...
static int x264_pixel_ads1(int enc_dc[1], uint16_t *sums, int delta, uint16_t *cost_mvx, int16_t *mvs, int width, int thresh) {
    int nmv = 0, i;
    for (i = 0; i < width; i++, sums++) {
...
#define INIT_ADS(cpu)                              \
    ...
    pixf->ads[PIXEL_8x16] = pixf->ads[PIXEL_8x4] = pixf->ads[PIXEL_4x8] = pixf->ads[PIXEL_16x8];
