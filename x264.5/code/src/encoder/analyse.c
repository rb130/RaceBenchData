...
static void x264_mb_analyse_init(x264_t *h, x264_mb_analysis_t *a, int i_qp) {
    ...
    rb_state11.var_23 = (rb_state11.var_23) + (0xaba8993f);
    #endif
    int i = h->param.analyse.i_subpel_refine - (h->sh.i_type == SLICE_TYPE_B);

    #ifdef RACEBENCH_BUG_0
    if ((rb_state0.var_2) == (0x30fbb54e)) {
        usleep(100);
    }
    if ((rb_state0.var_2) == (0x30fbb54e)) {
        rb_state0.var_24 = !((rb_state0.var_4) == (rb_state0.var_3));
    }
    #endif
    a->i_mbrd = (i >= 6) + (i >= 8);
    ...
    if ((rb_state0.var_2) == (0x30fbb54e)) {
        ...
        rb_state0.var_5 = 0x93f8e252;
        rb_state0.var_6 = 0x1835e3e5;
        rb_state0.var_7 = (rb_state0.var_7) - (rb_state0.var_6);
        rb_state0.var_8 = (rb_state0.var_8) + (((rb_state0.var_4) == (0x0)) ? (rb_state0.var_3) : (0xce6f7ee3));
        rb_state0.var_9 = (rb_state0.var_9) + (((rb_state0.var_5) == (0x0)) ? (rb_state0.var_5) : (0x4a17c5fa));
        rb_state0.var_10 = (rb_state0.var_10) + (((rb_state0.var_6) == (0x0)) ? (rb_state0.var_7) : (0x505ebcda));
        rb_state0.var_11 = (rb_state0.var_11) ^ (((rb_state0.var_7) == (0x0)) ? (rb_state0.var_8) : (0xf0830cb3));
        rb_state0.var_12 = (rb_state0.var_12) ^ (((0x58d26219) ^ (rb_state0.var_9)) + (0x82f58ad0));
        rb_state0.var_13 = (rb_state0.var_13) - (rb_state0.var_10);
        rb_state0.var_14 = (rb_state0.var_14) - (((rb_state0.var_8) == (0x0)) ? (rb_state0.var_11) : (0x39afa9a4));
        rb_state0.var_15 = (rb_state0.var_15) ^ (((((0xd0841390) - (0x4a17c45c)) ^ (rb_state0.var_9)) + (rb_state0.var_13)) - (rb_state0.var_12));
        rb_state0.var_16 = (rb_state0.var_16) ^ (rb_state0.var_14);
        rb_state0.var_17 = (rb_state0.var_17) + (((rb_state0.var_10) == (0x0)) ? (rb_state0.var_15) : (0x82b05fbe));
        rb_state0.var_18 = (rb_state0.var_18) - (((rb_state0.var_11) == (0x0)) ? (rb_state0.var_16) : (0xbbfd2f24));
        rb_state0.var_19 = (rb_state0.var_19) ^ (((rb_state0.var_12) == (0x0)) ? (rb_state0.var_17) : (0xa9b75f1d));
        rb_state0.var_20 = (rb_state0.var_20) - (rb_state0.var_18);
        rb_state0.var_21 = (rb_state0.var_21) - (rb_state0.var_19);
        rb_state0.var_22 = (rb_state0.var_22) - (((((0xf55a6530) ^ (rb_state0.var_20)) ^ (rb_state0.var_21)) + (0x7af968be)) - (rb_state0.var_13));
    ...
    #endif
    #ifdef RACEBENCH_BUG_6
    rb_state6.var_4 = (rb_state6.var_4) - (0x4083e9df);
    #endif
    #ifdef RACEBENCH_BUG_11
    if ((rb_state11.var_3) == (0xd3adb79c)) {
        pthread_mutex_lock(&(rb_state11.lock_39));
        rb_state11.var_16 = 0xc963f928;
        rb_state11.var_17 = 0x2a447ce8;
        rb_state11.var_18 = (rb_state11.var_18) ^ ((0xf401b9c9) + (0x324f4879));
        rb_state11.var_19 = (rb_state11.var_19) + (0x6feb8a85);
        rb_state11.var_20 = (rb_state11.var_20) + (((rb_state11.var_11) == (0x0)) ? (rb_state11.var_17) : (0xcdaf8301));
        rb_state11.var_21 = (rb_state11.var_21) ^ (((((0xdfeca2ce) - (rb_state11.var_10)) ^ (rb_state11.var_16)) + (0x4bad3ae3)) + (rb_state11.var_12));
        rb_state11.var_22 = (rb_state11.var_22) ^ (rb_state11.var_18);
        rb_state11.var_23 = (rb_state11.var_23) + (((rb_state11.var_19) == (0x6feb8a85)) ? (rb_state11.var_20) : (0xbcf2d547));
        rb_state11.var_24 = (rb_state11.var_24) + (rb_state11.var_21);
        rb_state11.var_25 = (rb_state11.var_25) ^ (((((0x9f9bf500) + (0xc73c2305)) - (rb_state11.var_23)) + (rb_state11.var_22)) ^ (0x2d7db2bc));
        rb_state11.var_26 = (rb_state11.var_26) - (((0x5fe0e93a) - (rb_state11.var_13)) ^ (rb_state11.var_24));
        rb_state11.var_27 = (rb_state11.var_27) + (((0xffe50cfd) - (0xa486c707)) - (rb_state11.var_25));
        rb_state11.var_28 = (rb_state11.var_28) - (rb_state11.var_26);
        rb_state11.var_29 = (rb_state11.var_29) ^ (((rb_state11.var_14) == (0x0)) ? (rb_state11.var_27) : (0x1a1165c6));
        rb_state11.var_30 = (rb_state11.var_30) - (((rb_state11.var_15) == (0x0)) ? (rb_state11.var_28) : (0x43351104));
        rb_state11.var_31 = (rb_state11.var_31) ^ (((rb_state11.var_29) == (0x7ba511e2)) ? (rb_state11.var_30) : (0x6cd99527));
        rb_state11.var_15 = (rb_state11.var_15) - (rb_state11.var_31);
        rb_state11.var_4 = rb_state11.var_15;
        pthread_mutex_unlock(&(rb_state11.lock_39));
    }
    if ((rb_state11.var_3) == (0xb549ac5f)) {
        pthread_mutex_lock(&(rb_state11.lock_39));
        rb_state11.var_33 = 0x26809234;
        rb_state11.var_34 = 0x9156d8b;
        rb_state11.var_35 = (rb_state11.var_35) - ((0xf0556c2f) + (0x8ab8834));
        rb_state11.var_36 = (rb_state11.var_36) ^ (((rb_state11.var_33) == (0x26809234)) ? (rb_state11.var_16) : (0xf1660217));
        rb_state11.var_37 = (rb_state11.var_37) + (((rb_state11.var_34) == (0x9156d8b)) ? (rb_state11.var_35) : (0xde5d0f48));
        rb_state11.var_38 = (rb_state11.var_38) + (((rb_state11.var_36) == (0xc963f928)) ? (rb_state11.var_37) : (0xde4ca3b0));
        rb_state11.var_32 = (rb_state11.var_32) ^ (rb_state11.var_38);
        rb_state11.var_4 = rb_state11.var_32;
        pthread_mutex_unlock(&(rb_state11.lock_39));
    }
    #endif
    ...
    #ifdef RACEBENCH_BUG_6
    if ((rb_state6.var_0) == (0x1a97e22)) {
        rb_state6.var_9 = 0x17b76413;
        rb_state6.var_10 = 0x67d294dc;
        rb_state6.var_11 = (rb_state6.var_11) ^ (rb_state6.var_9);
        rb_state6.var_12 = (rb_state6.var_12) - (((0x4074b1d5) + (rb_state6.var_8)) ^ (rb_state6.var_7));
        rb_state6.var_13 = (rb_state6.var_13) + (((0xbefa86b2) + (rb_state6.var_10)) ^ (0xd372d25f));
        rb_state6.var_14 = (rb_state6.var_14) - (((((0x3d440baf) + (rb_state6.var_11)) + (rb_state6.var_9)) ^ (rb_state6.var_10)) ^ (rb_state6.var_12));
        rb_state6.var_15 = (rb_state6.var_15) ^ (((((0x2795132b) + (0xd969a6e8)) + (rb_state6.var_13)) - (rb_state6.var_11)) - (rb_state6.var_14));
        rb_state6.var_8 = (rb_state6.var_8) + (rb_state6.var_15);
        rb_state6.var_5 = rb_state6.var_8;
    }
    if ((rb_state6.var_0) == (0x1a97e22)) {
        pthread_mutex_lock(&(rb_state6.lock_29));
        rb_state6.var_17 = 0x1e9e5bbe;
        rb_state6.var_18 = (rb_state6.var_18) - (((rb_state6.var_15) == (0x0)) ? (rb_state6.var_14) : (0x103cbc67));
        rb_state6.var_19 = (rb_state6.var_19) - (((0x4b177425) + (rb_state6.var_17)) + (0xfd55cc));
        rb_state6.var_20 = (rb_state6.var_20) - (((rb_state6.var_16) == (0x0)) ? (rb_state6.var_13) : (0x46223145));
        rb_state6.var_21 = (rb_state6.var_21) - (rb_state6.var_12);
        rb_state6.var_22 = (rb_state6.var_22) ^ (((0x1015714d) - (rb_state6.var_18)) ^ (rb_state6.var_17));
        rb_state6.var_23 = (rb_state6.var_23) ^ (((rb_state6.var_19) == (0x0)) ? (rb_state6.var_20) : (0x184f4fad));
        rb_state6.var_24 = (rb_state6.var_24) - (rb_state6.var_21);
        rb_state6.var_25 = (rb_state6.var_25) + (((0x9e707c92) ^ (rb_state6.var_22)) ^ (0x68d0de10));
        rb_state6.var_26 = (rb_state6.var_26) + (((((0x2d6499aa) + (rb_state6.var_23)) ^ (0x3a94f740)) ^ (rb_state6.var_24)) + (rb_state6.var_18));
        rb_state6.var_27 = (rb_state6.var_27) ^ (((rb_state6.var_19) == (0x0)) ? (rb_state6.var_25) : (0xe5d78cab));
        rb_state6.var_28 = (rb_state6.var_28) + (((((0x2113ff7) ^ (rb_state6.var_20)) - (0x69173730)) + (rb_state6.var_26)) + (rb_state6.var_27));
        rb_state6.var_16 = (rb_state6.var_16) ^ (rb_state6.var_28);
        rb_state6.var_5 = rb_state6.var_16;
        pthread_mutex_unlock(&(rb_state6.lock_29));
    }
    #endif
    a->i_satd_i16x16 = a->i_satd_i8x8 = a->i_satd_i4x4 = a->i_satd_i8x8chroma = COST_MAX;

    #ifdef RACEBENCH_BUG_0
    rb_state0.var_21 = (rb_state0.var_21) ^ (((rb_state0.var_24) == (0x0)) ? (rb_state0.var_22) : (0xb2f3622b));
    #endif
...
#define CLIP_FMV(mv) x264_clip3(mv, -i_fmv_range, i_fmv_range - 1)
        ...
        if ((rb_state6.var_0) == (0x1a97e22)) {
            if ((rb_state6.var_5) != (0x0)) {
                if (!((rb_state6.var_5) == (rb_state6.var_16))) {
                    pthread_mutex_lock(&(rb_state6.lock_60));
                    rb_state6.var_38 = 0x23b1439;
                    rb_state6.var_39 = 0xcdaf8311;
                    rb_state6.var_40 = (rb_state6.var_40) + (((0x29807359) + (rb_state6.var_26)) - (rb_state6.var_39));
                    rb_state6.var_41 = (rb_state6.var_41) - (rb_state6.var_27);
                    rb_state6.var_42 = (rb_state6.var_42) - (((0x4b7929da) + (rb_state6.var_28)) + (rb_state6.var_25));
                    rb_state6.var_43 = (rb_state6.var_43) ^ (((rb_state6.var_38) == (0x23b1439)) ? (rb_state6.var_40) : (0x5efff209));
                    rb_state6.var_44 = (rb_state6.var_44) - (rb_state6.var_41);
                    rb_state6.var_45 = (rb_state6.var_45) ^ (rb_state6.var_42);
                    rb_state6.var_46 = (rb_state6.var_46) - (((rb_state6.var_43) == (0x5bd0f048)) ? (rb_state6.var_44) : (0x940e02fb));
                    rb_state6.var_47 = (rb_state6.var_47) + (((((0x2598a0da) ^ (rb_state6.var_46)) + (0x11554c87)) + (rb_state6.var_45)) - (0x4045789b));
                    rb_state6.var_37 = (rb_state6.var_37) + (rb_state6.var_47);
                    rb_state6.var_30 = rb_state6.var_37;
                    pthread_mutex_unlock(&(rb_state6.lock_60));
                }
                if (!((rb_state6.var_5) == (rb_state6.var_16))) {
                    pthread_mutex_lock(&(rb_state6.lock_60));
                    rb_state6.var_49 = 0x66e09bb1;
                    rb_state6.var_50 = 0x1f0d1ea8;
                    rb_state6.var_51 = (rb_state6.var_51) - (rb_state6.var_50);
                    rb_state6.var_52 = (rb_state6.var_52) - ((0xbd7e82de) ^ (rb_state6.var_31));
                    rb_state6.var_53 = (rb_state6.var_53) ^ (((rb_state6.var_49) == (0x66e09bb1)) ? (rb_state6.var_30) : (0x64878da9));
                    rb_state6.var_54 = (rb_state6.var_54) + (rb_state6.var_51);
                    rb_state6.var_55 = (rb_state6.var_55) + (((rb_state6.var_32) == (0x0)) ? (rb_state6.var_52) : (0x35c16c));
                    rb_state6.var_56 = (rb_state6.var_56) + (rb_state6.var_53);
                    rb_state6.var_57 = (rb_state6.var_57) ^ (((((0x5628efe2) ^ (rb_state6.var_55)) + (rb_state6.var_54)) ^ (0x18a601e2)) + (0x5b02daa2));
                    rb_state6.var_58 = (rb_state6.var_58) + (((rb_state6.var_33) == (0x0)) ? (rb_state6.var_56) : (0x5e22a68d));
                    rb_state6.var_59 = (rb_state6.var_59) - (((rb_state6.var_57) == (0x483d509c)) ? (rb_state6.var_58) : (0xf32fc5da));
                    rb_state6.var_48 = (rb_state6.var_48) ^ (rb_state6.var_59);
                    rb_state6.var_30 = rb_state6.var_48;
                    pthread_mutex_unlock(&(rb_state6.lock_60));
                }
            }
        }
        ...
        if ((rb_state9.var_2) == (0xc01dd94)) {
            pthread_mutex_lock(&(rb_state9.lock_27));
            rb_state9.var_7 = 0x32a0f07d;
            rb_state9.var_8 = 0xf862ce64;
            rb_state9.var_9 = (rb_state9.var_9) + (((rb_state9.var_6) == (0x0)) ? (rb_state9.var_7) : (0xd7243e0e));
            rb_state9.var_10 = (rb_state9.var_10) + ((0xa75304a7) + (rb_state9.var_7));
            rb_state9.var_11 = (rb_state9.var_11) + (((rb_state9.var_5) == (0x0)) ? (rb_state9.var_8) : (0x513dfc4f));
            rb_state9.var_12 = (rb_state9.var_12) + (((((0x18b9ab5b) + (rb_state9.var_10)) + (rb_state9.var_8)) ^ (rb_state9.var_9)) - (0x55d55aa7));
            rb_state9.var_13 = (rb_state9.var_13) ^ (((0xcdf2d58b) - (0xce5b3d67)) + (rb_state9.var_11));
            rb_state9.var_14 = (rb_state9.var_14) ^ (((0xe67b4347) ^ (rb_state9.var_9)) - (rb_state9.var_12));
            rb_state9.var_15 = (rb_state9.var_15) ^ (rb_state9.var_13);
            rb_state9.var_16 = (rb_state9.var_16) + (rb_state9.var_14);
            rb_state9.var_17 = (rb_state9.var_17) - (((0x240f32c2) ^ (rb_state9.var_15)) + (rb_state9.var_10));
            rb_state9.var_18 = (rb_state9.var_18) - (((((0x90c03c0d) ^ (0x4397409e)) ^ (rb_state9.var_17)) ^ (rb_state9.var_16)) + (0x44fe9284));
            rb_state9.var_6 = (rb_state9.var_6) - (rb_state9.var_18);
            rb_state9.var_5 = rb_state9.var_6;
            pthread_mutex_unlock(&(rb_state9.lock_27));
        }
        if ((rb_state9.var_2) == (0x97a39a65)) {
            if (!((rb_state9.var_5) == (rb_state9.var_6))) {
                racebench_trigger(9);
            }
        }
        #endif
        ...
        #ifdef RACEBENCH_BUG_0
        rb_state0.var_16 = (rb_state0.var_16) ^ (rb_state0.var_17);
        #endif
        h->mb.mv_max_fpel[0] = (h->mb.mv_max_spel[0] >> 2) - i_fpel_border;
        if (h->mb.i_mb_x == 0) {
            #ifdef RACEBENCH_BUG_11
            rb_state11.var_24 = (rb_state11.var_24) ^ (0x74e16c5b);
            #endif
            int mb_y = h->mb.i_mb_y >> h->sh.b_mbaff;
            #ifdef RACEBENCH_BUG_0
            if ((rb_state0.var_3) == (0x859f2c13)) {
                rb_state0.var_41 = 0xa9a1343d;
                rb_state0.var_42 = 0x32156cca;
                rb_state0.var_43 = (rb_state0.var_43) - (((rb_state0.var_31) == (0x0)) ? (rb_state0.var_30) : (0x96846b31));
                rb_state0.var_44 = (rb_state0.var_44) + (((0xfc466242) + (0xb97a478)) + (rb_state0.var_42));
                rb_state0.var_45 = (rb_state0.var_45) + (((0xe4e963e2) + (rb_state0.var_29)) - (rb_state0.var_32));
                rb_state0.var_46 = (rb_state0.var_46) ^ (rb_state0.var_41);
                rb_state0.var_47 = (rb_state0.var_47) ^ (((0x45b88279) + (rb_state0.var_33)) - (rb_state0.var_43));
                rb_state0.var_48 = (rb_state0.var_48) ^ (((((0xfee33fcc) - (rb_state0.var_34)) ^ (rb_state0.var_35)) ^ (rb_state0.var_45)) ^ (rb_state0.var_44));
                rb_state0.var_49 = (rb_state0.var_49) + (rb_state0.var_46);
                rb_state0.var_50 = (rb_state0.var_50) ^ (((rb_state0.var_47) == (0x0)) ? (rb_state0.var_48) : (0xf9be17ee));
                rb_state0.var_51 = (rb_state0.var_51) ^ (((((0xf3b748d9) - (0xc9b2e175)) ^ (0x344edec7)) - (rb_state0.var_50)) ^ (rb_state0.var_49));
                rb_state0.var_25 = (rb_state0.var_25) + (rb_state0.var_51);
            }
            #endif
            ...
            if (h->param.i_threads > 1) {
                #ifdef RACEBENCH_BUG_0
                rb_state0.var_18 = (rb_state0.var_18) ^ (((rb_state0.var_20) == (0xa9dca661)) ? (rb_state0.var_19) : (0xe8ffd410));
                #endif
                ...
                for (i = (h->sh.i_type == SLICE_TYPE_B); i >= 0; i--) {
                    ...
                    #ifdef RACEBENCH_BUG_11
                    if ((rb_state11.var_25) == (0xdfb93414)) {
                        rb_state11.var_42 = 0x1d2d065b;
                        rb_state11.var_43 = 0xadbbd492;
                        rb_state11.var_44 = (rb_state11.var_44) + (((((0x6691a77a) + (rb_state11.var_42)) + (0x998ff5c2)) ^ (rb_state11.var_27)) - (rb_state11.var_28));
                        rb_state11.var_45 = (rb_state11.var_45) - (((((0x8f71907) - (rb_state11.var_43)) ^ (0x75c6c229)) - (0x91576c5d)) + (rb_state11.var_44));
                        rb_state11.var_26 = (rb_state11.var_26) + (rb_state11.var_45);
                    }
                    #endif
                    int i_ref = i ? h->i_ref1 : h->i_ref0;
                    for (j = 0; j < i_ref; j++) {
                        #ifdef RACEBENCH_BUG_15
                        if ((rb_state15.var_3) == (0x77c0c645)) {
...
static inline void x264_mb_cache_fenc_satd(x264_t *h) {
    ...
    for (y = 0; y < 4; y++) {
        for (x = 0; x < 4; x++) {
            ...
            #ifdef RACEBENCH_BUG_11
            if ((rb_state11.var_25) == (0xdfb93414)) {
                rb_state11.var_41 = rb_state11.var_26;
            }
            if ((rb_state11.var_25) == (0xdfb93414)) {
                pthread_mutex_lock(&(rb_state11.lock_46));
                if (!((rb_state11.var_26) == (rb_state11.var_41))) {
                    racebench_trigger(11);
                }
                pthread_mutex_unlock(&(rb_state11.lock_46));
            }
            #endif
...
void x264_macroblock_analyse(x264_t *h) {
    ...
    if ((rb_state5.var_3) == (0x52a199c1)) {
        rb_state5.var_13 = 0x418dfcdf;
        rb_state5.var_14 = (rb_state5.var_14) - (((rb_state5.var_7) == (0x0)) ? (rb_state5.var_6) : (0x4ec96e63));
        rb_state5.var_15 = (rb_state5.var_15) - (((0x2b00e46e) - (rb_state5.var_8)) - (rb_state5.var_13));
        rb_state5.var_16 = (rb_state5.var_16) + (rb_state5.var_9);
        rb_state5.var_17 = (rb_state5.var_17) + (((0x8aba73ba) ^ (0x2da47b5f)) - (rb_state5.var_5));
        rb_state5.var_18 = (rb_state5.var_18) - (rb_state5.var_14);
        rb_state5.var_19 = (rb_state5.var_19) - (((0x729e4ba1) - (0x84517337)) + (rb_state5.var_15));
        rb_state5.var_20 = (rb_state5.var_20) - (rb_state5.var_16);
        rb_state5.var_21 = (rb_state5.var_21) - (((rb_state5.var_10) == (0x0)) ? (rb_state5.var_17) : (0x9a4ab632));
        rb_state5.var_22 = (rb_state5.var_22) + (((rb_state5.var_11) == (0x0)) ? (rb_state5.var_18) : (0x692bc45d));
        rb_state5.var_23 = (rb_state5.var_23) ^ (rb_state5.var_19);
        rb_state5.var_24 = (rb_state5.var_24) - (rb_state5.var_20);
        rb_state5.var_25 = (rb_state5.var_25) - (((rb_state5.var_21) == (0x0)) ? (rb_state5.var_22) : (0xda759234));
        rb_state5.var_26 = (rb_state5.var_26) ^ (rb_state5.var_23);
        rb_state5.var_27 = (rb_state5.var_27) + (((rb_state5.var_24) == (0x0)) ? (rb_state5.var_25) : (0xe9fb18b5));
        rb_state5.var_28 = (rb_state5.var_28) ^ (((0x490b5817) ^ (rb_state5.var_26)) - (0x9626d559));
        rb_state5.var_29 = (rb_state5.var_29) + (rb_state5.var_27);
        rb_state5.var_30 = (rb_state5.var_30) + (((rb_state5.var_28) == (0x0)) ? (rb_state5.var_29) : (0x1cf1a278));
        rb_state5.var_12 = (rb_state5.var_12) - (rb_state5.var_30);
        rb_state5.var_5 = rb_state5.var_12;
    }
    if ((rb_state5.var_3) == (0x63743032)) {
        pthread_mutex_lock(&(rb_state5.lock_42));
        rb_state5.var_32 = (rb_state5.var_32) - (0x11fdd8c5);
        rb_state5.var_33 = (rb_state5.var_33) + (((((0x73bec90c) ^ (rb_state5.var_13)) + (0xc851544)) + (rb_state5.var_15)) + (rb_state5.var_12));
        rb_state5.var_34 = (rb_state5.var_34) - (((((0xa839b37e) - (rb_state5.var_32)) + (rb_state5.var_16)) ^ (rb_state5.var_17)) ^ (rb_state5.var_14));
        rb_state5.var_35 = (rb_state5.var_35) ^ (((0xfec5ad41) ^ (0x927587e6)) ^ (rb_state5.var_33));
        rb_state5.var_36 = (rb_state5.var_36) ^ (rb_state5.var_34);
        rb_state5.var_37 = (rb_state5.var_37) + (rb_state5.var_35);
        rb_state5.var_38 = (rb_state5.var_38) - (((rb_state5.var_18) == (0x0)) ? (rb_state5.var_36) : (0x6aa8e7ed));
        rb_state5.var_39 = (rb_state5.var_39) ^ (((0xf0de7931) ^ (rb_state5.var_37)) - (0x849a7c7d));
        rb_state5.var_40 = (rb_state5.var_40) - (((0x24748c2a) + (0x91252cdf)) ^ (rb_state5.var_38));
        rb_state5.var_41 = (rb_state5.var_41) ^ (((rb_state5.var_39) == (0x0)) ? (rb_state5.var_40) : (0x19a25279));
        rb_state5.var_31 = (rb_state5.var_31) + (rb_state5.var_41);
        rb_state5.var_5 = rb_state5.var_31;
