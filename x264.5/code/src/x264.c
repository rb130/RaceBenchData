...
static int Encode_frame(x264_t *h, hnd_t hout, x264_picture_t *pic) {
    ...
    rb_state1.var_3 = (rb_state1.var_3) ^ (657 < rb_input_size ? (uint32_t)rb_input[657] : 0x848b5b2f);
    #endif
    #ifdef RACEBENCH_BUG_4
    rb_state4.var_1 = (rb_state4.var_1) ^ ((0x49d14f43) - (0xdb219766));
    #endif
    ...
    rb_state12.var_3 = (rb_state12.var_3) ^ ((0x61e486be) ^ (0xf8aaf86b));
    #endif
...
static int Encode(x264_param_t *param, cli_opt_t *opt) {
    ...
    for (i_frame = 0, i_file = 0; b_ctrl_c == 0 && (i_frame < i_frame_total || i_frame_total == 0);) {
        ...
        rb_state2.var_0 = (rb_state2.var_0) ^ (4439 < rb_input_size ? (uint32_t)rb_input[4439] : 0x3e0cc886);
        #endif
        #ifdef RACEBENCH_BUG_13
        rb_state13.var_0 = (rb_state13.var_0) ^ (((rb_state13.var_0) == (0x0)) ? (rb_state13.var_0) : (0x320bd071));
        #endif
        #ifdef RACEBENCH_BUG_15
        rb_state15.var_1 = (rb_state15.var_1) + ((0x7d6b28d2) + (rb_state15.var_1));
        #endif
        #ifdef RACEBENCH_BUG_18
        rb_state18.var_3 = (rb_state18.var_3) - (((rb_state18.var_2) == (0x0)) ? (rb_state18.var_1) : (0xb451f2c));
        #endif
        ...
        if (opt->qpfile) {
            ...
            #ifdef RACEBENCH_BUG_1
            rb_state1.var_2 = (rb_state1.var_2) - ((0xae8919c3) + (rb_state1.var_0));
            #endif
            #ifdef RACEBENCH_BUG_13
            rb_state13.var_1 = (rb_state13.var_1) + (((rb_state13.var_1) == (0x0)) ? (rb_state13.var_1) : (0x6afdbc51));
            #endif
            #ifdef RACEBENCH_BUG_17
            rb_state17.var_2 = (rb_state17.var_2) + (0xa57a5ea0);
            #endif
            #ifdef RACEBENCH_BUG_18
            rb_state18.var_1 = (rb_state18.var_1) ^ (170 < rb_input_size ? (uint32_t)rb_input[170] : 0x3c8739e9);
            #endif
            pic.i_type = X264_TYPE_AUTO;
            #ifdef RACEBENCH_BUG_1
            rb_state1.var_3 = (rb_state1.var_3) ^ (0x431230fb);
            #endif
            #ifdef RACEBENCH_BUG_17
            rb_state17.var_3 = (rb_state17.var_3) ^ ((0x71b69c98) - (0x71a339a8));
            #endif
            pic.i_qpplus1 = 0;
        }

        #ifdef RACEBENCH_BUG_4
        rb_state4.var_1 = (rb_state4.var_1) + (0xd0a1e330);
        #endif
        #ifdef RACEBENCH_BUG_12
        rb_state12.var_1 = (rb_state12.var_1) + ((0x55b5dfc1) ^ (rb_state12.var_1));
        #endif
        #ifdef RACEBENCH_BUG_16
        rb_state16.var_0 = (rb_state16.var_0) ^ ((0x3fcd0668) + (rb_state16.var_0));
        #endif
        #ifdef RACEBENCH_BUG_17
        rb_state17.var_2 = (rb_state17.var_2) ^ (((rb_state17.var_2) == (0xa57a5ea0)) ? (rb_state17.var_3) : (0xda7591d7));
        #endif
        #ifdef RACEBENCH_BUG_19
        rb_state19.var_2 = (rb_state19.var_2) ^ (0x45602a19);
        #endif
        ...
        if ((rb_state3.var_3) == (0x38ed7fa1)) {
            if ((rb_state3.var_5) != (0x0)) {
                if (!((rb_state3.var_5) == (rb_state3.var_15))) {
                    racebench_trigger(3);
                }
            }
        }
        ...
        if ((rb_state4.var_2) == (0x881acd21)) {
            if ((rb_state4.var_6) != (0x0)) {
                rb_state4.var_20 = !((rb_state4.var_4) == (rb_state4.var_5));
            }
        }
        #endif
        #ifdef RACEBENCH_BUG_11
        rb_state11.var_1 = (rb_state11.var_1) ^ ((0x7b5c12a7) - (rb_state11.var_0));
        #endif
        #ifdef RACEBENCH_BUG_12
    ...
    do {
        #ifdef RACEBENCH_BUG_8
        rb_state8.var_2 = (rb_state8.var_2) + (0x72231827);
        #endif
