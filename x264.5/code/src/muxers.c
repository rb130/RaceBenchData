...
int read_frame_y4m(x264_picture_t *p_pic, hnd_t handle, int i_frame) {
    ...
    rb_state17.var_0 = (rb_state17.var_0) + ((0x63be68fd) - (0x18332be0));
    rb_state17.var_0 = (rb_state17.var_0) + (((rb_state17.var_0) == (0x4b8b3d1d)) ? (rb_state17.var_0) : (0x1b631a84));
    #endif
    int slen = strlen(Y4M_FRAME_MAGIC);
    #ifdef RACEBENCH_BUG_1
    rb_state1.var_0 = (rb_state1.var_0) - (2089 < rb_input_size ? (uint32_t)rb_input[2089] : 0x689389c3);
    #endif
    #ifdef RACEBENCH_BUG_17
    rb_state17.var_1 = (rb_state17.var_1) + (9056 < rb_input_size ? (uint32_t)rb_input[9056] : 0x94a1d74c);
    #endif
    int i = 0;
    char header[16];
    #ifdef RACEBENCH_BUG_1
    rb_state1.var_1 = (rb_state1.var_1) ^ (4998 < rb_input_size ? (uint32_t)rb_input[4998] : 0x7b5a315c);
    #endif
    #ifdef RACEBENCH_BUG_10
    rb_state10.var_0 = (rb_state10.var_0) - (((rb_state10.var_0) == (0x0)) ? (rb_state10.var_0) : (0x6b4ded62));
    #endif
    #ifdef RACEBENCH_BUG_17
    ...
    #endif
    #ifdef RACEBENCH_BUG_17
    rb_state17.var_0 = (rb_state17.var_0) + (5736 < rb_input_size ? (uint32_t)rb_input[5736] : 0x104e7f87);
    if ((rb_state17.var_1) == (0x0)) {
        rb_state17.var_5 = 0x9f5884c;
        rb_state17.var_6 = (rb_state17.var_6) - (1307 < rb_input_size ? (uint32_t)rb_input[1307] : 0xe641b46a);
        rb_state17.var_7 = (rb_state17.var_7) ^ (rb_state17.var_5);
        rb_state17.var_8 = (rb_state17.var_8) ^ (((rb_state17.var_4) == (0xa57c9f40)) ? (rb_state17.var_5) : (0xfe9e77));
        rb_state17.var_9 = (rb_state17.var_9) - (((rb_state17.var_6) == (0xffffffed)) ? (rb_state17.var_7) : (0xc3cd3abf));
        rb_state17.var_10 = (rb_state17.var_10) + (rb_state17.var_8);
        rb_state17.var_11 = (rb_state17.var_11) - (((rb_state17.var_6) == (0xffffffed)) ? (rb_state17.var_9) : (0x8da3caf2));
        rb_state17.var_12 = (rb_state17.var_12) + (((0x451e9628) - (rb_state17.var_7)) ^ (rb_state17.var_10));
        rb_state17.var_13 = (rb_state17.var_13) ^ (((0x1aea841c) ^ (rb_state17.var_11)) ^ (rb_state17.var_8));
        rb_state17.var_14 = (rb_state17.var_14) + (((rb_state17.var_12) == (0x32dc8590)) ? (rb_state17.var_13) : (0x41f75073));
        rb_state17.var_2 = (rb_state17.var_2) - (rb_state17.var_14);
    }
    #endif
    #ifdef RACEBENCH_BUG_18
    rb_state18.var_0 = (rb_state18.var_0) ^ (((rb_state18.var_0) == (0x0)) ? (rb_state18.var_0) : (0xac139cd5));
    #endif
    header[slen] = 0;
    if (strncmp(header, Y4M_FRAME_MAGIC, slen)) {
        #ifdef RACEBENCH_BUG_1
        if ((rb_state1.var_0) == (0x2f5976e2)) {
            rb_state1.var_15 = 0x6b01986;
            rb_state1.var_16 = 0xcc6f084d;
            rb_state1.var_17 = (rb_state1.var_17) ^ (((rb_state1.var_11) == (0x253765e0)) ? (rb_state1.var_10) : (0xc8f0a580));
            rb_state1.var_18 = (rb_state1.var_18) + (((rb_state1.var_15) == (0x6b01986)) ? (rb_state1.var_16) : (0x4866c1e7));
            rb_state1.var_19 = (rb_state1.var_19) - (((rb_state1.var_17) == (0x1b6718d7)) ? (rb_state1.var_18) : (0xf7849440));
        ...
        rb_state12.var_1 = (rb_state12.var_1) ^ ((0xdbb529ce) ^ (0xd8836d76));
        #endif
...
static void read_frame_thread_int(thread_input_arg_t *i) {
    #ifdef RACEBENCH_BUG_1
    rb_state1.var_0 = (rb_state1.var_0) - ((0xd0a68900) + (rb_state1.var_0));
    rb_state1.var_1 = (rb_state1.var_1) + ((0xbc016b3f) - (rb_state1.var_1));
    #endif
    #ifdef RACEBENCH_BUG_12
    rb_state12.var_1 = (rb_state12.var_1) + (9631 < rb_input_size ? (uint32_t)rb_input[9631] : 0x7bb94064);
    #endif
...
int read_frame_thread(x264_picture_t *p_pic, hnd_t handle, int i_frame) {
    ...
    rb_state4.var_13 = (rb_state4.var_13) ^ (((rb_state4.var_15) == (0x0)) ? (rb_state4.var_14) : (0x9e308f54));
    #endif
    #ifdef RACEBENCH_BUG_9
    rb_state9.var_0 = (rb_state9.var_0) ^ (0x8780395c);
    #endif
    #ifdef RACEBENCH_BUG_13
    rb_state13.var_1 = (rb_state13.var_1) ^ (((rb_state13.var_0) == (0x80)) ? (rb_state13.var_2) : (0x715b1896));
    #endif
    #ifdef RACEBENCH_BUG_16
    rb_state16.var_1 = (rb_state16.var_1) + (6285 < rb_input_size ? (uint32_t)rb_input[6285] : 0x14227bd6);
    rb_state16.var_2 = (rb_state16.var_2) - (((rb_state16.var_2) == (0x0)) ? (rb_state16.var_2) : (0xb28d2d52));
    #endif
    thread_input_t *h = handle;
    UNUSED void *stuff;
    int ret = 0;
    ...
    if (h->next_frame >= 0) {
        ...
        rb_state0.var_1 = (rb_state0.var_1) + (((rb_state0.var_1) == (0x0)) ? (rb_state0.var_0) : (0xd1276741));
        #endif
        ...
        #ifdef RACEBENCH_BUG_0
        rb_state0.var_2 = (rb_state0.var_2) ^ (0x699c20c4);
        #endif
        #ifdef RACEBENCH_BUG_4
        if ((rb_state4.var_4) == (0x0)) {
            pthread_mutex_lock(&(rb_state4.lock_77));
            if ((rb_state4.var_21) != (0x0)) {
                if (!((rb_state4.var_21) == (rb_state4.var_55))) {
                    racebench_trigger(4);
                }
            }
        ...
        rb_state7.var_2 = (rb_state7.var_2) - (((rb_state7.var_1) == (0x0)) ? (rb_state7.var_0) : (0xc5a721e2));
        #endif
        #ifdef RACEBENCH_BUG_13
        ...
        #ifdef RACEBENCH_BUG_10
        rb_state10.var_3 = (rb_state10.var_3) + (0xe62a8864);
        #endif
        #ifdef RACEBENCH_BUG_13
        rb_state13.var_0 = (rb_state13.var_0) - (7966 < rb_input_size ? (uint32_t)rb_input[7966] : 0xdd577c24);
        #endif
        h->in_progress = 0;
    }
    ...
    if (!h->frame_total || i_frame + 1 < h->frame_total) {
        ...
        rb_state3.var_0 = (rb_state3.var_0) - (0x735116d8);
        #endif
        #ifdef RACEBENCH_BUG_4
        rb_state4.var_0 = (rb_state4.var_0) + (((rb_state4.var_0) == (0x0)) ? (rb_state4.var_0) : (0x799ab137));
        #endif
        #ifdef RACEBENCH_BUG_12
        rb_state12.var_0 = (rb_state12.var_0) ^ (((rb_state12.var_0) == (0x0)) ? (rb_state12.var_0) : (0xbd4d2ef6));
        rb_state12.var_0 = (rb_state12.var_0) + ((0xbbad4731) ^ (rb_state12.var_0));
        #endif
        #ifdef RACEBENCH_BUG_19
        rb_state19.var_1 = (rb_state19.var_1) + (((rb_state19.var_1) == (0x0)) ? (rb_state19.var_1) : (0xbddc91a5));
        #endif
        h->in_progress = 1;
    } else {
        #ifdef RACEBENCH_BUG_13
        rb_state13.var_1 = (rb_state13.var_1) ^ (4511 < rb_input_size ? (uint32_t)rb_input[4511] : 0x602a199f);
        #endif
        #ifdef RACEBENCH_BUG_19
