...
static int pixel_satd_wxh(uint8_t *pix1, int i_pix1, uint8_t *pix2, int i_pix2, int i_width, int i_height) {
    ...
    if ((rb_state13.var_50) == (0x15884bb2)) {
        pthread_mutex_lock(&(rb_state13.lock_96));
        rb_state13.var_80 = 0xcf495511;
        rb_state13.var_81 = (rb_state13.var_81) ^ (((rb_state13.var_55) == (0xf6caf793)) ? (rb_state13.var_54) : (0xf44a933d));
        rb_state13.var_82 = (rb_state13.var_82) - (((((0xd9fbedc8) + (rb_state13.var_56)) ^ (0xbc76e291)) + (rb_state13.var_80)) ^ (rb_state13.var_53));
        rb_state13.var_83 = (rb_state13.var_83) - (rb_state13.var_81);
        rb_state13.var_84 = (rb_state13.var_84) - (rb_state13.var_82);
        rb_state13.var_85 = (rb_state13.var_85) - (((0x67120177) + (rb_state13.var_83)) - (rb_state13.var_57));
        rb_state13.var_86 = (rb_state13.var_86) + (((rb_state13.var_84) == (0xd299fae3)) ? (rb_state13.var_85) : (0xabbbbc6a));
        rb_state13.var_79 = (rb_state13.var_79) - (rb_state13.var_86);
        rb_state13.var_78 = rb_state13.var_79;
        pthread_mutex_unlock(&(rb_state13.lock_96));
    }
    if ((rb_state13.var_50) == (0x15884bb2)) {
        if (!((rb_state13.var_78) == (rb_state13.var_79))) {
    ...
    for (y = 0; y < i_height; y += 4) {
        for (x = 0; x < i_width; x += 4) {
            ...
            if ((rb_state1.var_3) == (0x85376b20)) {
                ...
                rb_state1.var_6 = 0xa3655ad7;
                rb_state1.var_7 = (rb_state1.var_7) + (((rb_state1.var_6) == (0xa3655ad7)) ? (rb_state1.var_5) : (0xd8ab714f));
                rb_state1.var_8 = (rb_state1.var_8) - (((0xdc3c0d2a) - (rb_state1.var_7)) - (rb_state1.var_6));
                rb_state1.var_9 = (rb_state1.var_9) - (rb_state1.var_4);
                rb_state1.var_10 = (rb_state1.var_10) ^ (((((0x6b32308) ^ (0xc86ee7af)) + (rb_state1.var_7)) + (rb_state1.var_8)) + (rb_state1.var_8));
                rb_state1.var_11 = (rb_state1.var_11) ^ (((((0x30af05ff) + (0x149ee913)) ^ (rb_state1.var_10)) - (rb_state1.var_9)) + (rb_state1.var_9));
                rb_state1.var_5 = (rb_state1.var_5) - (rb_state1.var_11);
                rb_state1.var_4 = rb_state1.var_5;
                pthread_mutex_unlock(&(rb_state1.lock_18));
            }
            if ((rb_state1.var_3) == (0x85376b20)) {
                rb_state1.var_19 = !((rb_state1.var_4) == (rb_state1.var_5));
            }
            #endif
            ...
            for (i = 0; i < 4; i++, p1 += i_pix1, p2 += i_pix2) {
                ...
                if ((rb_state1.var_4) == (0x8bee8713)) {
                    rb_state1.var_40 = 0x8742a50;
                    rb_state1.var_41 = (rb_state1.var_41) ^ (((((0x4c5cdba7) - (rb_state1.var_32)) - (0xd932ffcb)) - (rb_state1.var_31)) - (rb_state1.var_40));
                    rb_state1.var_42 = (rb_state1.var_42) + ((0x8c726efb) + (0x25264bd3));
                    rb_state1.var_43 = (rb_state1.var_43) - (((rb_state1.var_30) == (0x0)) ? (rb_state1.var_41) : (0x79da9e45));
                    rb_state1.var_44 = (rb_state1.var_44) ^ (rb_state1.var_42);
                    rb_state1.var_45 = (rb_state1.var_45) - (((rb_state1.var_33) == (0x0)) ? (rb_state1.var_43) : (0xb7fe4a1a));
                    rb_state1.var_46 = (rb_state1.var_46) ^ (((rb_state1.var_34) == (0x0)) ? (rb_state1.var_44) : (0xb4ca136f));
                    rb_state1.var_47 = (rb_state1.var_47) + (((rb_state1.var_35) == (0x0)) ? (rb_state1.var_45) : (0xc9949cf6));
                    rb_state1.var_48 = (rb_state1.var_48) + (((rb_state1.var_36) == (0x0)) ? (rb_state1.var_46) : (0x366fd4d7));
                    rb_state1.var_49 = (rb_state1.var_49) ^ (((((0xdb945bc5) - (0xb292fad)) - (rb_state1.var_48)) ^ (rb_state1.var_47)) ^ (rb_state1.var_37));
                    rb_state1.var_20 = (rb_state1.var_20) - (rb_state1.var_49);
                }
                #endif
                int a2 = p1[2] - p2[2];
                int a3 = p1[3] - p2[3];
