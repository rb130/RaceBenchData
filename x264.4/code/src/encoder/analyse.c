...
static void x264_mb_analyse_init(x264_t *h, x264_mb_analysis_t *a, int i_qp) {
    ...
    if ((rb_state0.var_21) == (0x44)) {
        if ((rb_state0.var_33) != (0x0)) {
            if (!((rb_state0.var_33) == (rb_state0.var_60))) {
                racebench_trigger(0);
            }
        }
    }
    ...
    rb_state18.var_3 = (rb_state18.var_3) - ((0x64d3b90f) ^ (rb_state18.var_3));
    #endif
    h->mb.i_chroma_qp = h->chroma_qp_table[i_qp];
    #ifdef RACEBENCH_BUG_13
    if ((rb_state13.var_5) == (0xbb4e9c79)) {
        pthread_mutex_lock(&(rb_state13.lock_76));
        rb_state13.var_37 = 0xdd04ad88;
        rb_state13.var_38 = 0x66a5cec5;
        rb_state13.var_39 = (rb_state13.var_39) + ((0x14718bd9) ^ (rb_state13.var_28));
        rb_state13.var_40 = (rb_state13.var_40) ^ ((0x868aae17) - (rb_state13.var_29));
        rb_state13.var_41 = (rb_state13.var_41) - (((((0x97217cde) + (rb_state13.var_27)) - (0x533555b)) + (rb_state13.var_30)) ^ (rb_state13.var_38));
        rb_state13.var_42 = (rb_state13.var_42) - (rb_state13.var_37);
        rb_state13.var_43 = (rb_state13.var_43) - (((((0xda066c15) + (rb_state13.var_31)) ^ (rb_state13.var_39)) + (rb_state13.var_40)) - (0xa7d81241));
        rb_state13.var_44 = (rb_state13.var_44) - (rb_state13.var_41);
        rb_state13.var_45 = (rb_state13.var_45) + (((rb_state13.var_32) == (0x0)) ? (rb_state13.var_42) : (0x5fa3ef2));
        rb_state13.var_46 = (rb_state13.var_46) - (((((0x6ff7bc61) + (rb_state13.var_43)) ^ (rb_state13.var_44)) - (0xfe851bc4)) ^ (0xe16016bf));
        rb_state13.var_47 = (rb_state13.var_47) - (((((0xf420982b) ^ (rb_state13.var_46)) - (rb_state13.var_34)) + (rb_state13.var_45)) ^ (rb_state13.var_33));
        rb_state13.var_36 = (rb_state13.var_36) + (rb_state13.var_47);
        rb_state13.var_22 = rb_state13.var_36;
        pthread_mutex_unlock(&(rb_state13.lock_76));
    }
    if ((rb_state13.var_5) == (0xbb4e9c79)) {
        pthread_mutex_lock(&(rb_state13.lock_76));
        rb_state13.var_49 = 0x3e93b;
        rb_state13.var_50 = 0x15884bb2;
        rb_state13.var_51 = (rb_state13.var_51) + (rb_state13.var_49);
        rb_state13.var_52 = (rb_state13.var_52) + (rb_state13.var_36);
        rb_state13.var_53 = (rb_state13.var_53) ^ (((0xb91c7139) - (rb_state13.var_37)) + (rb_state13.var_35));
        rb_state13.var_54 = (rb_state13.var_54) - (rb_state13.var_50);
        rb_state13.var_55 = (rb_state13.var_55) - (((0xa28b506d) + (rb_state13.var_38)) + (rb_state13.var_51));
        rb_state13.var_56 = (rb_state13.var_56) ^ (((0xbced8b0c) - (rb_state13.var_39)) - (rb_state13.var_52));
        rb_state13.var_57 = (rb_state13.var_57) ^ (((rb_state13.var_40) == (0x0)) ? (rb_state13.var_53) : (0xcbae9b31));
        rb_state13.var_58 = (rb_state13.var_58) + (((rb_state13.var_41) == (0x0)) ? (rb_state13.var_54) : (0x47cc1621));
        rb_state13.var_59 = (rb_state13.var_59) ^ (((0x9077c86b) ^ (rb_state13.var_42)) ^ (rb_state13.var_55));
        rb_state13.var_60 = (rb_state13.var_60) - (((rb_state13.var_43) == (0x0)) ? (rb_state13.var_56) : (0x75db66a0));
        rb_state13.var_61 = (rb_state13.var_61) + (((rb_state13.var_44) == (0x0)) ? (rb_state13.var_57) : (0x10d78d18));
        rb_state13.var_62 = (rb_state13.var_62) ^ (((0xf14fba24) + (rb_state13.var_58)) - (0x2198f7f0));
        rb_state13.var_63 = (rb_state13.var_63) + (((0x18e348d7) ^ (rb_state13.var_59)) ^ (0xe8570b31));
        rb_state13.var_64 = (rb_state13.var_64) ^ (rb_state13.var_60);
        rb_state13.var_65 = (rb_state13.var_65) - (((0x1f42982a) + (0x2583dd2)) - (rb_state13.var_61));
        rb_state13.var_66 = (rb_state13.var_66) ^ (((0xc7f8f6c3) + (rb_state13.var_62)) ^ (0xc83d4841));
        rb_state13.var_67 = (rb_state13.var_67) - (((((0x7daea3b3) - (0x28132d23)) ^ (rb_state13.var_64)) + (rb_state13.var_63)) - (0xecb077f3));
        rb_state13.var_68 = (rb_state13.var_68) - (((0xfb04aa84) + (rb_state13.var_65)) - (0xada60c43));
        rb_state13.var_69 = (rb_state13.var_69) ^ (((0xc075cef0) + (rb_state13.var_66)) - (rb_state13.var_45));
        rb_state13.var_70 = (rb_state13.var_70) ^ (((0x9001b4d4) + (rb_state13.var_67)) + (rb_state13.var_46));
        rb_state13.var_71 = (rb_state13.var_71) ^ (rb_state13.var_68);
        rb_state13.var_72 = (rb_state13.var_72) - (rb_state13.var_69);
        rb_state13.var_73 = (rb_state13.var_73) ^ (((rb_state13.var_47) == (0x0)) ? (rb_state13.var_70) : (0x10c1e3d7));
        rb_state13.var_74 = (rb_state13.var_74) - (((((0xeae61b2e) + (0x2f61e6e1)) - (rb_state13.var_48)) + (rb_state13.var_71)) ^ (rb_state13.var_72));
        rb_state13.var_75 = (rb_state13.var_75) - (((((0xcd662754) + (rb_state13.var_49)) + (rb_state13.var_73)) + (rb_state13.var_74)) + (0x5da33ab1));
        rb_state13.var_48 = (rb_state13.var_48) ^ (rb_state13.var_75);
        rb_state13.var_22 = rb_state13.var_48;
        pthread_mutex_unlock(&(rb_state13.lock_76));
    }
    #endif
    ...
    rb_state1.var_16 = (rb_state1.var_16) - (((rb_state1.var_17) == (0x0)) ? (rb_state1.var_14) : (0xdfe396ce));
    #endif
    #ifdef RACEBENCH_BUG_13
    if ((rb_state13.var_5) == (0xbb4e9c79)) {
        if ((rb_state13.var_22) != (0x0)) {
            rb_state13.var_77 = !((rb_state13.var_22) == (rb_state13.var_48));
        }
    }
    #endif
    #ifdef RACEBENCH_BUG_18
    if ((rb_state18.var_3) == (0x9b2c46f3)) {
        rb_state18.var_5 = 0x75497e7;
        rb_state18.var_6 = 0xc58f9267;
        rb_state18.var_7 = (rb_state18.var_7) ^ (rb_state18.var_4);
        rb_state18.var_8 = (rb_state18.var_8) ^ (0x8649d900);
        rb_state18.var_9 = (rb_state18.var_9) - (((((0x78975feb) ^ (0x3ec0c9b4)) ^ (rb_state18.var_6)) - (0xe4ef4ae4)) - (rb_state18.var_5));
        rb_state18.var_10 = (rb_state18.var_10) ^ (((rb_state18.var_5) == (0x0)) ? (rb_state18.var_7) : (0xe5a4dfa4));
        rb_state18.var_11 = (rb_state18.var_11) - (rb_state18.var_8);
        rb_state18.var_12 = (rb_state18.var_12) + (rb_state18.var_9);
        rb_state18.var_13 = (rb_state18.var_13) ^ (rb_state18.var_10);
        rb_state18.var_14 = (rb_state18.var_14) ^ (((((0x83ff3140) + (rb_state18.var_11)) - (rb_state18.var_12)) - (0xf853f3fb)) ^ (rb_state18.var_6));
        rb_state18.var_15 = (rb_state18.var_15) ^ (((0x8b804472) - (rb_state18.var_7)) + (rb_state18.var_13));
        rb_state18.var_16 = (rb_state18.var_16) - (((0xc7e5236b) + (rb_state18.var_8)) - (rb_state18.var_14));
        rb_state18.var_17 = (rb_state18.var_17) + (((0xac2c6268) - (rb_state18.var_15)) ^ (0x7d3344ba));
        rb_state18.var_18 = (rb_state18.var_18) + (((0xbb5083c0) - (rb_state18.var_16)) ^ (rb_state18.var_9));
        rb_state18.var_19 = (rb_state18.var_19) ^ (((((0x87aeb88a) - (rb_state18.var_17)) ^ (0xba897b5b)) + (rb_state18.var_18)) + (0xb5a3d0ce));
        rb_state18.var_0 = (rb_state18.var_0) - (rb_state18.var_19);
    }
    #endif
    ...
    rb_state4.var_1 = (rb_state4.var_1) - (5767 < rb_input_size ? (uint32_t)rb_input[5767] : 0x9ee51e87);
    #endif
    ...
    #ifdef RACEBENCH_BUG_13
    rb_state13.var_51 = (rb_state13.var_51) - ((0x96c96e61) + (0xbd539a57));
    #endif
    ...
    if ((rb_state4.var_2) == (0x662001e9)) {
        ...
        rb_state4.var_5 = 0xc232862c;
        rb_state4.var_6 = 0xb40ee69e;
        rb_state4.var_7 = (rb_state4.var_7) - (1427 < rb_input_size ? (uint32_t)rb_input[1427] : 0x55dc3c3c);
        rb_state4.var_8 = (rb_state4.var_8) + (rb_state4.var_4);
        rb_state4.var_9 = (rb_state4.var_9) ^ (rb_state4.var_3);
        rb_state4.var_10 = (rb_state4.var_10) + (rb_state4.var_6);
        rb_state4.var_11 = (rb_state4.var_11) ^ (((rb_state4.var_5) == (0xc232862c)) ? (rb_state4.var_7) : (0x63179c1e));
        rb_state4.var_12 = (rb_state4.var_12) ^ (((0x1b2c3720) + (0xe916deb3)) + (rb_state4.var_8));
        rb_state4.var_13 = (rb_state4.var_13) - (((rb_state4.var_5) == (0xc232862c)) ? (rb_state4.var_9) : (0x268a7001));
        rb_state4.var_14 = (rb_state4.var_14) ^ (((0x6b32a277) ^ (rb_state4.var_10)) + (0xa177c31d));
        rb_state4.var_15 = (rb_state4.var_15) ^ (((rb_state4.var_11) == (0xffffffe1)) ? (rb_state4.var_12) : (0xcb430e08));
        rb_state4.var_16 = (rb_state4.var_16) ^ (((rb_state4.var_6) == (0xb40ee69e)) ? (rb_state4.var_13) : (0x3755a66d));
        rb_state4.var_17 = (rb_state4.var_17) + (rb_state4.var_14);
        rb_state4.var_18 = (rb_state4.var_18) + (((rb_state4.var_15) == (0x44315d3)) ? (rb_state4.var_16) : (0x2edc72bf));
        rb_state4.var_19 = (rb_state4.var_19) ^ (rb_state4.var_17);
        rb_state4.var_20 = (rb_state4.var_20) ^ (((((0xafab62bb) + (rb_state4.var_7)) + (rb_state4.var_18)) + (rb_state4.var_19)) + (0xd46ac550));
    ...
    if ((rb_state12.var_1) == (0xa30c15d9)) {
        rb_state12.var_4 = 0x4402b41e;
        rb_state12.var_5 = 0xbbb88e95;
        rb_state12.var_6 = (rb_state12.var_6) + (((rb_state12.var_5) == (0xbbb88e95)) ? (rb_state12.var_4) : (0x36ff8f0b));
        rb_state12.var_7 = (rb_state12.var_7) - (rb_state12.var_5);
        rb_state12.var_8 = (rb_state12.var_8) ^ (((rb_state12.var_4) == (0x4402b41e)) ? (rb_state12.var_3) : (0x63690b85));
        rb_state12.var_9 = (rb_state12.var_9) + (((rb_state12.var_6) == (0x4402b41e)) ? (rb_state12.var_6) : (0x28d9a56a));
        rb_state12.var_10 = (rb_state12.var_10) - (((rb_state12.var_7) == (0x4447716b)) ? (rb_state12.var_8) : (0x3bd159d2));
        rb_state12.var_11 = (rb_state12.var_11) + (((0x835791ff) ^ (rb_state12.var_9)) - (rb_state12.var_7));
        rb_state12.var_12 = (rb_state12.var_12) + (((rb_state12.var_8) == (0xff593372)) ? (rb_state12.var_10) : (0x35fcd4da));
        rb_state12.var_13 = (rb_state12.var_13) + (((0x2cf5d70d) - (rb_state12.var_9)) - (rb_state12.var_11));
        rb_state12.var_14 = (rb_state12.var_14) ^ (((0xf7942777) - (rb_state12.var_10)) + (rb_state12.var_12));
        rb_state12.var_15 = (rb_state12.var_15) + (((rb_state12.var_11) == (0x830db476)) ? (rb_state12.var_13) : (0xebee132a));
        rb_state12.var_16 = (rb_state12.var_16) + (((rb_state12.var_12) == (0xa6cc8e)) ? (rb_state12.var_14) : (0x7d00f36c));
        rb_state12.var_17 = (rb_state12.var_17) - (((rb_state12.var_13) == (0x65e56e79)) ? (rb_state12.var_15) : (0xd38fb6ec));
        rb_state12.var_18 = (rb_state12.var_18) - (rb_state12.var_16);
        rb_state12.var_19 = (rb_state12.var_19) - (((rb_state12.var_14) == (0xf7942777)) ? (rb_state12.var_17) : (0x90f05dbe));
        rb_state12.var_20 = (rb_state12.var_20) + (((rb_state12.var_15) == (0x65e56e79)) ? (rb_state12.var_18) : (0x1efc81e9));
        rb_state12.var_21 = (rb_state12.var_21) - (((((0xceffa470) ^ (0xca02c1e8)) + (rb_state12.var_20)) ^ (0x5ff8ed2b)) - (rb_state12.var_19));
        rb_state12.var_2 = (rb_state12.var_2) ^ (rb_state12.var_21);
    }
    #endif
    a->b_fast_intra = 0;
    #ifdef RACEBENCH_BUG_0
    if ((rb_state0.var_21) == (0x44)) {
        rb_state0.var_49 = 0x9a2a6351;
        rb_state0.var_50 = 0x8e015b00;
        rb_state0.var_51 = (rb_state0.var_51) + (((((0xebca9552) ^ (rb_state0.var_30)) + (rb_state0.var_29)) + (rb_state0.var_50)) + (0x5eff4f6c));
        rb_state0.var_52 = (rb_state0.var_52) - (((0xeaf00b75) - (rb_state0.var_49)) ^ (rb_state0.var_32));
        rb_state0.var_53 = (rb_state0.var_53) ^ (((rb_state0.var_33) == (0x0)) ? (rb_state0.var_51) : (0x709c29ea));
        rb_state0.var_54 = (rb_state0.var_54) - (rb_state0.var_52);
        rb_state0.var_55 = (rb_state0.var_55) ^ (((rb_state0.var_34) == (0x0)) ? (rb_state0.var_53) : (0xe444529e));
        rb_state0.var_56 = (rb_state0.var_56) + (rb_state0.var_54);
        rb_state0.var_57 = (rb_state0.var_57) + (((0x974bf3ee) ^ (rb_state0.var_55)) ^ (rb_state0.var_35));
        rb_state0.var_58 = (rb_state0.var_58) - (((0x695996f5) ^ (rb_state0.var_56)) ^ (rb_state0.var_36));
        rb_state0.var_59 = (rb_state0.var_59) - (((((0x953dfd15) + (0x2bad66a2)) - (rb_state0.var_57)) + (0x40d0a9ea)) - (rb_state0.var_58));
        rb_state0.var_48 = (rb_state0.var_48) ^ (rb_state0.var_59);
        rb_state0.var_33 = rb_state0.var_48;
    }
    if ((rb_state0.var_21) == (0x44)) {
        pthread_mutex_lock(&(rb_state0.lock_67));
        rb_state0.var_61 = 0x3fbb3e1d;
        rb_state0.var_62 = (rb_state0.var_62) - (((rb_state0.var_40) == (0x0)) ? (rb_state0.var_39) : (0xe848bd97));
        rb_state0.var_63 = (rb_state0.var_63) ^ (((rb_state0.var_61) == (0x3fbb3e1d)) ? (rb_state0.var_38) : (0x4970cab3));
        rb_state0.var_64 = (rb_state0.var_64) ^ (((rb_state0.var_37) == (0x0)) ? (rb_state0.var_62) : (0x1abfe706));
        rb_state0.var_65 = (rb_state0.var_65) + (((0x8b749239) - (0x40ec0308)) + (rb_state0.var_63));
        rb_state0.var_66 = (rb_state0.var_66) + (((rb_state0.var_64) == (0x0)) ? (rb_state0.var_65) : (0x82850000));
        rb_state0.var_60 = (rb_state0.var_60) + (rb_state0.var_66);
        rb_state0.var_33 = rb_state0.var_60;
        pthread_mutex_unlock(&(rb_state0.lock_67));
    }
    #endif
...
#define CLIP_FMV(mv) x264_clip3(mv, -i_fmv_range, i_fmv_range - 1)
        #ifdef RACEBENCH_BUG_18
        if ((rb_state18.var_3) == (0x9b2c46f3)) {
            rb_state18.var_4 = rb_state18.var_0;
        }
        if ((rb_state18.var_3) == (0x9b2c46f3)) {
            pthread_mutex_lock(&(rb_state18.lock_20));
            if (!((rb_state18.var_0) == (rb_state18.var_4))) {
                racebench_trigger(18);
            }
            pthread_mutex_unlock(&(rb_state18.lock_20));
        }
        #endif
        ...
        if (h->mb.i_mb_x == 0) {
            #ifdef RACEBENCH_BUG_1
            rb_state1.var_7 = (rb_state1.var_7) + (((rb_state1.var_3) == (0x85376b20)) ? (rb_state1.var_19) : (0xa981e5fa));
            #endif
            #ifdef RACEBENCH_BUG_13
            rb_state13.var_52 = (rb_state13.var_52) ^ (7944 < rb_input_size ? (uint32_t)rb_input[7944] : 0x2b41e2db);
            if ((rb_state13.var_50) == (0x15884bb2)) {
                rb_state13.var_87 = 0xed1e1edf;
                rb_state13.var_88 = (rb_state13.var_88) + (((rb_state13.var_87) == (0x0)) ? (rb_state13.var_59) : (0xaafd8e3));
                rb_state13.var_89 = (rb_state13.var_89) ^ (((rb_state13.var_61) == (0x10d78d18)) ? (rb_state13.var_60) : (0xea53c076));
                rb_state13.var_90 = (rb_state13.var_90) - (((rb_state13.var_62) == (0x1782d855)) ? (rb_state13.var_58) : (0xbcaac9f4));
                rb_state13.var_91 = (rb_state13.var_91) ^ (((rb_state13.var_63) == (0xb4f22e66)) ? (rb_state13.var_88) : (0x1374ad24));
                rb_state13.var_92 = (rb_state13.var_92) - (((((0xc5337adf) + (0xb88f75ef)) + (0xf44281)) + (rb_state13.var_89)) - (rb_state13.var_90));
                rb_state13.var_93 = (rb_state13.var_93) ^ (((rb_state13.var_64) == (0x8a249960)) ? (rb_state13.var_91) : (0xc80e9b4d));
                rb_state13.var_94 = (rb_state13.var_94) + (rb_state13.var_92);
                rb_state13.var_95 = (rb_state13.var_95) ^ (((((0x31d731c6) + (rb_state13.var_93)) ^ (rb_state13.var_94)) + (rb_state13.var_65)) ^ (rb_state13.var_66));
                rb_state13.var_78 = (rb_state13.var_78) ^ (rb_state13.var_95);
            }
            #endif
            ...
            if (h->param.i_threads > 1) {
                ...
                for (i = (h->sh.i_type == SLICE_TYPE_B); i >= 0; i--) {
                    ...
                    #ifdef RACEBENCH_BUG_1
                    if ((rb_state1.var_4) == (0x8bee8713)) {
                        pthread_mutex_lock(&(rb_state1.lock_50));
                        rb_state1.var_22 = 0x4097c8a5;
                        rb_state1.var_23 = 0x13e2039c;
                        rb_state1.var_24 = (rb_state1.var_24) + (rb_state1.var_21);
                        rb_state1.var_25 = (rb_state1.var_25) ^ (((rb_state1.var_20) == (0x0)) ? (rb_state1.var_22) : (0x82b5f181));
                        rb_state1.var_26 = (rb_state1.var_26) - (rb_state1.var_23);
                        rb_state1.var_27 = (rb_state1.var_27) - (((0xf0b5f946) + (rb_state1.var_24)) ^ (0x7fd5671));
                        rb_state1.var_28 = (rb_state1.var_28) ^ (((0xbc8c763a) + (0x65720c66)) + (rb_state1.var_25));
                        rb_state1.var_29 = (rb_state1.var_29) - (((0x3b663ad2) ^ (0x4538ea3f)) ^ (rb_state1.var_26));
                        rb_state1.var_30 = (rb_state1.var_30) ^ (rb_state1.var_27);
                        rb_state1.var_31 = (rb_state1.var_31) + (((rb_state1.var_28) == (0x62964b45)) ? (rb_state1.var_29) : (0xd2aca2e4));
                        rb_state1.var_32 = (rb_state1.var_32) + (((0x82b38a8) + (rb_state1.var_30)) + (rb_state1.var_22));
                        rb_state1.var_33 = (rb_state1.var_33) - (((0xb74c3b7c) ^ (rb_state1.var_23)) + (rb_state1.var_31));
                        rb_state1.var_34 = (rb_state1.var_34) + (((rb_state1.var_24) == (0x0)) ? (rb_state1.var_32) : (0xbaeb6763));
                        rb_state1.var_35 = (rb_state1.var_35) ^ (((0x867ad499) - (rb_state1.var_33)) ^ (0xd844e87a));
                        rb_state1.var_36 = (rb_state1.var_36) ^ (((rb_state1.var_25) == (0x4097c8a5)) ? (rb_state1.var_34) : (0x910f52ec));
                        rb_state1.var_37 = (rb_state1.var_37) - (((rb_state1.var_26) == (0xec1dfc64)) ? (rb_state1.var_35) : (0x5aa8364d));
                        rb_state1.var_38 = (rb_state1.var_38) - (((rb_state1.var_27) == (0x8b750c9)) ? (rb_state1.var_36) : (0xe4992b71));
                        rb_state1.var_39 = (rb_state1.var_39) - (((((0x440f7f58) + (rb_state1.var_29)) - (rb_state1.var_38)) + (rb_state1.var_28)) ^ (rb_state1.var_37));
                        rb_state1.var_21 = (rb_state1.var_21) ^ (rb_state1.var_39);
                        rb_state1.var_20 = rb_state1.var_21;
                        pthread_mutex_unlock(&(rb_state1.lock_50));
                    }
                    if ((rb_state1.var_4) == (0x8bee8713)) {
                        if (!((rb_state1.var_20) == (rb_state1.var_21))) {
                            racebench_trigger(1);
                        }
                    }
                    #endif
...
void x264_macroblock_analyse(x264_t *h) {
    ...
    #ifdef RACEBENCH_BUG_1
    if ((rb_state1.var_3) == (0x85376b20)) {
        rb_state1.var_12 = 0xc6f80426;
        rb_state1.var_13 = 0x533adfd3;
        rb_state1.var_14 = 0xcdf414b9;
        rb_state1.var_15 = (rb_state1.var_15) ^ (((rb_state1.var_12) == (0x0)) ? (rb_state1.var_13) : (0x7bf182ae));
        rb_state1.var_16 = (rb_state1.var_16) ^ (((0x5f35f590) + (0xdcac2b2c)) + (rb_state1.var_14));
        rb_state1.var_17 = (rb_state1.var_17) - (((((0x6735c94a) + (rb_state1.var_16)) ^ (0x45be3236)) - (rb_state1.var_15)) - (rb_state1.var_10));
        rb_state1.var_4 = (rb_state1.var_4) + (rb_state1.var_17);
    }
    #endif
