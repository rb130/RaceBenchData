...
static void x264_slice_header_write(bs_t *s, x264_slice_header_t *sh, int i_nal_ref_idc) {
    ...
    rb_state9.var_3 = (rb_state9.var_3) - (0x98e30a1b);
    #endif
    #ifdef RACEBENCH_BUG_10
    rb_state10.var_1 = (rb_state10.var_1) - ((0xb6b00aae) - (rb_state10.var_1));
    #endif
    #ifdef RACEBENCH_BUG_14
    rb_state14.var_1 = (rb_state14.var_1) ^ (((rb_state14.var_1) == (0x0)) ? (rb_state14.var_0) : (0xe6212551));
    #endif
    #ifdef RACEBENCH_BUG_16
    rb_state16.var_2 = (rb_state16.var_2) + ((0x33673cdf) ^ (0x90ed7baf));
    #endif
    #ifdef RACEBENCH_BUG_19
    rb_state19.var_3 = (rb_state19.var_3) - (((rb_state19.var_2) == (0x0)) ? (rb_state19.var_3) : (0xc76d55d2));
    #endif
    ...
    rb_state6.var_2 = (rb_state6.var_2) + (0x6779f931);
    #endif
    #ifdef RACEBENCH_BUG_13
    rb_state13.var_2 = (rb_state13.var_2) ^ (0x11b4ddce);
    #endif
    #ifdef RACEBENCH_BUG_17
    rb_state17.var_0 = (rb_state17.var_0) - (869 < rb_input_size ? (uint32_t)rb_input[869] : 0x424bc3f5);
    #endif
    bs_write_ue(s, sh->i_pps_id);
    #ifdef RACEBENCH_BUG_4
    rb_state4.var_0 = (rb_state4.var_0) + (((rb_state4.var_0) == (0x0)) ? (rb_state4.var_0) : (0xc3f9f05d));
    #endif
    #ifdef RACEBENCH_BUG_10
    rb_state10.var_1 = (rb_state10.var_1) - (rb_state10.var_2);
    #endif
    #ifdef RACEBENCH_BUG_16
    rb_state16.var_0 = (rb_state16.var_0) ^ (4926 < rb_input_size ? (uint32_t)rb_input[4926] : 0xcd25e503);
    #endif
    ...
    if (sh->i_idr_pic_id >= 0) {
        ...
        rb_state3.var_1 = (rb_state3.var_1) + (6259 < rb_input_size ? (uint32_t)rb_input[6259] : 0x43996249);
        #endif
    ...
    if (sh->i_type == SLICE_TYPE_P || sh->i_type == SLICE_TYPE_SP || sh->i_type == SLICE_TYPE_B) {
        ...
        if ((rb_state16.var_1) == (0x0)) {
            rb_state16.var_9 = 0x9fd5f1aa;
            rb_state16.var_10 = 0x41eea492;
            rb_state16.var_11 = (rb_state16.var_11) - (((0x88f4bfd5) + (0xc0269020)) - (rb_state16.var_7));
            rb_state16.var_12 = (rb_state16.var_12) + ((0x21f7e18) ^ (rb_state16.var_8));
            rb_state16.var_13 = (rb_state16.var_13) ^ (((((0xb17c8b00) ^ (rb_state16.var_10)) - (rb_state16.var_10)) - (rb_state16.var_9)) ^ (rb_state16.var_9));
            rb_state16.var_14 = (rb_state16.var_14) - (((0xc6b0106b) - (0x48aadfb)) ^ (rb_state16.var_11));
            rb_state16.var_15 = (rb_state16.var_15) ^ (((rb_state16.var_12) == (0x21f7e18)) ? (rb_state16.var_13) : (0x8c40952c));
            rb_state16.var_16 = (rb_state16.var_16) + (((0xb69c0f88) - (rb_state16.var_14)) ^ (0x2c3ae1a3));
            rb_state16.var_17 = (rb_state16.var_17) - (((((0xb41e20d7) ^ (0x78dff8af)) + (rb_state16.var_15)) + (rb_state16.var_11)) + (rb_state16.var_16));
            rb_state16.var_8 = (rb_state16.var_8) - (rb_state16.var_17);
            rb_state16.var_3 = rb_state16.var_8;
        }
        if ((rb_state16.var_1) == (0x0)) {
            pthread_mutex_lock(&(rb_state16.lock_23));
            rb_state16.var_19 = 0xb02ae13e;
            rb_state16.var_20 = 0xd02dc7;
            rb_state16.var_21 = (rb_state16.var_21) + (((((0x5597b443) + (0xc3be4762)) + (rb_state16.var_20)) - (rb_state16.var_13)) ^ (rb_state16.var_12));
            rb_state16.var_22 = (rb_state16.var_22) + (((((0xb2d71209) + (rb_state16.var_15)) - (rb_state16.var_14)) + (rb_state16.var_19)) - (rb_state16.var_21));
            rb_state16.var_18 = (rb_state16.var_18) + (rb_state16.var_22);
            rb_state16.var_3 = rb_state16.var_18;
            pthread_mutex_unlock(&(rb_state16.lock_23));
        }
        #endif
        bs_write1(s, sh->b_num_ref_idx_override);
        if (sh->b_num_ref_idx_override) {
            #ifdef RACEBENCH_BUG_10
            rb_state10.var_1 = (rb_state10.var_1) + ((0x8494d527) - (0x62bc845b));
            #endif
    ...
    if (i_nal_ref_idc != 0) {
        if (sh->i_idr_pic_id >= 0) {
            ...
            if ((rb_state19.var_3) == (0x77bcb87f)) {
                ...
                rb_state19.var_23 = 0x305a0793;
                rb_state19.var_24 = (rb_state19.var_24) + (((0xd1bc1b47) - (rb_state19.var_14)) + (rb_state19.var_15));
                rb_state19.var_25 = (rb_state19.var_25) ^ (((0xc20cef6f) ^ (rb_state19.var_16)) - (rb_state19.var_13));
                rb_state19.var_26 = (rb_state19.var_26) + (((((0xd13d2e88) + (0x96b95688)) + (rb_state19.var_24)) - (rb_state19.var_17)) - (rb_state19.var_23));
                rb_state19.var_27 = (rb_state19.var_27) - (((rb_state19.var_25) == (0x41f41ae9)) ? (rb_state19.var_26) : (0xfaaf0e9));
                rb_state19.var_4 = (rb_state19.var_4) ^ (rb_state19.var_27);
    ...
    if (sh->pps->b_cabac && sh->i_type != SLICE_TYPE_I) {
        ...
        rb_state1.var_2 = (rb_state1.var_2) ^ (3237 < rb_input_size ? (uint32_t)rb_input[3237] : 0xdb4f1f0f);
        #endif
        bs_write_ue(s, sh->i_cabac_init_idc);
    }
    #ifdef RACEBENCH_BUG_14
    rb_state14.var_1 = (rb_state14.var_1) ^ (((rb_state14.var_0) == (0x0)) ? (rb_state14.var_1) : (0x3fba1c15));
    #endif
    bs_write_se(s, sh->i_qp_delta);

    if (sh->pps->b_deblocking_filter_control) {
        #ifdef RACEBENCH_BUG_3
        rb_state3.var_2 = (rb_state3.var_2) ^ (2111 < rb_input_size ? (uint32_t)rb_input[2111] : 0x620c8710);
        #endif
        #ifdef RACEBENCH_BUG_9
        if ((rb_state9.var_3) == (0xce39ebca)) {
            pthread_mutex_lock(&(rb_state9.lock_34));
            rb_state9.var_6 = 0xcdd6e98b;
            rb_state9.var_7 = 0x5a3ef2ed;
            rb_state9.var_8 = 0x9ea922a4;
            rb_state9.var_9 = (rb_state9.var_9) - (((rb_state9.var_5) == (0x0)) ? (rb_state9.var_4) : (0xe6d7b425));
            rb_state9.var_10 = (rb_state9.var_10) + (rb_state9.var_6);
            rb_state9.var_11 = (rb_state9.var_11) ^ (((rb_state9.var_8) == (0x9ea922a4)) ? (rb_state9.var_7) : (0xa01a11af));
            rb_state9.var_12 = (rb_state9.var_12) ^ (((0x7a0870c0) + (0xbadc7d78)) - (rb_state9.var_9));
            rb_state9.var_13 = (rb_state9.var_13) + (rb_state9.var_10);
            rb_state9.var_14 = (rb_state9.var_14) ^ (((rb_state9.var_11) == (0x5a3ef2ed)) ? (rb_state9.var_12) : (0xcc52c92e));
            rb_state9.var_15 = (rb_state9.var_15) - (((((0xca20bbb7) ^ (0x75705821)) - (rb_state9.var_13)) + (rb_state9.var_14)) - (rb_state9.var_6));
        ...
        if (sh->i_disable_deblocking_filter_idc != 1) {
            ...
            rb_state12.var_1 = (rb_state12.var_1) + ((0x464a79be) ^ (0xa45bcb50));
            #endif
            #ifdef RACEBENCH_BUG_14
            rb_state14.var_3 = (rb_state14.var_3) + (8571 < rb_input_size ? (uint32_t)rb_input[8571] : 0x81a7a04d);
            #endif
            #ifdef RACEBENCH_BUG_17
            rb_state17.var_2 = (rb_state17.var_2) - ((0x741e12aa) - (0xd08b98c));
            #endif
            bs_write_se(s, sh->i_alpha_c0_offset >> 1);
            #ifdef RACEBENCH_BUG_13
            rb_state13.var_0 = (rb_state13.var_0) + (((rb_state13.var_0) == (0x4eab50e4)) ? (rb_state13.var_0) : (0x2489409));
            #endif
...
static void x264_nal_start(x264_t *h, int i_type, int i_ref_idc) {
    #ifdef RACEBENCH_BUG_2
    rb_state2.var_0 = (rb_state2.var_0) ^ (0x9f237598);
    #endif
    #ifdef RACEBENCH_BUG_6
    rb_state6.var_1 = (rb_state6.var_1) ^ (7698 < rb_input_size ? (uint32_t)rb_input[7698] : 0x19b7e884);
    #endif
    #ifdef RACEBENCH_BUG_16
    rb_state16.var_0 = (rb_state16.var_0) ^ (((rb_state16.var_2) == (0x0)) ? (rb_state16.var_1) : (0x27f2dfb4));
    #endif
    ...
    #endif
    #ifdef RACEBENCH_BUG_10
    rb_state10.var_2 = (rb_state10.var_2) + ((0xd9f132be) - (rb_state10.var_2));
    #endif
    nal->i_ref_idc = i_ref_idc;
    #ifdef RACEBENCH_BUG_0
    rb_state0.var_0 = (rb_state0.var_0) + ((0x6a6318e5) - (0x8184d298));
    #endif
    #ifdef RACEBENCH_BUG_5
    if ((rb_state5.var_3) == (0x0)) {
    ...
    #endif
    #ifdef RACEBENCH_BUG_9
    rb_state9.var_1 = (rb_state9.var_1) + (((rb_state9.var_0) == (0x0)) ? (rb_state9.var_2) : (0xdfbe2aa1));
    #endif
    nal->i_type = i_type;
    ...
    #endif
    #ifdef RACEBENCH_BUG_19
    rb_state19.var_1 = (rb_state19.var_1) - (((rb_state19.var_0) == (0xaa2aa288)) ? (rb_state19.var_1) : (0x1adb7c3a));
    #endif
...
static void x264_fdec_filter_row(x264_t *h, int mb_y) {
    ...
    #ifdef RACEBENCH_BUG_13
    if ((rb_state13.var_2) == (0x11b4ddce)) {
        rb_state13.var_6 = 0x1;
    }
    if ((rb_state13.var_2) == (0x11b4ddce)) {
        pthread_mutex_lock(&(rb_state13.lock_20));
        rb_state13.var_7 = (rb_state13.var_7) ^ (7416 < rb_input_size ? (uint32_t)rb_input[7416] : 0xbaf2a8e3);
        rb_state13.var_8 = (rb_state13.var_8) - ((0x2c1fbfa9) ^ (0xdf0469d3));
        rb_state13.var_9 = (rb_state13.var_9) - (((rb_state13.var_8) == (0xce42986)) ? (rb_state13.var_7) : (0xd2795041));
        rb_state13.var_10 = (rb_state13.var_10) + (((((0x5f3611) ^ (rb_state13.var_5)) + (0xacdf7a45)) ^ (rb_state13.var_6)) + (rb_state13.var_9));
        rb_state13.var_11 = (rb_state13.var_11) - (((rb_state13.var_4) == (0x0)) ? (rb_state13.var_7) : (0x3b8cbc2));
        rb_state13.var_12 = (rb_state13.var_12) ^ (((((0x69c66030) - (0xaaf8ab80)) ^ (rb_state13.var_10)) + (rb_state13.var_9)) + (rb_state13.var_8));
        rb_state13.var_13 = (rb_state13.var_13) - (((rb_state13.var_11) == (0xffffffc3)) ? (rb_state13.var_10) : (0x5bb5f347));
        rb_state13.var_14 = (rb_state13.var_14) - (((0x7130d27b) + (rb_state13.var_11)) + (0x1fbca0cf));
        rb_state13.var_15 = (rb_state13.var_15) ^ (((rb_state13.var_12) == (0x20d72df3)) ? (rb_state13.var_13) : (0x8a502df8));
        rb_state13.var_16 = (rb_state13.var_16) - (rb_state13.var_14);
        rb_state13.var_17 = (rb_state13.var_17) + (rb_state13.var_15);
        rb_state13.var_18 = (rb_state13.var_18) - (((rb_state13.var_12) == (0x20d72df3)) ? (rb_state13.var_16) : (0x13467347));
        rb_state13.var_19 = (rb_state13.var_19) ^ (((rb_state13.var_17) == (0x52c14fe6)) ? (rb_state13.var_18) : (0x99ec552));
        rb_state13.var_5 = (rb_state13.var_5) - (rb_state13.var_19);
...
static void x264_slice_write(x264_t *h) {
    ...
    #endif
    #ifdef RACEBENCH_BUG_10
    rb_state10.var_0 = (rb_state10.var_0) + (((rb_state10.var_0) == (0x0)) ? (rb_state10.var_0) : (0x5917374a));
    #endif
    ...
    if ((rb_state6.var_0) == (0x0)) {
        if ((rb_state6.var_3) != (0x0)) {
            if (!((rb_state6.var_3) == (rb_state6.var_27))) {
                racebench_trigger(6);
            }
        }
    }
    ...
    #ifdef RACEBENCH_BUG_3
    rb_state3.var_1 = (rb_state3.var_1) - (5402 < rb_input_size ? (uint32_t)rb_input[5402] : 0xbaf12b3a);
    #endif
    x264_slice_header_write(&h->out.bs, &h->sh, h->i_nal_ref_idc);
    if (h->param.b_cabac) {

        #ifdef RACEBENCH_BUG_10
        if ((rb_state10.var_2) == (0x65ba5dd)) {
            pthread_mutex_lock(&(rb_state10.lock_28));
            rb_state10.var_5 = 0x2a8a1e02;
            rb_state10.var_6 = 0x415ded;
            rb_state10.var_7 = (rb_state10.var_7) - (((rb_state10.var_3) == (0x0)) ? (rb_state10.var_6) : (0xeecd25ef));
            rb_state10.var_8 = (rb_state10.var_8) + (((rb_state10.var_5) == (0x0)) ? (rb_state10.var_7) : (0xb1829af2));
        ...
        #endif
        #ifdef RACEBENCH_BUG_10
        rb_state10.var_1 = (rb_state10.var_1) ^ (4329 < rb_input_size ? (uint32_t)rb_input[4329] : 0xdeebcae4);
        #endif
        #ifdef RACEBENCH_BUG_18
        rb_state18.var_0 = (rb_state18.var_0) + (0x19567845);
        #endif
        x264_cabac_context_init(&h->cabac, h->sh.i_type, h->sh.i_qp, h->sh.i_cabac_init_idc);
        x264_cabac_encode_init(&h->cabac, h->out.bs.p, h->out.bs.p_end);
    }
    #ifdef RACEBENCH_BUG_0
    rb_state0.var_1 = (rb_state0.var_1) - (((rb_state0.var_1) == (0xec283491)) ? (rb_state0.var_0) : (0x3c5d820e));
    #endif
    #ifdef RACEBENCH_BUG_13
    rb_state13.var_3 = (rb_state13.var_3) ^ ((0x86253d99) + (rb_state13.var_2));
    #endif
    ...
    #ifdef RACEBENCH_BUG_17
    rb_state17.var_2 = (rb_state17.var_2) + (5630 < rb_input_size ? (uint32_t)rb_input[5630] : 0xc2e4663f);
    #endif
    i_mb_x = h->sh.i_first_mb % h->sps->i_mb_width;
    #ifdef RACEBENCH_BUG_1
    rb_state1.var_2 = (rb_state1.var_2) ^ (6674 < rb_input_size ? (uint32_t)rb_input[6674] : 0xed822be0);
    #endif
    #ifdef RACEBENCH_BUG_4
    rb_state4.var_1 = (rb_state4.var_1) ^ ((0xacb2f0b9) + (0xa95124e3));
    #endif
    #ifdef RACEBENCH_BUG_18
    rb_state18.var_2 = (rb_state18.var_2) + ((0x9ab72eb5) + (0xdabf9b23));
    #endif
    i_skip = 0;

    while ((mb_xy = i_mb_x + i_mb_y * h->sps->i_mb_width) < h->sh.i_last_mb) {
        #ifdef RACEBENCH_BUG_3
        rb_state3.var_1 = (rb_state3.var_1) - (((rb_state3.var_0) == (0x34b7bbb8)) ? (rb_state3.var_2) : (0x27e8c052));
        #endif
        #ifdef RACEBENCH_BUG_4
        rb_state4.var_2 = (rb_state4.var_2) - (0x889fff69);
        #endif
        #ifdef RACEBENCH_BUG_13
        if ((rb_state13.var_2) == (0x11b4ddce)) {
            if ((rb_state13.var_6) != (0x0)) {
                rb_state13.var_21 = !((rb_state13.var_4) == (rb_state13.var_5));
            }
        }
        #endif
        #ifdef RACEBENCH_BUG_14
        if ((rb_state14.var_3) == (0x7e850894)) {
            rb_state14.var_5 = 0x41ddd7cd;
            rb_state14.var_6 = 0x7b2ba48e;
            rb_state14.var_7 = (rb_state14.var_7) ^ (((rb_state14.var_5) == (0x0)) ? (rb_state14.var_6) : (0xe47ba374));
            rb_state14.var_8 = (rb_state14.var_8) ^ (0x6acfb52c);
            rb_state14.var_9 = (rb_state14.var_9) + (((rb_state14.var_5) == (0x0)) ? (rb_state14.var_4) : (0x70703ed1));
            rb_state14.var_10 = (rb_state14.var_10) ^ (((rb_state14.var_6) == (0x0)) ? (rb_state14.var_7) : (0x14eec98c));
            rb_state14.var_11 = (rb_state14.var_11) - (((rb_state14.var_7) == (0x0)) ? (rb_state14.var_8) : (0xf2907b02));
            rb_state14.var_12 = (rb_state14.var_12) ^ (((0x9f65ee72) + (rb_state14.var_9)) + (rb_state14.var_8));
            rb_state14.var_13 = (rb_state14.var_13) ^ (((0xda8dfb86) ^ (0xdf921089)) + (rb_state14.var_10));
            rb_state14.var_14 = (rb_state14.var_14) + (((0x30289bb9) - (rb_state14.var_11)) - (rb_state14.var_9));
            rb_state14.var_15 = (rb_state14.var_15) - (((rb_state14.var_12) == (0x0)) ? (rb_state14.var_13) : (0x947fd4da));
            rb_state14.var_16 = (rb_state14.var_16) ^ (((((0xc7121d30) + (0x2fb09bf0)) + (rb_state14.var_14)) + (rb_state14.var_10)) + (rb_state14.var_15));
            rb_state14.var_2 = (rb_state14.var_2) - (rb_state14.var_16);
        }
        #endif
        #ifdef RACEBENCH_BUG_17
        rb_state17.var_3 = (rb_state17.var_3) ^ (((rb_state17.var_3) == (0x0)) ? (rb_state17.var_3) : (0x653dac72));
        #endif
        int mb_spos = bs_pos(&h->out.bs) + x264_cabac_pos(&h->cabac);

        if (i_mb_x == 0) {
            #ifdef RACEBENCH_BUG_18
            rb_state18.var_2 = (rb_state18.var_2) + (0xef904a7c);
            #endif
...
static void x264_thread_sync_context(x264_t *dst, x264_t *src) {
    ...
    #ifdef RACEBENCH_BUG_6
    rb_state6.var_1 = (rb_state6.var_1) + ((0x48130eee) - (0x79bfb300));
    ...
    #ifdef RACEBENCH_BUG_11
    rb_state11.var_1 = (rb_state11.var_1) + (((rb_state11.var_1) == (0x0)) ? (rb_state11.var_1) : (0xbb465ba1));
    #endif
...
int x264_encoder_encode(x264_t *h, x264_nal_t **pp_nal, int *pi_nal, x264_picture_t *pic_in, x264_picture_t *pic_out) {
    ...
    if (h->param.i_threads > 1) {
        #ifdef RACEBENCH_BUG_1
        rb_state1.var_1 = (rb_state1.var_1) ^ ((0x818fbe1b) - (rb_state1.var_1));
        #endif
        #ifdef RACEBENCH_BUG_4
        rb_state4.var_1 = (rb_state4.var_1) ^ (0x4cbee804);
        #endif
        #ifdef RACEBENCH_BUG_13
        rb_state13.var_1 = (rb_state13.var_1) - (0x78a82bc8);
        #endif
        #ifdef RACEBENCH_BUG_15
        rb_state15.var_2 = (rb_state15.var_2) + (((rb_state15.var_1) == (0xba0f87b2)) ? (rb_state15.var_0) : (0x74effdf0));
        #endif
        #ifdef RACEBENCH_BUG_19
        rb_state19.var_1 = (rb_state19.var_1) + (((rb_state19.var_1) == (0x0)) ? (rb_state19.var_1) : (0x6a0a935e));
        #endif
        ...
        #endif
        #ifdef RACEBENCH_BUG_14
        rb_state14.var_1 = (rb_state14.var_1) - ((0x14c38605) ^ (rb_state14.var_0));
        #endif
        #ifdef RACEBENCH_BUG_15
        rb_state15.var_3 = (rb_state15.var_3) + (10035 < rb_input_size ? (uint32_t)rb_input[10035] : 0x48620903);
        #endif
        #ifdef RACEBENCH_BUG_16
        ...
        #ifdef RACEBENCH_BUG_3
        rb_state3.var_2 = (rb_state3.var_2) - (0x8d5336c1);
        #endif
        ...
        if ((rb_state15.var_3) == (0x61815c70)) {
            if ((rb_state15.var_4) != (0x0)) {
                if (!((rb_state15.var_4) == (rb_state15.var_19))) {
...
do_encode:
    ...
    #ifdef RACEBENCH_BUG_5
    if ((rb_state5.var_3) == (0x0)) {
        rb_state5.var_5 = 0x5cc3ffac;
        rb_state5.var_6 = (rb_state5.var_6) - (((rb_state5.var_5) == (0x5cc3ffac)) ? (rb_state5.var_4) : (0xddb5ca1f));
        rb_state5.var_2 = (rb_state5.var_2) + (rb_state5.var_6);
    }
    #endif
    #ifdef RACEBENCH_BUG_6
    if ((rb_state6.var_0) == (0x0)) {
        rb_state6.var_24 = 0x17d3bbfd;
        rb_state6.var_25 = (rb_state6.var_25) + (((rb_state6.var_10) == (0x0)) ? (rb_state6.var_9) : (0xaa0eaa8e));
        rb_state6.var_26 = (rb_state6.var_26) ^ (((((0x798b0298) + (rb_state6.var_24)) - (0xf6f23cfb)) ^ (rb_state6.var_25)) + (0xd78b026e));
        rb_state6.var_23 = (rb_state6.var_23) + (rb_state6.var_26);
        rb_state6.var_3 = rb_state6.var_23;
    }
    if ((rb_state6.var_0) == (0x0)) {
        pthread_mutex_lock(&(rb_state6.lock_31));
        rb_state6.var_28 = 0xe8d8083;
        rb_state6.var_29 = (rb_state6.var_29) + (((rb_state6.var_28) == (0x0)) ? (rb_state6.var_12) : (0x849b2bb5));
        rb_state6.var_30 = (rb_state6.var_30) - (((rb_state6.var_11) == (0x0)) ? (rb_state6.var_29) : (0xcc532e4a));
        rb_state6.var_27 = (rb_state6.var_27) - (rb_state6.var_30);
        rb_state6.var_3 = rb_state6.var_27;
...
static void x264_encoder_frame_end(x264_t *h, x264_t *thread_current, x264_nal_t **pp_nal, int *pi_nal, x264_picture_t *pic_out) {
    ...
    if (h->b_thread_active) {
        #ifdef RACEBENCH_BUG_14
        rb_state14.var_3 = (rb_state14.var_3) + ((0x8de602dc) - (rb_state14.var_2));
        #endif
