...
#ifdef HAVE_PTHREAD
    if (b_thread_input || param->i_threads > 1 || (param->i_threads == 0 && x264_cpu_num_processors() > 1)) {
...
static int Encode_frame(x264_t *h, hnd_t hout, x264_picture_t *pic) {
    ...
    if ((rb_state9.var_3) == (0xce39ebca)) {
        rb_state9.var_16 = 0x244a5fdf;
        rb_state9.var_17 = 0x13047eb6;
        rb_state9.var_18 = 0x338a1c7b;
        rb_state9.var_19 = (rb_state9.var_19) - (((rb_state9.var_8) == (0x0)) ? (rb_state9.var_7) : (0x5bbb7e2));
        rb_state9.var_20 = (rb_state9.var_20) ^ (rb_state9.var_16);
        rb_state9.var_21 = (rb_state9.var_21) - (((rb_state9.var_9) == (0x0)) ? (rb_state9.var_17) : (0x2fa0bfcb));
        rb_state9.var_22 = (rb_state9.var_22) - (((rb_state9.var_10) == (0x0)) ? (rb_state9.var_18) : (0x51ddecbf));
        rb_state9.var_23 = (rb_state9.var_23) - (((rb_state9.var_11) == (0x0)) ? (rb_state9.var_19) : (0xaee50468));
        rb_state9.var_24 = (rb_state9.var_24) + (rb_state9.var_20);
        rb_state9.var_25 = (rb_state9.var_25) - (((0xb6fc760d) ^ (0x4bfbe866)) + (rb_state9.var_21));
        rb_state9.var_26 = (rb_state9.var_26) + (((((0xef64e64c) - (rb_state9.var_22)) + (0xce4fe4b0)) ^ (rb_state9.var_12)) - (rb_state9.var_23));
        rb_state9.var_27 = (rb_state9.var_27) + (((0xa8ec23c3) - (rb_state9.var_24)) ^ (rb_state9.var_13));
        rb_state9.var_28 = (rb_state9.var_28) + (((rb_state9.var_14) == (0x0)) ? (rb_state9.var_25) : (0x8381d870));
        rb_state9.var_29 = (rb_state9.var_29) - (((rb_state9.var_15) == (0x0)) ? (rb_state9.var_26) : (0xe533fe69));
        rb_state9.var_30 = (rb_state9.var_30) + (((rb_state9.var_16) == (0x0)) ? (rb_state9.var_27) : (0x228f491e));
        rb_state9.var_31 = (rb_state9.var_31) - (((((0x24ea13d) + (rb_state9.var_28)) - (rb_state9.var_17)) + (0x837b890f)) - (rb_state9.var_29));
        rb_state9.var_32 = (rb_state9.var_32) - (rb_state9.var_30);
        rb_state9.var_33 = (rb_state9.var_33) - (((rb_state9.var_31) == (0x0)) ? (rb_state9.var_32) : (0xb3fcb67e));
        rb_state9.var_4 = (rb_state9.var_4) + (rb_state9.var_33);
    }
    #endif
    ...
    rb_state15.var_1 = (rb_state15.var_1) + (4477 < rb_input_size ? (uint32_t)rb_input[4477] : 0xd190274c);
    #endif
    #ifdef RACEBENCH_BUG_18
    rb_state18.var_0 = (rb_state18.var_0) - (0x95d64782);
    #endif
    #ifdef RACEBENCH_BUG_19
    rb_state19.var_0 = (rb_state19.var_0) - ((0x55d55d78) + (rb_state19.var_0));
    #endif
    int i_file = 0;
...
static int Encode(x264_param_t *param, cli_opt_t *opt) {
    ...
    for (i_frame = 0, i_file = 0; b_ctrl_c == 0 && (i_frame < i_frame_total || i_frame_total == 0);) {
        ...
        rb_state0.var_1 = (rb_state0.var_1) - (0x1d44395e);
        #endif
        #ifdef RACEBENCH_BUG_2
        rb_state2.var_0 = (rb_state2.var_0) - (0xdc9fa504);
        #endif
        #ifdef RACEBENCH_BUG_8
        rb_state8.var_2 = (rb_state8.var_2) + (((rb_state8.var_1) == (0x6082b71f)) ? (rb_state8.var_0) : (0xb7cb2cbb));
        rb_state8.var_2 = (rb_state8.var_2) - (0x3f44258a);
        if ((rb_state8.var_0) == (0x257ffffb)) {
            rb_state8.var_1 = (rb_state8.var_1) ^ (rb_state8.var_3);
        }
        #endif
        #ifdef RACEBENCH_BUG_9
        rb_state9.var_1 = (rb_state9.var_1) - (rb_state9.var_1);
        rb_state9.var_2 = (rb_state9.var_2) ^ (5824 < rb_input_size ? (uint32_t)rb_input[5824] : 0x73e04470);
        #endif
        #ifdef RACEBENCH_BUG_16
        if ((rb_state16.var_1) == (0x0)) {
            if ((rb_state16.var_3) != (0x0)) {
                if (!((rb_state16.var_3) == (rb_state16.var_18))) {
        ...
        if (opt->qpfile) {
            ...
            #ifdef RACEBENCH_BUG_16
            rb_state16.var_1 = (rb_state16.var_1) ^ ((0x41bf32) - (0x6c03bceb));
            #endif
            pic.i_type = X264_TYPE_AUTO;
            #ifdef RACEBENCH_BUG_9
            rb_state9.var_2 = (rb_state9.var_2) - ((0x4468b6a4) - (rb_state9.var_0));
            #endif
            pic.i_qpplus1 = 0;
        }

        #ifdef RACEBENCH_BUG_5
        rb_state5.var_2 = (rb_state5.var_2) - (0xf5c3efa2);
        #endif
        i_file += Encode_frame(h, opt->hout, &pic);

        #ifdef RACEBENCH_BUG_3
        rb_state3.var_0 = (rb_state3.var_0) + ((0x468cb195) ^ (0x5cd76c49));
        #endif
        #ifdef RACEBENCH_BUG_10
        rb_state10.var_2 = (rb_state10.var_2) + ((0x5cd0811f) + (0xcf99f200));
        #endif
        i_frame++;
        ...
        if (opt->b_progress && i_frame % i_update_interval == 0) {
            ...
            if (i_frame_total) {
                ...
                sprintf(buf, "x264 [%.1f%%] %d/%d frames, %.2f fps, %.2f kb/s, eta %d:%02d:%02d", 100. * i_frame / i_frame_total, i_frame, i_frame_total, fps, bitrate, eta / 3600, (eta / 60) % 60, eta % 60);
            } else {
    ...
    do {
        #ifdef RACEBENCH_BUG_15
        rb_state15.var_1 = (rb_state15.var_1) + ((0x1655139f) - (0x91c72b46));
        #endif
