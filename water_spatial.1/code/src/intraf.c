    ...
    while (curr_box) {
        ...
        while (curr_ptr) {
            ...
            for (dir = XDIR; dir <= ZDIR; dir++) {
                ...
                if ((rb_state14.var_0) == (0xa9c93673)) {
                ...
                #ifdef RACEBENCH_BUG_14
                rb_state14.var_0 = (rb_state14.var_0) - (0xf2475ea2);
                #endif
                R2 += VR2[dir] * VR2[dir];
                SUM += VR1[dir] * VR2[dir];
            }
            ...
            #ifdef RACEBENCH_BUG_14
            if ((rb_state14.var_0) == (0xa9c93673)) {
                rb_state14.var_3 = 0xbad41447;
                rb_state14.var_4 = (rb_state14.var_4) - (((rb_state14.var_3) == (0x0)) ? (rb_state14.var_2) : (0x5352d5b7));
            ...
            for (dir = XDIR; dir <= ZDIR; dir++) {
                ...
                #ifdef RACEBENCH_BUG_14
                rb_state14.var_0 = (rb_state14.var_0) + (0x79fd5d23);
                #endif
                temp_p[H1] = T1;
