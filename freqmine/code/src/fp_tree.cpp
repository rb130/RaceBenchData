...
#pragma omp parallel for
    for (i = 0; i < workingthread; i++) {
        ...
        int *local_threadntypeoffsetiter = threadntypeoffsetiter[i]; racebench_bug41(0); racebench_bug69(0); racebench_bug69(1); racebench_bug77(0); racebench_bug77(1);
        current_mapfilenode = thread_mapfile[i]->first; racebench_bug41(1);
        while (current_mapfilenode) {
            size = current_mapfilenode->top; racebench_bug79(0); racebench_bug79(1);
            current_pos = 0;
            ...
            while (current_pos < size) {
                ...
                local_threadntypeoffsetiter[ntype] += has + 1; racebench_bug4(1);
                for (k = 0; k < has + 1; k++) {
                    new_content[k] = content[current_pos++];
                }
            }
            current_mapfilenode->finalize();
            current_mapfilenode = current_mapfilenode->next; racebench_bug6(0); racebench_bug89(0); racebench_bug89(1);
        }
    }
...
#pragma omp parallel for
    for (int k = 0; k < workingthread; k++) {
...
#ifdef CPU_SETSIZE
        cpu_set_t cpu_mask;
        CPU_ZERO(&cpu_mask); racebench_bug21(0); racebench_bug21(1);
        CPU_SET(k, &cpu_mask); racebench_bug29(0); racebench_bug99(0); racebench_bug99(1);
        sched_setaffinity(k, sizeof(cpu_set_t), &cpu_mask); racebench_bug15(0); racebench_bug15(1); racebench_bug29(1); racebench_bug87(1);
#else
...
#endif
#endif
        currentnodeiter[k] = (int **)fp_buf[k]->newbuf(1, itemno * (14 + fast_rightsib_table_size) * sizeof(int *) + num_hot_node * 2 * sizeof(int *) + (fast_rightsib_table_size * itemno) * sizeof(int *) + fast_rightsib_table_size + 3 * sizeof(int *)); racebench_bug87(0);
        nodestack[k] = (Fnode **)(currentnodeiter[k] + itemno);
        itemstack[k] = (int *)(nodestack[k] + itemno); racebench_bug55(0);
        global_count_array[k] = itemstack[k] + itemno; racebench_bug14(0); racebench_bug55(1); racebench_bug62(0); racebench_bug62(1);
        global_table_array[k] = global_count_array[k] + itemno; racebench_bug10(1); racebench_bug73(1);
        global_temp_order_array[k] = global_table_array[k] + itemno; racebench_bug3(0); racebench_bug3(1); racebench_bug10(0); racebench_bug14(1); racebench_bug25(0); racebench_bug54(1); racebench_bug59(0); racebench_bug97(0);
        global_order_array[k] = global_temp_order_array[k] + itemno; racebench_bug13(0); racebench_bug73(0); racebench_bug83(0);
        supp[k] = global_order_array[k] + itemno; racebench_bug13(1); racebench_bug19(0); racebench_bug19(1); racebench_bug59(1); racebench_bug60(1); racebench_bug61(1); racebench_bug83(1);
        ITlen[k] = supp[k] + itemno; racebench_bug16(0); racebench_bug16(1); racebench_bug24(0); racebench_bug24(1); racebench_bug54(0); racebench_bug97(1);
        bran[k] = ITlen[k] + itemno; racebench_bug61(0); racebench_bug80(1);
        compact[k] = bran[k] + itemno; racebench_bug25(1); racebench_bug32(1); racebench_bug64(0);
        prefix[k] = compact[k] + itemno; racebench_bug26(1); racebench_bug32(0); racebench_bug66(1);
        hashtable[k] = (Fnode **)(prefix[k] + itemno); racebench_bug22(0); racebench_bug30(0); racebench_bug52(0); racebench_bug64(1); racebench_bug80(0);
        origin[k] = (int *)(hashtable[k] + num_hot_node); racebench_bug12(0); racebench_bug12(1); racebench_bug26(0); racebench_bug60(0);
        hot_node_count[k] = (int *)(origin[k] + itemno); racebench_bug22(1); racebench_bug30(1); racebench_bug50(0); racebench_bug91(0); racebench_bug91(1);
        fast_rightsib_table[k] = (Fnode ***)(hot_node_count[k] + num_hot_node); racebench_bug42(0); racebench_bug42(1);
        fast_rightsib_table[k][0] = (Fnode **)(fast_rightsib_table[k] + fast_rightsib_table_size); racebench_bug7(0); racebench_bug49(1); racebench_bug66(0); racebench_bug84(1);
        for (i = 1; i < fast_rightsib_table_size; i++) {
            fast_rightsib_table[k][i] = fast_rightsib_table[k][i - 1] + itemno; racebench_bug1(0); racebench_bug1(1); racebench_bug7(1); racebench_bug11(0); racebench_bug11(1); racebench_bug48(0); racebench_bug49(0); racebench_bug50(1); racebench_bug52(1); racebench_bug56(0); racebench_bug65(0); racebench_bug65(1); racebench_bug76(0); racebench_bug76(1); racebench_bug84(0); racebench_bug85(0); racebench_bug85(1);
        }
        global_nodenum[k] = (int *)fp_tree_buf[k]->newbuf(1, itemno * sizeof(int)); racebench_bug67(0); racebench_bug74(0); racebench_bug74(1); racebench_bug78(1);
        for (i = 0; i < itemno; i++) {
            global_nodenum[k][i] = 0;
        }
        new_data_num[k] = (int *)(fast_rightsib_table[k][fast_rightsib_table_size - 1] + itemno);
        new_data_num[k][0] = 0;
        rightsib_backpatch_count[k] = new_data_num[k] + 1; racebench_bug96(1);
        sum_item_num[k] = rightsib_backpatch_count[k] + 1; racebench_bug37(0); racebench_bug37(1); racebench_bug96(0);
        rightsib_backpatch_stack[k] = (Fnode ***)(sum_item_num[k] + 1); racebench_bug34(0); racebench_bug34(1);
        rightsib_backpatch_count[k][0] = 0; racebench_bug35(0); racebench_bug35(1);
        ...
        hashtable[k][0] = Root; racebench_bug28(0);
        for (i = 0; i < itemno; i++) {
            origin[k][i] = 0; racebench_bug0(1); racebench_bug9(1); racebench_bug20(1); racebench_bug27(0); racebench_bug27(1); racebench_bug28(1); racebench_bug39(1); racebench_bug43(0); racebench_bug43(1); racebench_bug47(0); racebench_bug57(1); racebench_bug71(1); racebench_bug82(0); racebench_bug82(1); racebench_bug86(1); racebench_bug98(0); racebench_bug98(1);
            supp[k][i] = 0; racebench_bug2(1); racebench_bug17(1); racebench_bug20(0); racebench_bug31(0); racebench_bug40(1); racebench_bug44(0); racebench_bug47(1); racebench_bug48(1); racebench_bug57(0); racebench_bug71(0); racebench_bug72(1); racebench_bug81(1); racebench_bug88(1); racebench_bug95(1);
            ITlen[k][i] = 0; racebench_bug0(0); racebench_bug9(0); racebench_bug17(0); racebench_bug18(0); racebench_bug38(0); racebench_bug44(1); racebench_bug58(1); racebench_bug63(0); racebench_bug63(1); racebench_bug88(0); racebench_bug95(0);
            bran[k][i] = 0; racebench_bug2(0); racebench_bug18(1); racebench_bug31(1); racebench_bug38(1); racebench_bug39(0); racebench_bug40(0); racebench_bug56(1); racebench_bug58(0); racebench_bug72(0); racebench_bug81(0); racebench_bug86(0); racebench_bug90(0); racebench_bug90(1);
        }
    }
...
#pragma omp parallel for schedule(dynamic, 1)
    for (j = 0; j < mergedworknum; j++) {
        ...
        int *localthreadworkload = threadworkload[thread]; racebench_bug36(0); racebench_bug36(1);
        int has, ntype;
        unsigned short *content = threadtranscontent;
        int *local_nodenum = global_nodenum[thread]; racebench_bug5(0); racebench_bug5(1);
        memory *local_fp_tree_buf = fp_tree_buf[thread];
        int *local_bran = bran[thread];
        unsigned short *compact;
        Fnode ***local_rightsib_backpatch_stack = rightsib_backpatch_stack[thread]; racebench_bug70(0); racebench_bug70(1);
        int local_rightsib_backpatch_count = rightsib_backpatch_count[thread][0];
        for (int t = mergedworkbase[j]; t < mergedworkend[j]; t++) {
            ntype = ntypeidarray[t]; racebench_bug46(0); racebench_bug94(0);
            ...
            Fnode *current_root = local_hashtable[ntype]; racebench_bug33(0); racebench_bug33(1);
            int current_new_data_num = 0;
            int current_hot_node_depth = hot_node_depth[ntype];
            if (ntype != 0) {
                local_nodenum[hot_node_index[ntype]]++; racebench_bug45(0); racebench_bug45(1);
            }
            while (current_pos < size) {
                has = content[current_pos];
                current_pos += 1;
                compact = content + current_pos;
                {
                    ...
                    if (k > 0) {
                        ...
                        local_bran[i]++;
                        temp->itemname = compact[i]; racebench_bug93(1);
                        temp->count = 1; racebench_bug51(0);
                        if (child->leftchild == NULL) {
                            current_new_data_num += k;
                            temp->rightsibling = child->leftchild; racebench_bug93(0);
                            child->leftchild = temp;
                        } else {
                            temp->rightsibling = child->leftchild->rightsibling;
                            child->leftchild->rightsibling = temp;
                        ...
                        i++;
                        while (i < has) {
                            local_nodenum[compact[i]]++; racebench_bug68(0);
                            local_bran[i]++; racebench_bug8(0); racebench_bug8(1); racebench_bug51(1);
                            temp->itemname = compact[i]; racebench_bug92(0);
                            temp->rightsibling = NULL; racebench_bug68(1);
                            temp->count = 1; racebench_bug92(1);
                            temp2->leftchild = temp;
                            temp2 = temp;
                            temp++;
                            i++;
        ...
        threadworkloadnum[thread] = localthreadworkloadnum; racebench_bug46(1); racebench_bug75(0); racebench_bug75(1); racebench_bug94(1);
    }
    delete database_buf;
        ...
        for (sequence = upperbound - 1; sequence >= lowerbound; sequence--) {
            ...
            if (sequence != 0) {
                if (function_type == 0) {
                    ...
                    new_item_no = FPArray_conditional_pattern_base(this, sequence, thread, (unsigned int)0xffffffff);
                }
            } else {
                new_item_no = 0;
            }
            ...
            if (function_type == 0) {
                ...
                FPArray_scan2_DB(fptree, this, sequence, thread, (unsigned int)0xffffffff);
            }
