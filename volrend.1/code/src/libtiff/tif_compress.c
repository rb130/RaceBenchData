...
static struct cscheme const *findScheme(scheme)
int scheme;
{
...
static int TIFFNoEncode(tif, method)
TIFF *tif;
char *method;
{
...
int TIFFNoRowEncode(tif, pp, cc, s)
TIFF *tif;
u_char *pp;
int cc;
u_int s;
...
int TIFFNoStripEncode(tif, pp, cc, s)
TIFF *tif;
u_char *pp;
int cc;
u_int s;
...
int TIFFNoTileEncode(tif, pp, cc, s)
TIFF *tif;
u_char *pp;
int cc;
u_int s;
...
int TIFFNoRowDecode(tif, pp, cc, s)
TIFF *tif;
u_char *pp;
int cc;
u_int s;
...
int TIFFNoStripDecode(tif, pp, cc, s)
TIFF *tif;
u_char *pp;
int cc;
u_int s;
...
int TIFFNoTileDecode(tif, pp, cc, s)
TIFF *tif;
u_char *pp;
int cc;
u_int s;
