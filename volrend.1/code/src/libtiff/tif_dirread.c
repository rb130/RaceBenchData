...
static char *CheckMalloc(tif, n, what)
TIFF *tif;
int n;
char *what;
{
...
static int cvtRational(tif, dir, num, denom, rv)
TIFF *tif;
TIFFDirEntry *dir;
u_long num, denom;
float *rv;
...
static float TIFFFetchRational(tif, dir)
TIFF *tif;
TIFFDirEntry *dir;
{
    u_long l[2];
...
static float TIFFFetchFloat(tif, dir)
TIFF *tif;
TIFFDirEntry *dir;
{
