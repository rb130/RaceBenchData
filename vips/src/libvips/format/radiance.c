...
static int oldreadcolrs(scanline, len, fp)
...
static int freadcolrs(scanline, len, fp)
register COLR *scanline;
int len;
register FILE *fp;
{
...
static int fwritecolrs(scanline, len, fp)
register COLR *scanline;
int len;
register FILE *fp;
{
