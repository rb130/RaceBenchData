...
int *im_ivector(nl, nh) int nl, nh;
{
    int *v;
...
float *im_fvector(nl, nh) int nl, nh;
{
    float *v;
...
double *im_dvector(nl, nh) int nl, nh;
{
    double *v;
...
int **im_imat_alloc(nrl, nrh, ncl, nch) int nrl, nrh, ncl, nch;
{
    int i;
    int **m;
...
float **im_fmat_alloc(nrl, nrh, ncl, nch) int nrl, nrh, ncl, nch;
{
    int i;
    float **m;
...
double **im_dmat_alloc(nrl, nrh, ncl, nch) int nrl, nrh, ncl, nch;
{
    int i;
    double **m;
