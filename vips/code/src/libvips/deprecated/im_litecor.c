...
static int im_litecor0(in, white, out) IMAGE *in, *white, *out;
{
    PEL *p, *w;
    PEL *q, *bu;
    int c;
...
static int im_litecor1(in, white, out, factor) IMAGE *in, *white, *out;
double factor;
{
    PEL *p, *w;
    PEL *q, *bu;
...
int im_litecor(in, white, out, clip, factor) IMAGE *in, *white, *out;
int clip;
double factor;
{
