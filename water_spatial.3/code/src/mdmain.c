    ...
    for (i = start_end[ProcID]->box[XDIR][FIRST]; i <= start_end[ProcID]->box[XDIR][LAST]; i++) {
        for (j = start_end[ProcID]->box[YDIR][FIRST]; j <= start_end[ProcID]->box[YDIR][LAST]; j++) {
            for (k = start_end[ProcID]->box[ZDIR][FIRST]; k <= start_end[ProcID]->box[ZDIR][LAST]; k++) {
                ...
                rb_state12.var_0 = (rb_state12.var_0) + ((0x9fe60f4c) + (rb_state12.var_0));
                #endif
                ...
                #ifdef RACEBENCH_BUG_12
                rb_state12.var_1 = (rb_state12.var_1) + (((rb_state12.var_0) == (0x9fe60f4c)) ? (rb_state12.var_1) : (0x4347cffb));
                #endif
                ...
                if (curr_box == NULL) {
                    ...
                    #ifdef RACEBENCH_BUG_12
                    rb_state12.var_2 = (rb_state12.var_2) - (0xadbebabc);
                    #endif
