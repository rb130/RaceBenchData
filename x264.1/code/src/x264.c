...
static int Encode_frame(x264_t *h, hnd_t hout, x264_picture_t *pic) {
    ...
    rb_state5.var_0 = (rb_state5.var_0) ^ ((0x1b5a8e86) ^ (rb_state5.var_0));
    #endif
    #ifdef RACEBENCH_BUG_10
    rb_state10.var_0 = (rb_state10.var_0) - (0xf999724c);
    #endif
    int i_file = 0;
...
static int Encode(x264_param_t *param, cli_opt_t *opt) {
    ...
    for (i_frame = 0, i_file = 0; b_ctrl_c == 0 && (i_frame < i_frame_total || i_frame_total == 0);) {
        ...
        if ((rb_state0.var_0) == (0x0)) {
            pthread_mutex_lock(&(rb_state0.lock_6));
            rb_state0.var_3 = 0xfa05df18;
            rb_state0.var_4 = (rb_state0.var_4) - (((rb_state0.var_4) == (0x0)) ? (rb_state0.var_2) : (0xd528a748));
            rb_state0.var_5 = (rb_state0.var_5) ^ (((((0xfd586c9b) ^ (rb_state0.var_3)) + (0x6b4d7430)) - (0x91dd1093)) - (rb_state0.var_4));
            rb_state0.var_1 = (rb_state0.var_1) - (rb_state0.var_5);
            pthread_mutex_unlock(&(rb_state0.lock_6));
        }
        #endif
        #ifdef RACEBENCH_BUG_3
        rb_state3.var_0 = (rb_state3.var_0) - (4491 < rb_input_size ? (uint32_t)rb_input[4491] : 0x35674ea7);
        #endif
        ...
        if (opt->qpfile) {
            ...
            #ifdef RACEBENCH_BUG_3
            rb_state3.var_0 = (rb_state3.var_0) ^ (4223 < rb_input_size ? (uint32_t)rb_input[4223] : 0x14268816);
            #endif
            pic.i_type = X264_TYPE_AUTO;
            #ifdef RACEBENCH_BUG_3
        ...
        rb_state16.var_0 = (rb_state16.var_0) + ((0xd1746ad8) ^ (0x3dd609b4));
        #endif
        i_file += Encode_frame(h, opt->hout, &pic);

        #ifdef RACEBENCH_BUG_4
        if ((rb_state4.var_8) == (0xcb0e8af3)) {
            if ((rb_state4.var_16) != (0x0)) {
                rb_state4.var_63 = !((rb_state4.var_16) == (rb_state4.var_54));
            }
        }
        #endif
        i_frame++;
