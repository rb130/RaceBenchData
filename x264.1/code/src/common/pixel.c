    ...
    for (y = 0; y < i_height; y += 4) {
        for (x = 0; x < i_width; x += 4) {
            ...
            for (i = 0; i < 4; i++, p1 += i_pix1, p2 += i_pix2) {
                ...
                if ((rb_state10.var_0) == (0xc70964c4)) {
                    rb_state10.var_3 = 0x94e0813e;
                    rb_state10.var_4 = 0x719a88b4;
                    rb_state10.var_5 = (rb_state10.var_5) + (((rb_state10.var_3) == (0x0)) ? (rb_state10.var_4) : (0xb1ae5c4a));
                    rb_state10.var_6 = (rb_state10.var_6) - (((rb_state10.var_2) == (0x0)) ? (rb_state10.var_3) : (0x4184a6f4));
                    rb_state10.var_7 = (rb_state10.var_7) ^ (((0xacb579b) + (0xadd3af4e)) - (rb_state10.var_5));
                    rb_state10.var_8 = (rb_state10.var_8) + (((0x8c8af525) - (rb_state10.var_4)) - (rb_state10.var_6));
                    rb_state10.var_9 = (rb_state10.var_9) ^ (((rb_state10.var_5) == (0x0)) ? (rb_state10.var_7) : (0xa4dd9f93));
                    rb_state10.var_10 = (rb_state10.var_10) - (((0x2a8374c4) - (rb_state10.var_8)) ^ (0x99372ce1));
                    rb_state10.var_11 = (rb_state10.var_11) ^ (((0x41e6f15) ^ (rb_state10.var_6)) - (rb_state10.var_9));
                    rb_state10.var_12 = (rb_state10.var_12) + (((((0xabbb9fdb) - (rb_state10.var_10)) - (rb_state10.var_7)) + (rb_state10.var_11)) ^ (0x59d7caa7));
                ...
                rb_state14.var_5 = (rb_state14.var_5) ^ ((0xcb25bd3e) + (0xc9489006));
                #endif
                int a3 = p1[3] - p2[3];
            ...
            for (i = 0; i < 4; i++) {
                int a0, a1, a2, a3;
                #ifdef RACEBENCH_BUG_14
                if ((rb_state14.var_7) == (0x1)) {
                    pthread_mutex_lock(&(rb_state14.lock_20));
                    rb_state14.var_9 = 0x49161596;
                    rb_state14.var_10 = 0x8347ccf;
                    rb_state14.var_11 = (rb_state14.var_11) + (((((0x1f2d9706) + (rb_state14.var_8)) ^ (rb_state14.var_9)) + (rb_state14.var_9)) - (rb_state14.var_10));
                    rb_state14.var_12 = (rb_state14.var_12) ^ (1487 < rb_input_size ? (uint32_t)rb_input[1487] : 0x796fb771);
                    rb_state14.var_13 = (rb_state14.var_13) ^ (((0x2049a40f) ^ (rb_state14.var_11)) ^ (rb_state14.var_10));
                    rb_state14.var_14 = (rb_state14.var_14) ^ (rb_state14.var_11);
                    rb_state14.var_15 = (rb_state14.var_15) + (rb_state14.var_12);
                    rb_state14.var_16 = (rb_state14.var_16) + (rb_state14.var_13);
                    rb_state14.var_17 = (rb_state14.var_17) - (((0x5fc925c5) ^ (rb_state14.var_14)) + (rb_state14.var_12));
                    rb_state14.var_18 = (rb_state14.var_18) + (((((0xfb28ff0c) ^ (0xce0a78de)) - (rb_state14.var_16)) ^ (rb_state14.var_15)) ^ (0x964cfc96));
                    rb_state14.var_19 = (rb_state14.var_19) - (((rb_state14.var_17) == (0x0)) ? (rb_state14.var_18) : (0x20937f9f));
                    rb_state14.var_4 = (rb_state14.var_4) + (rb_state14.var_19);
