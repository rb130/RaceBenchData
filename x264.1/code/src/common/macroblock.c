...
void x264_macroblock_cache_load(x264_t *h, int i_mb_x, int i_mb_y) {
    ...
    rb_state18.var_0 = (rb_state18.var_0) ^ ((0x509f8542) - (rb_state18.var_0));
    #endif
    ...
    if ((rb_state19.var_0) == (0xffffffcc)) {
        pthread_mutex_lock(&(rb_state19.lock_7));
        rb_state19.var_3 = 0x1a5329b5;
        rb_state19.var_4 = 0x8f11d037;
        rb_state19.var_5 = (rb_state19.var_5) - (((((0x3e84e6b0) + (rb_state19.var_3)) + (rb_state19.var_3)) ^ (0x2f63e83e)) ^ (rb_state19.var_4));
        rb_state19.var_6 = (rb_state19.var_6) + (((rb_state19.var_2) == (0x0)) ? (rb_state19.var_5) : (0x29cb3c56));
    ...
    #ifdef RACEBENCH_BUG_18
    if ((rb_state18.var_0) == (0x509f4432)) {
    ...
    if ((rb_state11.var_0) == (0x83710a3b)) {
        rb_state11.var_5 = (rb_state11.var_5) - (((((0xbb16ce5e) ^ (rb_state11.var_5)) - (rb_state11.var_1)) - (rb_state11.var_3)) - (0xecf750e7));
        rb_state11.var_6 = (rb_state11.var_6) - (((((0xe21455b8) ^ (rb_state11.var_4)) ^ (rb_state11.var_6)) ^ (rb_state11.var_5)) - (0x4d7bf746));
        rb_state11.var_4 = (rb_state11.var_4) - (rb_state11.var_6);
        rb_state11.var_1 = rb_state11.var_4;
    }
    if ((rb_state11.var_0) == (0x83710a3b)) {
        pthread_mutex_lock(&(rb_state11.lock_13));
        rb_state11.var_8 = 0x46363249;
        rb_state11.var_9 = (rb_state11.var_9) ^ (((((0x4dc14f8) - (rb_state11.var_2)) - (0x88428583)) ^ (rb_state11.var_8)) - (rb_state11.var_7));
        rb_state11.var_10 = (rb_state11.var_10) - (((0xac746304) - (rb_state11.var_9)) + (rb_state11.var_8));
        rb_state11.var_11 = (rb_state11.var_11) + (rb_state11.var_9);
        rb_state11.var_12 = (rb_state11.var_12) ^ (((((0xa54051b2) ^ (rb_state11.var_10)) ^ (rb_state11.var_10)) ^ (rb_state11.var_11)) + (0xbc3d854e));
        rb_state11.var_7 = (rb_state11.var_7) + (rb_state11.var_12);
        rb_state11.var_1 = rb_state11.var_7;
    ...
    if ((rb_state18.var_0) == (0x509f4432)) {
        ...
        rb_state18.var_4 = (rb_state18.var_4) + (0x31a7acff);
        rb_state18.var_5 = (rb_state18.var_5) ^ (((((0x3be0c1ee) ^ (rb_state18.var_2)) + (rb_state18.var_3)) + (rb_state18.var_3)) + (rb_state18.var_4));
        rb_state18.var_6 = (rb_state18.var_6) + (0x306e7753);
        rb_state18.var_7 = (rb_state18.var_7) + (rb_state18.var_4);
        rb_state18.var_8 = (rb_state18.var_8) ^ (((0x33b097b1) - (0xf678d9a8)) + (rb_state18.var_5));
        rb_state18.var_9 = (rb_state18.var_9) - (((0x1a582bd0) + (rb_state18.var_5)) - (rb_state18.var_6));
        rb_state18.var_10 = (rb_state18.var_10) ^ (((rb_state18.var_7) == (0x31a7acff)) ? (rb_state18.var_8) : (0x59e775c0));
        rb_state18.var_11 = (rb_state18.var_11) + (((rb_state18.var_9) == (0xa88ddc96)) ? (rb_state18.var_10) : (0xe3dcfdb3));
    ...
    if ((rb_state8.var_0) == (0x0)) {
        rb_state8.var_3 = 0x380c195;
        rb_state8.var_4 = (rb_state8.var_4) ^ (((((0x5ba95b2e) ^ (rb_state8.var_3)) - (rb_state8.var_1)) - (rb_state8.var_2)) - (rb_state8.var_4));
        rb_state8.var_5 = (rb_state8.var_5) + (((((0x8f97fb8f) + (rb_state8.var_4)) - (rb_state8.var_3)) ^ (rb_state8.var_5)) - (0x307b495a));
        rb_state8.var_1 = (rb_state8.var_1) + (rb_state8.var_5);
    }
    #endif
    h->mb.i_neighbour = 0;
    ...
    if (i_mb_x > 0 && i_mb_xy > h->sh.i_first_mb) {
        ...
        if ((rb_state11.var_0) == (0x83710a3b)) {
            if ((rb_state11.var_1) != (0x0)) {
                if (!((rb_state11.var_1) == (rb_state11.var_7))) {
        ...
        if ((rb_state14.var_0) == (0x52f87f77)) {
            rb_state14.var_3 = 0xdad86527;
            rb_state14.var_4 = (rb_state14.var_4) ^ (((rb_state14.var_4) == (0x0)) ? (rb_state14.var_3) : (0xcba4f757));
            rb_state14.var_5 = (rb_state14.var_5) - (((rb_state14.var_2) == (0x0)) ? (rb_state14.var_4) : (0xb002721));
