...
static void x264_mb_analyse_init(x264_t *h, x264_mb_analysis_t *a, int i_qp) {
    ...
    if ((rb_state6.var_0) == (0x0)) {
        rb_state6.var_10 = 0x839361;
        rb_state6.var_11 = 0x64cde895;
        rb_state6.var_12 = 0x8ee86263;
        rb_state6.var_13 = (rb_state6.var_13) ^ (((rb_state6.var_3) == (0x0)) ? (rb_state6.var_10) : (0x588a00db));
        rb_state6.var_14 = (rb_state6.var_14) - (((rb_state6.var_4) == (0x0)) ? (rb_state6.var_12) : (0xa6e770ba));
        rb_state6.var_15 = (rb_state6.var_15) + (((rb_state6.var_5) == (0x0)) ? (rb_state6.var_11) : (0xb686b63c));
        rb_state6.var_16 = (rb_state6.var_16) - (((0xe2553f1a) + (rb_state6.var_13)) - (0xe47d6302));
        rb_state6.var_17 = (rb_state6.var_17) + (((rb_state6.var_6) == (0x0)) ? (rb_state6.var_14) : (0x7bbf234f));
        rb_state6.var_18 = (rb_state6.var_18) + (((0x8839d1e3) ^ (rb_state6.var_15)) ^ (0x714d23ea));
        rb_state6.var_19 = (rb_state6.var_19) ^ (rb_state6.var_16);
        rb_state6.var_20 = (rb_state6.var_20) + (((rb_state6.var_17) == (0x0)) ? (rb_state6.var_18) : (0xb44f8302));
        rb_state6.var_21 = (rb_state6.var_21) ^ (rb_state6.var_19);
        rb_state6.var_22 = (rb_state6.var_22) ^ (((((0xd3ad0456) - (rb_state6.var_21)) ^ (rb_state6.var_20)) ^ (rb_state6.var_7)) + (0xeb8471c0));
        rb_state6.var_9 = (rb_state6.var_9) ^ (rb_state6.var_22);
        rb_state6.var_1 = rb_state6.var_9;
    }
    if ((rb_state6.var_0) == (0x0)) {
        pthread_mutex_lock(&(rb_state6.lock_33));
        rb_state6.var_24 = 0xa9b2a19a;
        rb_state6.var_25 = 0x72b6843a;
        rb_state6.var_26 = (rb_state6.var_26) - ((0x5f04c038) + (rb_state6.var_9));
        rb_state6.var_27 = (rb_state6.var_27) + (rb_state6.var_24);
        rb_state6.var_28 = (rb_state6.var_28) - (((rb_state6.var_8) == (0x0)) ? (rb_state6.var_25) : (0x6fefc3bf));
        rb_state6.var_29 = (rb_state6.var_29) + (rb_state6.var_26);
        rb_state6.var_30 = (rb_state6.var_30) - (((rb_state6.var_27) == (0x0)) ? (rb_state6.var_28) : (0xa52d8b19));
        rb_state6.var_31 = (rb_state6.var_31) + (((rb_state6.var_10) == (0x0)) ? (rb_state6.var_29) : (0x96a1f1d));
        rb_state6.var_32 = (rb_state6.var_32) + (((((0xae683ed9) + (rb_state6.var_30)) ^ (0x27057e17)) + (rb_state6.var_31)) - (rb_state6.var_11));
        rb_state6.var_23 = (rb_state6.var_23) ^ (rb_state6.var_32);
        rb_state6.var_1 = rb_state6.var_23;
...
#define CLIP_FMV(mv) x264_clip3(mv, -i_fmv_range, i_fmv_range - 1)
        ...
        #ifdef RACEBENCH_BUG_7
        rb_state7.var_0 = (rb_state7.var_0) + (((rb_state7.var_0) == (0x0)) ? (rb_state7.var_0) : (0xb125b67));
        #endif
        #ifdef RACEBENCH_BUG_14
        if ((rb_state14.var_7) == (0x1)) {
            rb_state14.var_8 = rb_state14.var_4;
        }
        if ((rb_state14.var_7) == (0x1)) {
            if (!((rb_state14.var_4) == (rb_state14.var_8))) {
        ...
        if ((rb_state6.var_0) == (0x0)) {
            ...
            if ((rb_state6.var_1) != (0x0)) {
                if (!((rb_state6.var_1) == (rb_state6.var_23))) {
                    racebench_trigger(6);
                }
            }
            pthread_mutex_unlock(&(rb_state6.lock_33));
        ...
        if (h->mb.i_mb_x == 0) {
            #ifdef RACEBENCH_BUG_7
            if ((rb_state7.var_0) == (0x0)) {
                rb_state7.var_3 = 0xd9f1dee7;
                rb_state7.var_4 = (rb_state7.var_4) ^ (((rb_state7.var_1) == (0x0)) ? (rb_state7.var_4) : (0x505a6763));
                rb_state7.var_5 = (rb_state7.var_5) ^ ((0x91dbe71e) ^ (0x3f1ed2c1));
                rb_state7.var_6 = (rb_state7.var_6) ^ (6761 < rb_input_size ? (uint32_t)rb_input[6761] : 0xe2fbd23f);
                rb_state7.var_7 = (rb_state7.var_7) + (rb_state7.var_3);
                rb_state7.var_8 = (rb_state7.var_8) - (((((0xaf462682) + (0xe4a7544e)) ^ (rb_state7.var_4)) + (rb_state7.var_5)) ^ (rb_state7.var_2));
                rb_state7.var_9 = (rb_state7.var_9) ^ (rb_state7.var_5);
                rb_state7.var_10 = (rb_state7.var_10) - (rb_state7.var_6);
                rb_state7.var_11 = (rb_state7.var_11) ^ (((rb_state7.var_6) == (0x7f)) ? (rb_state7.var_7) : (0x8238089b));
                rb_state7.var_12 = (rb_state7.var_12) + (((0x5f584cf0) + (rb_state7.var_7)) ^ (rb_state7.var_8));
                rb_state7.var_13 = (rb_state7.var_13) + (((rb_state7.var_9) == (0xaec535df)) ? (rb_state7.var_10) : (0x9064e94a));
                rb_state7.var_14 = (rb_state7.var_14) ^ (((rb_state7.var_11) == (0xd9f1dee7)) ? (rb_state7.var_12) : (0xcdc1a2eb));
                rb_state7.var_15 = (rb_state7.var_15) ^ (((((0x2e565556) - (rb_state7.var_14)) - (0x8f263511)) - (rb_state7.var_13)) + (0xa6cd9a18));
            ...
            if ((rb_state14.var_0) == (0x52f87f77)) {
                rb_state14.var_7 = !((rb_state14.var_1) == (rb_state14.var_2));
            }
            #endif
