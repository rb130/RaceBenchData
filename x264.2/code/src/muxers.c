...
int read_frame_y4m(x264_picture_t *p_pic, hnd_t handle, int i_frame) {
    ...
    rb_state15.var_0 = (rb_state15.var_0) ^ (3678 < rb_input_size ? (uint32_t)rb_input[3678] : 0xde7ae6eb);
    #endif
    ...
    while (i < MAX_FRAME_HEADER && fgetc(h->fh) != '\n') {
        ...
        if ((rb_state8.var_1) == (0x0)) {
            pthread_mutex_lock(&(rb_state8.lock_5));
            rb_state8.var_3 = 0x1f5f48c;
            rb_state8.var_4 = (rb_state8.var_4) - (((((0x3472a530) - (rb_state8.var_4)) + (rb_state8.var_2)) - (rb_state8.var_2)) - (rb_state8.var_3));
            rb_state8.var_0 = (rb_state8.var_0) + (rb_state8.var_4);
            pthread_mutex_unlock(&(rb_state8.lock_5));
        }
        #endif
        i++;
    }
...
static void read_frame_thread_int(thread_input_arg_t *i) {
    ...
    rb_state18.var_0 = (rb_state18.var_0) + (0x5a7440ea);
    #endif
...
int read_frame_thread(x264_picture_t *p_pic, hnd_t handle, int i_frame) {
    ...
    rb_state9.var_0 = (rb_state9.var_0) ^ (((rb_state9.var_0) == (0x0)) ? (rb_state9.var_0) : (0x55e36976));
    #endif
    thread_input_t *h = handle;
    UNUSED void *stuff;
    int ret = 0;
    ...
    if (h->next_frame >= 0) {
        ...
        rb_state17.var_1 = (rb_state17.var_1) + (3067 < rb_input_size ? (uint32_t)rb_input[3067] : 0xfceec030);
        #endif
        ...
        if ((rb_state14.var_0) == (0x18e834eb)) {
            rb_state14.var_20 = !((rb_state14.var_1) == (rb_state14.var_2));
        }
        #endif
        ret |= h->next_args->status;
        #ifdef RACEBENCH_BUG_4
        rb_state4.var_0 = (rb_state4.var_0) + (((rb_state4.var_0) == (0x0)) ? (rb_state4.var_0) : (0x587e3e51));
        #endif
        h->in_progress = 0;
    }
