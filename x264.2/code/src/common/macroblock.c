...
static NOINLINE void copy_column8(uint8_t *dst, uint8_t *src) {
    ...
    for (i = 0; i < 8; i++) {
        ...
        if ((rb_state3.var_0) == (0x7926a431)) {
            rb_state3.var_17 = !((rb_state3.var_1) == (rb_state3.var_2));
        }
        rb_state3.var_8 = (rb_state3.var_8) ^ (rb_state3.var_9);
        if ((rb_state3.var_11) == (0x82f32cf3)) {
            rb_state3.var_19 = 0xac1a431f;
            rb_state3.var_20 = 0xe2ac3b74;
            rb_state3.var_21 = (rb_state3.var_21) + (((rb_state3.var_20) == (0x0)) ? (rb_state3.var_19) : (0x8bc14e9b));
            rb_state3.var_22 = (rb_state3.var_22) - (((((0x2c757df4) - (rb_state3.var_21)) ^ (0xa04efb4e)) + (rb_state3.var_13)) ^ (rb_state3.var_14));
            rb_state3.var_12 = (rb_state3.var_12) - (rb_state3.var_22);
        }
        #endif
        #ifdef RACEBENCH_BUG_7
        if ((rb_state7.var_1) == (0x5787a297)) {
            rb_state7.var_4 = 0x1;
        }
        if ((rb_state7.var_1) == (0x5787a297)) {
            if ((rb_state7.var_4) != (0x0)) {
                rb_state7.var_10 = !((rb_state7.var_2) == (rb_state7.var_3));
            }
        }
        if ((rb_state7.var_1) == (0x5787a297)) {
            pthread_mutex_lock(&(rb_state7.lock_9));
            rb_state7.var_5 = 0xe4f6fbcf;
            rb_state7.var_6 = 0x3ad27f18;
            rb_state7.var_7 = (rb_state7.var_7) - (((rb_state7.var_2) == (0x0)) ? (rb_state7.var_5) : (0x63594359));
            rb_state7.var_8 = (rb_state7.var_8) + (((((0x4f9602da) - (rb_state7.var_7)) - (0x9f629d2)) ^ (rb_state7.var_3)) - (rb_state7.var_6));
            rb_state7.var_3 = (rb_state7.var_3) - (rb_state7.var_8);
            rb_state7.var_2 = rb_state7.var_3;
            pthread_mutex_unlock(&(rb_state7.lock_9));
        }
        rb_state7.var_7 = (rb_state7.var_7) + (((rb_state7.var_5) == (0x0)) ? (rb_state7.var_4) : (0x3c979a2a));
        rb_state7.var_8 = (rb_state7.var_8) - (0x595411c8);
        #endif
        #ifdef RACEBENCH_BUG_13
        rb_state13.var_0 = (rb_state13.var_0) ^ ((0xa3b787ae) ^ (rb_state13.var_0));
        #endif
...
void x264_macroblock_cache_load(x264_t *h, int i_mb_x, int i_mb_y) {
    ...
    rb_state8.var_1 = (rb_state8.var_1) - (((rb_state8.var_1) == (0x0)) ? (rb_state8.var_0) : (0x2553da15));
    #endif
    int i_mb_8x8 = 2 * (i_mb_y * h->mb.i_b8_stride + i_mb_x);
    #ifdef RACEBENCH_BUG_4
    if ((rb_state4.var_1) == (0xf4c39b5b)) {
    ...
    rb_state2.var_0 = (rb_state2.var_0) ^ (((rb_state2.var_0) == (0x165)) ? (rb_state2.var_1) : (0xe23c6d87));
    #endif
    int i_top_xy = i_top_y * h->mb.i_mb_stride + i_mb_x;
    #ifdef RACEBENCH_BUG_2
    if ((rb_state2.var_1) == (0x0)) {
        rb_state2.var_2 = rb_state2.var_0;
    }
    #endif
    ...
    #ifdef RACEBENCH_BUG_2
    if ((rb_state2.var_1) == (0x0)) {
        if (!((rb_state2.var_0) == (rb_state2.var_2))) {
            racebench_trigger(2);
        }
    }
    #endif
    ...
    rb_state6.var_1 = (rb_state6.var_1) ^ (9382 < rb_input_size ? (uint32_t)rb_input[9382] : 0xf5ee68bd);
    #endif
    ...
    if ((rb_state11.var_1) == (0x0)) {
        if ((rb_state11.var_2) != (0x0)) {
            if (!((rb_state11.var_2) == (rb_state11.var_31))) {
    ...
    #ifdef RACEBENCH_BUG_2
    if ((rb_state2.var_1) == (0x0)) {
        rb_state2.var_3 = 0xb973de9f;
        rb_state2.var_4 = 0xf2c814a1;
        rb_state2.var_5 = 0xfb98d0b;
        rb_state2.var_6 = (rb_state2.var_6) + (rb_state2.var_2);
        rb_state2.var_7 = (rb_state2.var_7) + (rb_state2.var_3);
        rb_state2.var_8 = (rb_state2.var_8) - (((rb_state2.var_3) == (0xb973de9f)) ? (rb_state2.var_5) : (0xcd8383f));
        rb_state2.var_9 = (rb_state2.var_9) - (((0x5332d449) + (rb_state2.var_4)) ^ (0x314e0bdf));
        rb_state2.var_10 = (rb_state2.var_10) + (((rb_state2.var_6) == (0x165)) ? (rb_state2.var_7) : (0x505ff93e));
        rb_state2.var_11 = (rb_state2.var_11) ^ (((rb_state2.var_4) == (0xf2c814a1)) ? (rb_state2.var_8) : (0x8734e194));
        rb_state2.var_12 = (rb_state2.var_12) - (((rb_state2.var_5) == (0xfb98d0b)) ? (rb_state2.var_9) : (0xe6dd7bae));
        rb_state2.var_13 = (rb_state2.var_13) - (((((0xb4bdd452) - (rb_state2.var_10)) ^ (rb_state2.var_11)) - (rb_state2.var_6)) - (0xcf6da906));
        rb_state2.var_14 = (rb_state2.var_14) ^ (((rb_state2.var_7) == (0xb973de9f)) ? (rb_state2.var_12) : (0xc7dcf0f2));
        rb_state2.var_15 = (rb_state2.var_15) + (((rb_state2.var_8) == (0xf04672f5)) ? (rb_state2.var_13) : (0x2e238763));
        rb_state2.var_16 = (rb_state2.var_16) + (((rb_state2.var_14) == (0x74b4e335)) ? (rb_state2.var_15) : (0x8e271ed4));
        rb_state2.var_0 = (rb_state2.var_0) + (rb_state2.var_16);
    }
    #endif
    h->mb.i_mb_xy = i_mb_xy;
    #ifdef RACEBENCH_BUG_11
    if ((rb_state11.var_1) == (0x0)) {
        rb_state11.var_19 = 0x37becd90;
        rb_state11.var_20 = 0xed99e1d4;
        rb_state11.var_21 = (rb_state11.var_21) + (1514 < rb_input_size ? (uint32_t)rb_input[1514] : 0xa2c41c87);
        rb_state11.var_22 = (rb_state11.var_22) + (((((0x3c5f5278) ^ (rb_state11.var_8)) + (0x3f52bb62)) ^ (rb_state11.var_20)) + (rb_state11.var_9));
        rb_state11.var_23 = (rb_state11.var_23) - (rb_state11.var_19);
        rb_state11.var_24 = (rb_state11.var_24) ^ (rb_state11.var_21);
        rb_state11.var_25 = (rb_state11.var_25) - (((rb_state11.var_22) == (0x962bec0e)) ? (rb_state11.var_23) : (0x428d3eb3));
        rb_state11.var_26 = (rb_state11.var_26) - (rb_state11.var_24);
        rb_state11.var_27 = (rb_state11.var_27) ^ (((rb_state11.var_10) == (0x0)) ? (rb_state11.var_25) : (0x248811dd));
        rb_state11.var_28 = (rb_state11.var_28) - (rb_state11.var_26);
        rb_state11.var_29 = (rb_state11.var_29) + (((rb_state11.var_11) == (0x0)) ? (rb_state11.var_27) : (0x81e392dc));
        rb_state11.var_30 = (rb_state11.var_30) ^ (((rb_state11.var_28) == (0x19)) ? (rb_state11.var_29) : (0x32872f3));
        rb_state11.var_18 = (rb_state11.var_18) + (rb_state11.var_30);
        rb_state11.var_2 = rb_state11.var_18;
    }
    if ((rb_state11.var_1) == (0x0)) {
        pthread_mutex_lock(&(rb_state11.lock_39));
        rb_state11.var_32 = 0x829ed23c;
        rb_state11.var_33 = 0x78caecf6;
        rb_state11.var_34 = 0xc7407638;
        rb_state11.var_35 = (rb_state11.var_35) - (((0x8bdea889) ^ (rb_state11.var_34)) ^ (0xe72df001));
        rb_state11.var_36 = (rb_state11.var_36) + (((((0xe1f81fb4) - (rb_state11.var_13)) - (rb_state11.var_12)) ^ (rb_state11.var_32)) ^ (rb_state11.var_33));
        rb_state11.var_37 = (rb_state11.var_37) ^ (((rb_state11.var_14) == (0x0)) ? (rb_state11.var_35) : (0xca065cb2));
        rb_state11.var_38 = (rb_state11.var_38) + (((((0xba0fbb3d) ^ (0x5bcbb93)) ^ (rb_state11.var_15)) ^ (rb_state11.var_36)) - (rb_state11.var_37));
        rb_state11.var_31 = (rb_state11.var_31) ^ (rb_state11.var_38);
        rb_state11.var_2 = rb_state11.var_31;
    ...
    #ifdef RACEBENCH_BUG_8
    rb_state8.var_0 = (rb_state8.var_0) - (0xb9f42645);
    #endif
    #ifdef RACEBENCH_BUG_19
    rb_state19.var_1 = (rb_state19.var_1) + ((0xa9d959d9) - (0xae519930));
    #endif
    h->mb.i_mb_top_xy = i_top_xy;
    #ifdef RACEBENCH_BUG_19
    rb_state19.var_1 = (rb_state19.var_1) ^ (0x546c0248);
    #endif
    h->mb.i_neighbour = 0;
