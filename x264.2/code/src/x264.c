...
static int Encode_frame(x264_t *h, hnd_t hout, x264_picture_t *pic) {
    ...
    rb_state11.var_0 = (rb_state11.var_0) ^ (((rb_state11.var_0) == (0x0)) ? (rb_state11.var_0) : (0x93f9f565));
    #endif
    int i_file = 0;
...
static int Encode(x264_param_t *param, cli_opt_t *opt) {
    ...
    for (i_frame = 0, i_file = 0; b_ctrl_c == 0 && (i_frame < i_frame_total || i_frame_total == 0);) {
        ...
        rb_state12.var_0 = (rb_state12.var_0) + (0x7cf31e07);
        #endif
        ...
        if (opt->qpfile) {
            ...
            rb_state17.var_1 = (rb_state17.var_1) + ((0x470263ae) - (0xf168a148));
            #endif
            pic.i_qpplus1 = 0;
        }

        #ifdef RACEBENCH_BUG_0
        rb_state0.var_0 = (rb_state0.var_0) + (((rb_state0.var_0) == (0x0)) ? (rb_state0.var_0) : (0x513780c9));
        #endif
        #ifdef RACEBENCH_BUG_5
        rb_state5.var_0 = (rb_state5.var_0) - (((rb_state5.var_0) == (0x0)) ? (rb_state5.var_0) : (0xb212f299));
        #endif
        #ifdef RACEBENCH_BUG_17
        rb_state17.var_0 = (rb_state17.var_0) ^ (((rb_state17.var_0) == (0x0)) ? (rb_state17.var_0) : (0x53ef3f04));
        #endif
