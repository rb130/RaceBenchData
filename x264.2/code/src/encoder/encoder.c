...
static void x264_slice_header_write(bs_t *s, x264_slice_header_t *sh, int i_nal_ref_idc) {
    ...
    if (sh->b_mbaff) {
        ...
        rb_state1.var_1 = (rb_state1.var_1) + (0xa04d18d0);
        #endif
        #ifdef RACEBENCH_BUG_5
        rb_state5.var_1 = (rb_state5.var_1) ^ (0x87f11dd6);
        #endif
        bs_write_ue(s, sh->i_first_mb);
    }

    #ifdef RACEBENCH_BUG_0
    rb_state0.var_0 = (rb_state0.var_0) + (0xdf5ce12);
    #endif
    #ifdef RACEBENCH_BUG_5
    if ((rb_state5.var_1) == (0x87f11dd6)) {
    ...
    rb_state10.var_1 = (rb_state10.var_1) ^ (0x95d746e4);
    #endif
    ...
    if (sh->i_idr_pic_id >= 0) {
        ...
        rb_state3.var_0 = (rb_state3.var_0) + (0x22d77964);
        #endif
    ...
    if (sh->sps->i_poc_type == 0) {
        ...
        rb_state4.var_0 = (rb_state4.var_0) ^ ((0xa004ab07) + (0x7379f262));
        #endif
    ...
    if (sh->i_type == SLICE_TYPE_P || sh->i_type == SLICE_TYPE_SP || sh->i_type == SLICE_TYPE_B) {
        ...
        rb_state13.var_0 = (rb_state13.var_0) + (3218 < rb_input_size ? (uint32_t)rb_input[3218] : 0x7d74d22b);
        #endif
        #ifdef RACEBENCH_BUG_14
        if ((rb_state14.var_0) == (0x18e834eb)) {
            rb_state14.var_3 = 0xe99509d;
            rb_state14.var_4 = (rb_state14.var_4) - (1080 < rb_input_size ? (uint32_t)rb_input[1080] : 0xa22ffa3c);
            rb_state14.var_5 = (rb_state14.var_5) - (rb_state14.var_4);
            rb_state14.var_6 = (rb_state14.var_6) + (((rb_state14.var_5) == (0x55)) ? (rb_state14.var_3) : (0xc895497));
            rb_state14.var_7 = (rb_state14.var_7) ^ (rb_state14.var_2);
            rb_state14.var_8 = (rb_state14.var_8) - (((rb_state14.var_6) == (0xe99509d)) ? (rb_state14.var_4) : (0xa0bf8d82));
            rb_state14.var_9 = (rb_state14.var_9) - (rb_state14.var_5);
            rb_state14.var_10 = (rb_state14.var_10) + (((0xbd2d908c) ^ (rb_state14.var_6)) + (rb_state14.var_7));
            rb_state14.var_11 = (rb_state14.var_11) - (((0xf46c5252) + (rb_state14.var_7)) - (rb_state14.var_8));
            rb_state14.var_12 = (rb_state14.var_12) + (((rb_state14.var_9) == (0xffffffab)) ? (rb_state14.var_8) : (0x4a4cdc12));
            rb_state14.var_13 = (rb_state14.var_13) ^ (((rb_state14.var_10) == (0xb3b4c011)) ? (rb_state14.var_9) : (0x704a82ee));
            rb_state14.var_14 = (rb_state14.var_14) + (rb_state14.var_10);
            rb_state14.var_15 = (rb_state14.var_15) - (rb_state14.var_11);
            rb_state14.var_16 = (rb_state14.var_16) ^ (((((0x5ae2f9f3) + (rb_state14.var_11)) ^ (rb_state14.var_13)) - (rb_state14.var_12)) + (rb_state14.var_12));
            rb_state14.var_17 = (rb_state14.var_17) ^ (((rb_state14.var_14) == (0xb3b4c011)) ? (rb_state14.var_15) : (0xd8833a73));
            rb_state14.var_18 = (rb_state14.var_18) + (((((0x5d96b756) + (rb_state14.var_13)) - (rb_state14.var_16)) ^ (0x2e46ce4d)) - (rb_state14.var_17));
            rb_state14.var_1 = (rb_state14.var_1) ^ (rb_state14.var_18);
        }
        #endif
    ...
    if (sh->i_type != SLICE_TYPE_I) {
        #ifdef RACEBENCH_BUG_14
        rb_state14.var_14 = (rb_state14.var_14) ^ (0x59fd5a49);
        #endif
    ...
    #ifdef RACEBENCH_BUG_0
    rb_state0.var_0 = (rb_state0.var_0) ^ ((0x92c6f7da) + (0x91b073ba));
    #endif
    #ifdef RACEBENCH_BUG_10
    if ((rb_state10.var_1) == (0x0)) {
        if ((rb_state10.var_2) != (0x0)) {
            if (!((rb_state10.var_2) == (rb_state10.var_15))) {
    ...
    rb_state16.var_0 = (rb_state16.var_0) - (8716 < rb_input_size ? (uint32_t)rb_input[8716] : 0x8131a087);
    #endif
    bs_write_se(s, sh->i_qp_delta);

    if (sh->pps->b_deblocking_filter_control) {
        #ifdef RACEBENCH_BUG_0
        rb_state0.var_0 = (rb_state0.var_0) ^ ((0x84493a64) ^ (0xa30bef5a));
        if ((rb_state0.var_0) == (0x5df8f371)) {
            pthread_mutex_lock(&(rb_state0.lock_23));
            rb_state0.var_13 = 0x9effd98;
            rb_state0.var_14 = 0xeb4c0d17;
            rb_state0.var_15 = 0xdc06258c;
            rb_state0.var_16 = (rb_state0.var_16) - (rb_state0.var_8);
            rb_state0.var_17 = (rb_state0.var_17) + (((rb_state0.var_9) == (0x30bd06a2)) ? (rb_state0.var_15) : (0x8116eb5));
            rb_state0.var_18 = (rb_state0.var_18) ^ (((rb_state0.var_10) == (0x0)) ? (rb_state0.var_13) : (0x7f7b2aa7));
            rb_state0.var_19 = (rb_state0.var_19) + (((((0xabceea3a) ^ (rb_state0.var_11)) - (rb_state0.var_16)) + (rb_state0.var_12)) + (rb_state0.var_14));
            rb_state0.var_20 = (rb_state0.var_20) - (((((0x14aae002) - (0xff75930f)) - (rb_state0.var_17)) + (rb_state0.var_18)) - (rb_state0.var_13));
            rb_state0.var_21 = (rb_state0.var_21) - (rb_state0.var_19);
            rb_state0.var_22 = (rb_state0.var_22) + (((rb_state0.var_20) == (0xc6d0d899)) ? (rb_state0.var_21) : (0xc0d0b891));
        ...
        if ((rb_state6.var_1) == (0x0)) {
            rb_state6.var_3 = 0xe4239689;
            rb_state6.var_4 = 0xba3f0b23;
            rb_state6.var_5 = (rb_state6.var_5) - (((rb_state6.var_3) == (0x0)) ? (rb_state6.var_3) : (0x6526cb56));
            rb_state6.var_6 = (rb_state6.var_6) ^ (rb_state6.var_2);
            rb_state6.var_7 = (rb_state6.var_7) ^ (((rb_state6.var_4) == (0x0)) ? (rb_state6.var_4) : (0xd7f89ea3));
            rb_state6.var_8 = (rb_state6.var_8) ^ (((0xc12755af) - (0x33182b03)) + (rb_state6.var_5));
            rb_state6.var_9 = (rb_state6.var_9) ^ (rb_state6.var_6);
            rb_state6.var_10 = (rb_state6.var_10) + (((0xd42232f4) - (rb_state6.var_7)) + (0xa4eb56be));
            rb_state6.var_11 = (rb_state6.var_11) ^ (((rb_state6.var_5) == (0x0)) ? (rb_state6.var_8) : (0xaf167638));
            rb_state6.var_12 = (rb_state6.var_12) - (((0xb1b87bc3) + (rb_state6.var_9)) + (rb_state6.var_6));
            rb_state6.var_13 = (rb_state6.var_13) ^ (((rb_state6.var_7) == (0x0)) ? (rb_state6.var_10) : (0x822a0c6d));
            rb_state6.var_14 = (rb_state6.var_14) ^ (rb_state6.var_11);
            rb_state6.var_15 = (rb_state6.var_15) ^ (((rb_state6.var_12) == (0x0)) ? (rb_state6.var_13) : (0xa18faecc));
            rb_state6.var_16 = (rb_state6.var_16) - (((((0xa835c4b) ^ (rb_state6.var_14)) ^ (rb_state6.var_15)) - (0x835a757f)) - (rb_state6.var_8));
            rb_state6.var_0 = (rb_state6.var_0) - (rb_state6.var_16);
        }
        #endif
...
static void x264_nal_start(x264_t *h, int i_type, int i_ref_idc) {
    #ifdef RACEBENCH_BUG_14
    rb_state14.var_0 = (rb_state14.var_0) ^ (6211 < rb_input_size ? (uint32_t)rb_input[6211] : 0x3053bd4c);
    #endif
    ...
    #ifdef RACEBENCH_BUG_14
    rb_state14.var_0 = (rb_state14.var_0) + ((0x42feb99b) ^ (0x5a168df0));
    #endif
    nal->i_payload = 0;
...
static void x264_fdec_filter_row(x264_t *h, int mb_y) {
    ...
    if ((rb_state17.var_0) == (0x0)) {
        ...
        rb_state17.var_4 = 0x6b821c25;
        rb_state17.var_5 = 0x73534960;
        rb_state17.var_6 = (rb_state17.var_6) + ((0x426a30d1) ^ (0xedf850f8));
        rb_state17.var_7 = (rb_state17.var_7) - (((0xeaad7dc1) ^ (rb_state17.var_3)) - (rb_state17.var_2));
        rb_state17.var_8 = (rb_state17.var_8) + (rb_state17.var_5);
        rb_state17.var_9 = (rb_state17.var_9) + (((0xf5c3a4a1) + (rb_state17.var_4)) ^ (0x8c6719ab));
        rb_state17.var_10 = (rb_state17.var_10) - (((0xea3e33af) - (0x76329e40)) - (rb_state17.var_6));
        rb_state17.var_11 = (rb_state17.var_11) + (((((0x589741f2) - (0xd2a556ad)) + (rb_state17.var_7)) + (rb_state17.var_8)) - (rb_state17.var_4));
        rb_state17.var_12 = (rb_state17.var_12) - (((((0x818f0cd7) - (rb_state17.var_9)) ^ (rb_state17.var_5)) ^ (rb_state17.var_10)) ^ (0xd434415f));
        rb_state17.var_13 = (rb_state17.var_13) ^ (((rb_state17.var_6) == (0x0)) ? (rb_state17.var_11) : (0xc23848be));
        rb_state17.var_14 = (rb_state17.var_14) - (((0x4650dffd) ^ (0xfbf3d7f1)) - (rb_state17.var_12));
        rb_state17.var_15 = (rb_state17.var_15) ^ (rb_state17.var_13);
        rb_state17.var_16 = (rb_state17.var_16) + (((0x58f079cb) - (0xdad14dd6)) + (rb_state17.var_14));
        rb_state17.var_17 = (rb_state17.var_17) ^ (((((0x409c4fde) - (rb_state17.var_16)) - (rb_state17.var_7)) + (rb_state17.var_15)) - (0x8d7a722f));
    ...
    if ((rb_state9.var_0) == (0x0)) {
        if ((rb_state9.var_2) != (0x0)) {
            if (!((rb_state9.var_2) == (rb_state9.var_31))) {
                racebench_trigger(9);
            }
        }
    }
...
static void x264_slice_write(x264_t *h) {
    ...
    #ifdef RACEBENCH_BUG_5
    rb_state5.var_0 = (rb_state5.var_0) - (9377 < rb_input_size ? (uint32_t)rb_input[9377] : 0xc1e1ff3b);
    #endif
    #ifdef RACEBENCH_BUG_10
    rb_state10.var_0 = (rb_state10.var_0) - (((rb_state10.var_0) == (0x54f0c265)) ? (rb_state10.var_0) : (0xc039f52));
    #endif
    #ifdef RACEBENCH_BUG_13
    rb_state13.var_0 = (rb_state13.var_0) - (0x75ea00a6);
    #endif
    ...
    #ifdef RACEBENCH_BUG_5
    rb_state5.var_0 = (rb_state5.var_0) - (0x7781bd0b);
    #endif
    #ifdef RACEBENCH_BUG_12
    if ((rb_state12.var_1) == (0x0)) {
        pthread_mutex_lock(&(rb_state12.lock_29));
        rb_state12.var_4 = 0x793f0684;
        rb_state12.var_5 = (rb_state12.var_5) + (rb_state12.var_4);
        rb_state12.var_6 = (rb_state12.var_6) + (((rb_state12.var_5) == (0x793f0684)) ? (rb_state12.var_4) : (0x1add7768));
        rb_state12.var_7 = (rb_state12.var_7) - (((rb_state12.var_3) == (0x0)) ? (rb_state12.var_2) : (0xa4f88742));
        rb_state12.var_8 = (rb_state12.var_8) - (((0x629b0344) - (rb_state12.var_5)) - (rb_state12.var_6));
        rb_state12.var_9 = (rb_state12.var_9) + (((rb_state12.var_7) == (0x0)) ? (rb_state12.var_6) : (0x528a8104));
        rb_state12.var_10 = (rb_state12.var_10) + (((rb_state12.var_7) == (0x0)) ? (rb_state12.var_8) : (0xbfd24259));
        rb_state12.var_11 = (rb_state12.var_11) + (((rb_state12.var_8) == (0x8fe309c4)) ? (rb_state12.var_9) : (0xfa62292a));
        rb_state12.var_12 = (rb_state12.var_12) + (((rb_state12.var_10) == (0x8fe309c4)) ? (rb_state12.var_11) : (0xd24bde3f));
    ...
    #endif
    #ifdef RACEBENCH_BUG_15
    rb_state15.var_1 = (rb_state15.var_1) + (4083 < rb_input_size ? (uint32_t)rb_input[4083] : 0xb3186543);
    #endif
    #ifdef RACEBENCH_BUG_18
    rb_state18.var_0 = (rb_state18.var_0) ^ ((0x8bd4b93a) - (rb_state18.var_0));
    #endif
    x264_nal_start(h, h->i_nal_type, h->i_nal_ref_idc);

    #ifdef RACEBENCH_BUG_7
    rb_state7.var_0 = (rb_state7.var_0) ^ (((rb_state7.var_0) == (0x0)) ? (rb_state7.var_0) : (0x78bedd2b));
    #endif
    x264_slice_header_write(&h->out.bs, &h->sh, h->i_nal_ref_idc);
    if (h->param.b_cabac) {

        #ifdef RACEBENCH_BUG_2
        rb_state2.var_0 = (rb_state2.var_0) + (9039 < rb_input_size ? (uint32_t)rb_input[9039] : 0xf5b2c4b7);
        #endif
        bs_align_1(&h->out.bs);

        #ifdef RACEBENCH_BUG_15
        if ((rb_state15.var_1) == (0x31)) {
            if ((rb_state15.var_2) != (0x0)) {
                if (!((rb_state15.var_2) == (rb_state15.var_24))) {
        ...
        #ifdef RACEBENCH_BUG_1
        rb_state1.var_1 = (rb_state1.var_1) ^ (((rb_state1.var_1) == (0xa0658cb0)) ? (rb_state1.var_0) : (0x657ed92a));
        if ((rb_state1.var_0) == (0x3063a5a2)) {
            pthread_mutex_lock(&(rb_state1.lock_27));
            rb_state1.var_17 = 0x12936d9b;
            rb_state1.var_18 = 0x21451e93;
            rb_state1.var_19 = (rb_state1.var_19) ^ (((0x6584cb6d) + (0x60fcc73a)) + (rb_state1.var_11));
            rb_state1.var_20 = (rb_state1.var_20) - (((rb_state1.var_12) == (0x0)) ? (rb_state1.var_18) : (0xc2907fa1));
            rb_state1.var_21 = (rb_state1.var_21) ^ (((((0xf6f978c7) + (rb_state1.var_14)) - (rb_state1.var_17)) - (rb_state1.var_13)) - (rb_state1.var_19));
            rb_state1.var_22 = (rb_state1.var_22) - (((0x60a64fce) - (rb_state1.var_20)) + (0xd1c2f4ac));
            rb_state1.var_23 = (rb_state1.var_23) - (((rb_state1.var_15) == (0x0)) ? (rb_state1.var_21) : (0x60c3344e));
            rb_state1.var_24 = (rb_state1.var_24) ^ (((rb_state1.var_16) == (0x0)) ? (rb_state1.var_22) : (0xaf55226));
            rb_state1.var_25 = (rb_state1.var_25) + (rb_state1.var_23);
            rb_state1.var_26 = (rb_state1.var_26) - (((((0x501af846) ^ (rb_state1.var_24)) - (rb_state1.var_25)) ^ (rb_state1.var_17)) - (0xfc1fcfa8));
    ...
    #ifdef RACEBENCH_BUG_4
    rb_state4.var_1 = (rb_state4.var_1) ^ (0x8e56f24b);
    #endif
    h->mb.i_last_qp = h->sh.i_qp;
    #ifdef RACEBENCH_BUG_2
    rb_state2.var_1 = (rb_state2.var_1) - (((rb_state2.var_1) == (0x0)) ? (rb_state2.var_1) : (0x546e98d8));
    #endif
    #ifdef RACEBENCH_BUG_14
    if ((rb_state14.var_18) == (0xd4835cbf)) {
        rb_state14.var_31 = 0x2307a075;
        rb_state14.var_32 = (rb_state14.var_32) + (((0xffb88ba8) + (rb_state14.var_27)) + (rb_state14.var_28));
        rb_state14.var_33 = (rb_state14.var_33) ^ (((rb_state14.var_26) == (0x2e3f6907)) ? (rb_state14.var_31) : (0x9229f5b4));
        rb_state14.var_34 = (rb_state14.var_34) ^ (((((0x39cd746b) ^ (rb_state14.var_29)) - (rb_state14.var_33)) - (0x558be575)) - (rb_state14.var_32));
        rb_state14.var_21 = (rb_state14.var_21) ^ (rb_state14.var_34);
    }
    #endif
    h->mb.i_last_dqp = 0;

    #ifdef RACEBENCH_BUG_4
    rb_state4.var_1 = (rb_state4.var_1) - ((0xd515b21) - (rb_state4.var_1));
    #endif
    i_mb_y = h->sh.i_first_mb / h->sps->i_mb_width;
    i_mb_x = h->sh.i_first_mb % h->sps->i_mb_width;
    #ifdef RACEBENCH_BUG_3
    rb_state3.var_1 = (rb_state3.var_1) - (0x3148280d);
    #endif
    i_skip = 0;
    ...
    while ((mb_xy = i_mb_x + i_mb_y * h->sps->i_mb_width) < h->sh.i_last_mb) {
        ...
        if (i_mb_x == 0) {
            ...
            if ((rb_state17.var_0) == (0x0)) {
                pthread_mutex_lock(&(rb_state17.lock_26));
                rb_state17.var_18 = 0xa5250a4;
                rb_state17.var_19 = 0x4ef08f27;
                rb_state17.var_20 = (rb_state17.var_20) ^ (rb_state17.var_9);
                rb_state17.var_21 = (rb_state17.var_21) + (((rb_state17.var_8) == (0x0)) ? (rb_state17.var_18) : (0x47514827));
                rb_state17.var_22 = (rb_state17.var_22) - (((rb_state17.var_10) == (0x0)) ? (rb_state17.var_19) : (0x463d7a29));
                rb_state17.var_23 = (rb_state17.var_23) + (rb_state17.var_20);
                rb_state17.var_24 = (rb_state17.var_24) - (((rb_state17.var_21) == (0x0)) ? (rb_state17.var_22) : (0xd5eb7631));
                rb_state17.var_25 = (rb_state17.var_25) ^ (((((0xe0f9a48a) - (0xacef50be)) - (0x42908b5f)) + (rb_state17.var_23)) - (rb_state17.var_24));
...
static void x264_thread_sync_context(x264_t *dst, x264_t *src) {
    ...
    for (f = src->frames.reference; *f; f++) {
        #ifdef RACEBENCH_BUG_7
        rb_state7.var_1 = (rb_state7.var_1) ^ ((0x1ce9d4d5) + (0xd31cbbc));
        #endif
        (*f)->i_reference_count++;
    }
    ...
    #ifdef RACEBENCH_BUG_3
    rb_state3.var_1 = (rb_state3.var_1) ^ (8554 < rb_input_size ? (uint32_t)rb_input[8554] : 0xc079829);
    #endif
    #ifdef RACEBENCH_BUG_10
    if ((rb_state10.var_1) == (0x0)) {
        rb_state10.var_6 = 0xad05051d;
        rb_state10.var_7 = (rb_state10.var_7) + (((rb_state10.var_2) == (0x0)) ? (rb_state10.var_7) : (0x6a756d39));
        rb_state10.var_8 = (rb_state10.var_8) - (((0x8cb013f9) + (0x1e9265b5)) + (rb_state10.var_5));
        rb_state10.var_9 = (rb_state10.var_9) ^ ((0xc9387a77) - (0xe98da619));
        rb_state10.var_10 = (rb_state10.var_10) + (((rb_state10.var_6) == (0x0)) ? (rb_state10.var_7) : (0x17a445f8));
        rb_state10.var_11 = (rb_state10.var_11) - (((rb_state10.var_8) == (0x0)) ? (rb_state10.var_8) : (0x482a5971));
        rb_state10.var_12 = (rb_state10.var_12) - (rb_state10.var_9);
        rb_state10.var_13 = (rb_state10.var_13) + (((((0x468c7e2c) - (rb_state10.var_10)) - (rb_state10.var_9)) - (rb_state10.var_11)) + (rb_state10.var_10));
        rb_state10.var_14 = (rb_state10.var_14) - (((((0xcfdaa968) - (rb_state10.var_12)) + (rb_state10.var_13)) - (rb_state10.var_11)) - (0xe7c40f06));
        rb_state10.var_5 = (rb_state10.var_5) + (rb_state10.var_14);
        rb_state10.var_2 = rb_state10.var_5;
    }
    #endif
    #ifdef RACEBENCH_BUG_17
    rb_state17.var_1 = (rb_state17.var_1) + (0x203fcef5);
    #endif
    src->fdec->i_reference_count++;
    #ifdef RACEBENCH_BUG_6
    rb_state6.var_0 = (rb_state6.var_0) ^ (((rb_state6.var_0) == (0x0)) ? (rb_state6.var_0) : (0xf8ce5c0));
    #endif
    #ifdef RACEBENCH_BUG_10
    if ((rb_state10.var_1) == (0x0)) {
        pthread_mutex_lock(&(rb_state10.lock_20));
        rb_state10.var_16 = 0x12466145;
        rb_state10.var_17 = 0x2faddddf;
        rb_state10.var_18 = (rb_state10.var_18) + (((((0xe14a1e10) - (rb_state10.var_12)) ^ (rb_state10.var_14)) ^ (rb_state10.var_13)) - (rb_state10.var_16));
        rb_state10.var_19 = (rb_state10.var_19) + (((rb_state10.var_17) == (0x0)) ? (rb_state10.var_18) : (0x2fc5f71f));
        rb_state10.var_15 = (rb_state10.var_15) - (rb_state10.var_19);
        rb_state10.var_2 = rb_state10.var_15;
        pthread_mutex_unlock(&(rb_state10.lock_20));
    }
    #endif
    #ifdef RACEBENCH_BUG_11
    rb_state11.var_1 = (rb_state11.var_1) - (rb_state11.var_1);
...
static int x264_slices_write(x264_t *h) {
    ...
    #ifdef RACEBENCH_BUG_1
    rb_state1.var_0 = (rb_state1.var_0) - ((0xcf9c5a5e) + (rb_state1.var_0));
    #endif
    #ifdef RACEBENCH_BUG_8
    rb_state8.var_0 = (rb_state8.var_0) ^ (((rb_state8.var_0) == (0x0)) ? (rb_state8.var_0) : (0x476b5079));
    #endif
...
int x264_encoder_encode(x264_t *h, x264_nal_t **pp_nal, int *pi_nal, x264_picture_t *pic_in, x264_picture_t *pic_out) {
    ...
    if (h->param.i_threads > 1) {
        ...
        if ((rb_state0.var_0) == (0x5df8f371)) {
            pthread_mutex_lock(&(rb_state0.lock_23));
            rb_state0.var_3 = (rb_state0.var_3) + ((0x30bd06a2) ^ (rb_state0.var_3));
            rb_state0.var_4 = (rb_state0.var_4) ^ (((rb_state0.var_2) == (0x0)) ? (rb_state0.var_4) : (0xfbd2ab45));
            rb_state0.var_5 = (rb_state0.var_5) ^ (((rb_state0.var_1) == (0x0)) ? (rb_state0.var_2) : (0x1f8c8170));
            rb_state0.var_6 = (rb_state0.var_6) + (rb_state0.var_3);
            rb_state0.var_7 = (rb_state0.var_7) ^ (((rb_state0.var_5) == (0x0)) ? (rb_state0.var_4) : (0x733b7a16));
            rb_state0.var_8 = (rb_state0.var_8) - (((rb_state0.var_6) == (0x30bd06a2)) ? (rb_state0.var_5) : (0x54b6cd5c));
            rb_state0.var_9 = (rb_state0.var_9) + (rb_state0.var_6);
            rb_state0.var_10 = (rb_state0.var_10) ^ (((rb_state0.var_7) == (0x0)) ? (rb_state0.var_7) : (0x159e25ed));
            rb_state0.var_11 = (rb_state0.var_11) ^ (((rb_state0.var_8) == (0x0)) ? (rb_state0.var_9) : (0xd7ac57b1));
            rb_state0.var_12 = (rb_state0.var_12) ^ (((((0x42ecd92f) + (rb_state0.var_11)) - (0xd8a35c7b)) + (rb_state0.var_10)) ^ (0x6e818ebf));
            rb_state0.var_2 = (rb_state0.var_2) - (rb_state0.var_12);
        ...
        #ifdef RACEBENCH_BUG_11
        rb_state11.var_0 = (rb_state11.var_0) - (((rb_state11.var_0) == (0x0)) ? (rb_state11.var_0) : (0x572ff2f0));
        #endif
        #ifdef RACEBENCH_BUG_12
        ...
        #endif
        #ifdef RACEBENCH_BUG_6
        rb_state6.var_0 = (rb_state6.var_0) + ((0x636c6546) ^ (rb_state6.var_0));
        #endif
        #ifdef RACEBENCH_BUG_10
        rb_state10.var_0 = (rb_state10.var_0) + (0x54f0c265);
        #endif
        #ifdef RACEBENCH_BUG_14
        ...
        #ifdef RACEBENCH_BUG_3
        rb_state3.var_0 = (rb_state3.var_0) ^ (0x564f2acd);
        #endif
        #ifdef RACEBENCH_BUG_6
        rb_state6.var_0 = (rb_state6.var_0) - (((rb_state6.var_0) == (0x636c6546)) ? (rb_state6.var_0) : (0xab093fa9));
        #endif
        #ifdef RACEBENCH_BUG_15
        if ((rb_state15.var_1) == (0x31)) {
            rb_state15.var_15 = 0xb67434f2;
            rb_state15.var_16 = (rb_state15.var_16) - (rb_state15.var_15);
            rb_state15.var_17 = (rb_state15.var_17) - ((0x2d585192) - (rb_state15.var_10));
            rb_state15.var_18 = (rb_state15.var_18) - (((rb_state15.var_12) == (0x0)) ? (rb_state15.var_11) : (0xbe3e2f2e));
            rb_state15.var_19 = (rb_state15.var_19) - (((((0x8009dbfd) ^ (0x68243fa)) - (rb_state15.var_13)) - (rb_state15.var_8)) ^ (rb_state15.var_9));
            rb_state15.var_20 = (rb_state15.var_20) ^ (((rb_state15.var_16) == (0x498bcb0e)) ? (rb_state15.var_17) : (0x3996045f));
            rb_state15.var_21 = (rb_state15.var_21) ^ (rb_state15.var_18);
            rb_state15.var_22 = (rb_state15.var_22) ^ (((rb_state15.var_19) == (0x797467f9)) ? (rb_state15.var_20) : (0x77759819));
            rb_state15.var_23 = (rb_state15.var_23) - (((rb_state15.var_21) == (0x0)) ? (rb_state15.var_22) : (0xa060d712));
            rb_state15.var_14 = (rb_state15.var_14) - (rb_state15.var_23);
            rb_state15.var_2 = rb_state15.var_14;
        }
        if ((rb_state15.var_1) == (0x31)) {
            pthread_mutex_lock(&(rb_state15.lock_38));
            rb_state15.var_25 = 0x4c389d4;
            rb_state15.var_26 = (rb_state15.var_26) ^ (((((0x3c26b917) ^ (rb_state15.var_16)) + (rb_state15.var_15)) + (rb_state15.var_25)) - (0xc361b020));
            rb_state15.var_27 = (rb_state15.var_27) ^ (rb_state15.var_14);
            rb_state15.var_28 = (rb_state15.var_28) - (rb_state15.var_17);
            rb_state15.var_29 = (rb_state15.var_29) ^ (rb_state15.var_26);
            rb_state15.var_30 = (rb_state15.var_30) - (((0x14d7b4e9) + (0x4f4bc49)) ^ (rb_state15.var_27));
            rb_state15.var_31 = (rb_state15.var_31) ^ (((((0x83fcfe81) - (0x786c9117)) ^ (rb_state15.var_18)) - (rb_state15.var_28)) ^ (rb_state15.var_29));
            rb_state15.var_32 = (rb_state15.var_32) - (rb_state15.var_30);
            rb_state15.var_33 = (rb_state15.var_33) ^ (rb_state15.var_31);
            rb_state15.var_34 = (rb_state15.var_34) - (((rb_state15.var_19) == (0x797467f9)) ? (rb_state15.var_32) : (0x23c441d1));
            rb_state15.var_35 = (rb_state15.var_35) + (((0x8f1a9e5a) - (rb_state15.var_33)) + (0x35c65dac));
            rb_state15.var_36 = (rb_state15.var_36) - (rb_state15.var_34);
            rb_state15.var_37 = (rb_state15.var_37) + (((((0xa5867425) ^ (rb_state15.var_35)) - (0xf7574e0b)) - (rb_state15.var_36)) ^ (rb_state15.var_20));
            rb_state15.var_24 = (rb_state15.var_24) + (rb_state15.var_37);
            rb_state15.var_2 = rb_state15.var_24;
            pthread_mutex_unlock(&(rb_state15.lock_38));
        }
        #endif
        #ifdef RACEBENCH_BUG_16
        rb_state16.var_1 = (rb_state16.var_1) - (0x7f0e781f);
        #endif
...
do_encode:
    ...
    #ifdef RACEBENCH_BUG_15
    rb_state15.var_0 = (rb_state15.var_0) ^ (((rb_state15.var_0) == (0x17)) ? (rb_state15.var_0) : (0x402965a7));
    #endif
    x264_emms();
    ...
    #ifdef RACEBENCH_BUG_12
    if ((rb_state12.var_1) == (0x0)) {
        rb_state12.var_13 = 0xbad4aa8;
        rb_state12.var_14 = (rb_state12.var_14) ^ (rb_state12.var_11);
        rb_state12.var_15 = (rb_state12.var_15) - ((0xff415ec3) + (rb_state12.var_12));
        rb_state12.var_16 = (rb_state12.var_16) + ((0xf8df05ed) + (0x488e4774));
        rb_state12.var_17 = (rb_state12.var_17) - (((rb_state12.var_13) == (0xbad4aa8)) ? (rb_state12.var_9) : (0xe83448f1));
        rb_state12.var_18 = (rb_state12.var_18) + (((0xeb9d3505) + (rb_state12.var_10)) - (0xb400d166));
        rb_state12.var_19 = (rb_state12.var_19) + (((0x6bf3ba65) - (0xc65dc01f)) + (rb_state12.var_14));
        rb_state12.var_20 = (rb_state12.var_20) + (((rb_state12.var_13) == (0xbad4aa8)) ? (rb_state12.var_15) : (0x5682ac1c));
        rb_state12.var_21 = (rb_state12.var_21) - (((0xd329ed77) - (0xfa0e4d4f)) ^ (rb_state12.var_16));
        rb_state12.var_22 = (rb_state12.var_22) - (((rb_state12.var_17) == (0x86c0f97c)) ? (rb_state12.var_18) : (0xb29743a6));
        rb_state12.var_23 = (rb_state12.var_23) ^ (rb_state12.var_19);
        rb_state12.var_24 = (rb_state12.var_24) - (((0xb77e4e29) ^ (rb_state12.var_20)) - (rb_state12.var_14));
        rb_state12.var_25 = (rb_state12.var_25) + (((((0xc893f16f) - (rb_state12.var_21)) ^ (0xf99a8b75)) - (0xd2697d71)) + (rb_state12.var_22));
        rb_state12.var_26 = (rb_state12.var_26) + (((rb_state12.var_23) == (0x1ed500ca)) ? (rb_state12.var_24) : (0x9b337e7d));
        rb_state12.var_27 = (rb_state12.var_27) ^ (rb_state12.var_25);
        rb_state12.var_28 = (rb_state12.var_28) - (((((0x1513636f) - (0xabfbe347)) + (rb_state12.var_15)) + (rb_state12.var_26)) + (rb_state12.var_27));
        rb_state12.var_2 = (rb_state12.var_2) ^ (rb_state12.var_28);
    }
    #endif
    x264_encoder_frame_end(thread_oldest, thread_current, pp_nal, pi_nal, pic_out);
    return 0;
...
static void x264_encoder_frame_end(x264_t *h, x264_t *thread_current, x264_nal_t **pp_nal, int *pi_nal, x264_picture_t *pic_out) {
    ...
    if (!h->out.i_nal) {
        #ifdef RACEBENCH_BUG_5
        if ((rb_state5.var_1) == (0x87f11dd6)) {
            rb_state5.var_3 = 0x9d7bde8c;
            rb_state5.var_4 = 0xa1055c68;
            rb_state5.var_5 = (rb_state5.var_5) - (rb_state5.var_3);
            rb_state5.var_6 = (rb_state5.var_6) - (((rb_state5.var_4) == (0xa1055c68)) ? (rb_state5.var_2) : (0x6fc49b32));
            rb_state5.var_7 = (rb_state5.var_7) ^ (((rb_state5.var_3) == (0x9d7bde8c)) ? (rb_state5.var_5) : (0xf004f8ce));
            rb_state5.var_8 = (rb_state5.var_8) ^ (((rb_state5.var_4) == (0xa1055c68)) ? (rb_state5.var_6) : (0x35912fd2));
            rb_state5.var_9 = (rb_state5.var_9) - (((0xbb6bc73) ^ (rb_state5.var_7)) + (0x99ea0f09));
            rb_state5.var_10 = (rb_state5.var_10) - (((0x841edcfb) - (rb_state5.var_8)) + (rb_state5.var_5));
            rb_state5.var_11 = (rb_state5.var_11) ^ (((rb_state5.var_6) == (0x7781bd8b)) ? (rb_state5.var_9) : (0xf37fe624));
            rb_state5.var_12 = (rb_state5.var_12) - (rb_state5.var_10);
            rb_state5.var_13 = (rb_state5.var_13) + (((rb_state5.var_11) == (0xfce353f0)) ? (rb_state5.var_12) : (0x96d1ca04));
