...
static int DumpModeEncode(tif, pp, cc, s) register TIFF *tif;
u_char *pp;
int cc;
u_int s;
{
...
static int DumpModeDecode(tif, buf, cc, s) register TIFF *tif;
u_char *buf;
int cc;
u_int s;
{
...
static int DumpModeSeek(tif, nrows) register TIFF *tif;
int nrows;
{
