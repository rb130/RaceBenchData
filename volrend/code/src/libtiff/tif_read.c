...
static int TIFFReadRawStrip1(tif, strip, buf, size, module) TIFF *tif;
u_int strip;
u_char *buf;
u_int size;
char module[];
...
static int TIFFReadRawTile1(tif, tile, buf, size, module) TIFF *tif;
u_int tile;
u_char *buf;
u_int size;
char module[];
...
int TIFFReadBufferSetup(tif, bp, size) TIFF *tif;
char *bp;
u_int size;
{
