...
static int PackBitsPreEncode(tif) TIFF *tif;
{
...
static int PackBitsEncodeChunk(tif, bp, cc, s) TIFF *tif;
u_char *bp;
int cc;
u_int s;
{
...
static int PackBitsEncode(tif, bp, cc, s) TIFF *tif;
u_char *bp;
register int cc;
u_int s;
{
...
static int PackBitsDecode(tif, op, occ, s) TIFF *tif;
register u_char *op;
register int occ;
u_int s;
{
