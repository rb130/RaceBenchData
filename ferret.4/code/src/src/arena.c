...
MemArena *mkmemarena(void *(*memalloc)(size_t), void *(*memrealloc)(void *, size_t), void (*memfree)(void *), unsigned long n) {
    MemArena *a;
...
void *memarenamalloc(MemArena *a, unsigned long n) {
    uchar *b, *p;
    uchar **tab;
