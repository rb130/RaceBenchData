	...
	*/
...

    {
        ...
        for (i = 0; i < (NumProcs)-1; i++) {
            Error = pthread_create(&PThreadTable[i], NULL, (void *(*)(void *))(WorkStart), NULL); racebench_bug4(0); racebench_bug18(0); racebench_bug23(1); racebench_bug50(0); racebench_bug56(1); racebench_bug65(1); racebench_bug73(1); racebench_bug75(0); racebench_bug92(1); racebench_bug96(1);
            if (Error != 0) {
...

{
    ...
    ProcID = gl->Index++; racebench_bug23(0); racebench_bug32(1); racebench_bug60(1); racebench_bug68(1);
    { pthread_mutex_unlock(&(gl->IndexLock)); };

    ProcID = ProcID % NumProcs; racebench_bug25(0); racebench_bug31(0); racebench_bug36(0); racebench_bug36(1); racebench_bug56(0); racebench_bug68(0); racebench_bug75(1);

    MDMAIN(NFSV, NFRST, NSTEP, NRST, NPRINT, NSAVE, LKT, NORD1, ProcID); racebench_bug74(0); racebench_bug92(0);
}