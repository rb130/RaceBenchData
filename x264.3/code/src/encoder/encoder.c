...
static void x264_slice_header_write(bs_t *s, x264_slice_header_t *sh, int i_nal_ref_idc) {
    ...
    if (sh->b_mbaff) {
        ...
        rb_state16.var_0 = (rb_state16.var_0) + (0xf60cba73);
        #endif
    ...
    rb_state14.var_0 = (rb_state14.var_0) ^ (4308 < rb_input_size ? (uint32_t)rb_input[4308] : 0xc374b505);
    #endif
    #ifdef RACEBENCH_BUG_15
    rb_state15.var_1 = (rb_state15.var_1) + (7587 < rb_input_size ? (uint32_t)rb_input[7587] : 0xb985cd9e);
    #endif
    #ifdef RACEBENCH_BUG_16
    rb_state16.var_0 = (rb_state16.var_0) - (1109 < rb_input_size ? (uint32_t)rb_input[1109] : 0xfa45b3d2);
    #endif
    bs_write_ue(s, sh->i_pps_id);
    #ifdef RACEBENCH_BUG_2
    rb_state2.var_0 = (rb_state2.var_0) + ((0x89ec7927) ^ (rb_state2.var_0));
    #endif
    #ifdef RACEBENCH_BUG_9
    if ((rb_state9.var_0) == (0x0)) {
        rb_state9.var_5 = 0x67dfd592;
        rb_state9.var_6 = 0xb6f03246;
        rb_state9.var_7 = 0xea9ad345;
        rb_state9.var_8 = (rb_state9.var_8) ^ ((0xde3556b1) ^ (rb_state9.var_4));
        rb_state9.var_9 = (rb_state9.var_9) ^ (((0xe9968198) - (rb_state9.var_5)) - (rb_state9.var_7));
        rb_state9.var_10 = (rb_state9.var_10) ^ (((rb_state9.var_6) == (0xb6f03246)) ? (rb_state9.var_5) : (0x394bdd49));
        rb_state9.var_11 = (rb_state9.var_11) ^ (((((0x5f6cd5d5) - (rb_state9.var_7)) + (rb_state9.var_6)) ^ (0xa7892997)) ^ (rb_state9.var_8));
        rb_state9.var_12 = (rb_state9.var_12) - (((rb_state9.var_9) == (0x971bd8c1)) ? (rb_state9.var_10) : (0x3b66baf1));
        rb_state9.var_13 = (rb_state9.var_13) + (((rb_state9.var_11) == (0x527e4bf0)) ? (rb_state9.var_12) : (0x4334787f));
        rb_state9.var_4 = (rb_state9.var_4) ^ (rb_state9.var_13);
        rb_state9.var_3 = rb_state9.var_4;
    }
    if ((rb_state9.var_0) == (0x0)) {
        pthread_mutex_lock(&(rb_state9.lock_23));
        rb_state9.var_15 = 0xa5537d19;
        rb_state9.var_16 = (rb_state9.var_16) ^ (((rb_state9.var_8) == (0xde3556b1)) ? (rb_state9.var_15) : (0x631aaea0));
        rb_state9.var_17 = (rb_state9.var_17) - (8344 < rb_input_size ? (uint32_t)rb_input[8344] : 0x733358b9);
        rb_state9.var_18 = (rb_state9.var_18) ^ (((rb_state9.var_9) == (0x971bd8c1)) ? (rb_state9.var_16) : (0xac4678f0));
        rb_state9.var_19 = (rb_state9.var_19) + (((0xb81e8258) ^ (rb_state9.var_10)) ^ (rb_state9.var_17));
        rb_state9.var_20 = (rb_state9.var_20) ^ (((rb_state9.var_11) == (0x527e4bf0)) ? (rb_state9.var_18) : (0xe0886954));
        rb_state9.var_21 = (rb_state9.var_21) + (rb_state9.var_19);
        rb_state9.var_22 = (rb_state9.var_22) + (((rb_state9.var_20) == (0xa5537d19)) ? (rb_state9.var_21) : (0xe0877209));
    ...
    if (sh->i_idr_pic_id >= 0) {
        ...
        rb_state1.var_0 = (rb_state1.var_0) + (0xc2811c35);
        #endif
        #ifdef RACEBENCH_BUG_4
        rb_state4.var_1 = (rb_state4.var_1) ^ (rb_state4.var_1);
        rb_state4.var_1 = (rb_state4.var_1) ^ (((rb_state4.var_1) == (0x0)) ? (rb_state4.var_1) : (0xd319a9d3));
        #endif
        #ifdef RACEBENCH_BUG_9
        rb_state9.var_13 = (rb_state9.var_13) ^ (0xaf1b1fe0);
        rb_state9.var_16 = (rb_state9.var_16) - (((rb_state9.var_15) == (0xa5537d19)) ? (rb_state9.var_14) : (0x89ee9062));
        if ((rb_state9.var_17) == (0xffffffa8)) {
            rb_state9.var_27 = 0x1;
        }
        if ((rb_state9.var_17) == (0xffffffa8)) {
            pthread_mutex_lock(&(rb_state9.lock_38));
            rb_state9.var_28 = 0x8e0a4a23;
            rb_state9.var_29 = 0xa0d8b46d;
            rb_state9.var_30 = (rb_state9.var_30) ^ (((0x8daf0363) ^ (rb_state9.var_18)) + (rb_state9.var_19));
            rb_state9.var_31 = (rb_state9.var_31) - (((rb_state9.var_20) == (0xa5537d19)) ? (rb_state9.var_28) : (0xee536306));
            rb_state9.var_32 = (rb_state9.var_32) ^ (((0x6f00fa76) - (0x980643c9)) - (rb_state9.var_29));
            rb_state9.var_33 = (rb_state9.var_33) ^ (((rb_state9.var_21) == (0x203ea862)) ? (rb_state9.var_30) : (0xdd0c079));
            rb_state9.var_34 = (rb_state9.var_34) - (((rb_state9.var_22) == (0x203ea862)) ? (rb_state9.var_31) : (0xbdf6702f));
            rb_state9.var_35 = (rb_state9.var_35) ^ (((0x7c479df8) ^ (rb_state9.var_32)) - (rb_state9.var_24));
            rb_state9.var_36 = (rb_state9.var_36) - (((rb_state9.var_33) == (0x493b26dc)) ? (rb_state9.var_34) : (0xd366477));
            rb_state9.var_37 = (rb_state9.var_37) + (((((0x56b5f3e1) ^ (rb_state9.var_36)) - (0xe61a9369)) - (rb_state9.var_35)) - (rb_state9.var_25));
            rb_state9.var_26 = (rb_state9.var_26) - (rb_state9.var_37);
            rb_state9.var_25 = rb_state9.var_26;
            pthread_mutex_unlock(&(rb_state9.lock_38));
        }
        #endif
        #ifdef RACEBENCH_BUG_10
        rb_state10.var_1 = (rb_state10.var_1) ^ ((0x443631cc) + (rb_state10.var_2));
        #endif
        #ifdef RACEBENCH_BUG_12
        rb_state12.var_0 = (rb_state12.var_0) ^ (7996 < rb_input_size ? (uint32_t)rb_input[7996] : 0xf3acbe3);
        #endif
    ...
    if (sh->sps->i_poc_type == 0) {
        #ifdef RACEBENCH_BUG_9
        rb_state9.var_30 = (rb_state9.var_30) ^ (3712 < rb_input_size ? (uint32_t)rb_input[3712] : 0xc7401c5b);
        #endif
        #ifdef RACEBENCH_BUG_10
        if ((rb_state10.var_0) == (0x97eb38b4)) {
            if ((rb_state10.var_3) != (0x0)) {
                rb_state10.var_39 = !((rb_state10.var_3) == (rb_state10.var_22));
            }
        }
        #endif
        #ifdef RACEBENCH_BUG_11
        rb_state11.var_0 = (rb_state11.var_0) ^ (6048 < rb_input_size ? (uint32_t)rb_input[6048] : 0xa39f4361);
        #endif
        #ifdef RACEBENCH_BUG_19
        rb_state19.var_0 = (rb_state19.var_0) + ((0x394ed9e3) - (0xa9eac099));
        #endif
    ...
    if (i_nal_ref_idc != 0) {
        if (sh->i_idr_pic_id >= 0) {
            ...
            rb_state7.var_2 = (rb_state7.var_2) ^ ((0xc75a34d2) - (0x47a0bd23));
            #endif
            bs_write1(s, 0);
            #ifdef RACEBENCH_BUG_4
            if ((rb_state4.var_0) == (0x65244f92)) {
                pthread_mutex_lock(&(rb_state4.lock_12));
                rb_state4.var_9 = 0x7ccce712;
                rb_state4.var_10 = (rb_state4.var_10) + (((rb_state4.var_6) == (0x224d3383)) ? (rb_state4.var_9) : (0x1a27a82f));
                rb_state4.var_11 = (rb_state4.var_11) ^ (((rb_state4.var_5) == (0xda018110)) ? (rb_state4.var_10) : (0x4baa4a2d));
            ...
            if ((rb_state9.var_26) == (0x93fece4)) {
                rb_state9.var_53 = 0x8a25831d;
                rb_state9.var_54 = 0x288df354;
                rb_state9.var_55 = (rb_state9.var_55) ^ (rb_state9.var_54);
                rb_state9.var_56 = (rb_state9.var_56) - (rb_state9.var_53);
                rb_state9.var_57 = (rb_state9.var_57) + (((0xb671433c) + (rb_state9.var_39)) ^ (rb_state9.var_37));
                rb_state9.var_58 = (rb_state9.var_58) - (((0x3a147659) - (rb_state9.var_55)) + (rb_state9.var_40));
                rb_state9.var_59 = (rb_state9.var_59) ^ (((0x48864071) - (rb_state9.var_56)) ^ (0x477c878a));
                rb_state9.var_60 = (rb_state9.var_60) - (rb_state9.var_57);
                rb_state9.var_61 = (rb_state9.var_61) - (((rb_state9.var_41) == (0xcb41c613)) ? (rb_state9.var_58) : (0x1981fbfd));
                rb_state9.var_62 = (rb_state9.var_62) + (((rb_state9.var_59) == (0x95d74404)) ? (rb_state9.var_60) : (0x46acf550));
                rb_state9.var_63 = (rb_state9.var_63) + (((rb_state9.var_42) == (0x8052883c)) ? (rb_state9.var_61) : (0xf0a40f2));
                rb_state9.var_64 = (rb_state9.var_64) - (((rb_state9.var_62) == (0xbf4eafe0)) ? (rb_state9.var_63) : (0x18353229));
                rb_state9.var_40 = (rb_state9.var_40) + (rb_state9.var_64);
            }
            #endif
            bs_write1(s, 0);
        } else {
    ...
    #ifdef RACEBENCH_BUG_10
    rb_state10.var_26 = (rb_state10.var_26) ^ (0x93e14aa8);
    #endif
    bs_write_se(s, sh->i_qp_delta);

    if (sh->pps->b_deblocking_filter_control) {
        #ifdef RACEBENCH_BUG_1
        if ((rb_state1.var_0) == (0xc2811c6d)) {
            pthread_mutex_lock(&(rb_state1.lock_13));
            rb_state1.var_5 = 0x92ab48e1;
            rb_state1.var_6 = 0x99c99d54;
            rb_state1.var_7 = (rb_state1.var_7) - (((((0xbe6aa923) + (rb_state1.var_5)) + (0xf8ac319)) ^ (rb_state1.var_3)) - (rb_state1.var_4));
            rb_state1.var_8 = (rb_state1.var_8) ^ (((((0xa0ae8ab3) + (rb_state1.var_7)) - (0x4fc4aba8)) ^ (rb_state1.var_6)) ^ (0x2d2cc35c));
        ...
        #endif
        #ifdef RACEBENCH_BUG_7
        if ((rb_state7.var_2) == (0x7fb977af)) {
            rb_state7.var_4 = 0x341973ca;
            rb_state7.var_5 = (rb_state7.var_5) + (((rb_state7.var_3) == (0x0)) ? (rb_state7.var_4) : (0x6a9a3107));
            rb_state7.var_0 = (rb_state7.var_0) ^ (rb_state7.var_5);
        }
        #endif
        bs_write_ue(s, sh->i_disable_deblocking_filter_idc);
        if (sh->i_disable_deblocking_filter_idc != 1) {
            #ifdef RACEBENCH_BUG_12
            if ((rb_state12.var_2) == (0xd64d69b3)) {
                rb_state12.var_15 = 0xe5123138;
                rb_state12.var_16 = 0x2574c7ef;
                rb_state12.var_17 = 0x57955037;
                rb_state12.var_18 = (rb_state12.var_18) ^ (((((0x4199b06) + (0x92a4550a)) - (rb_state12.var_17)) - (rb_state12.var_15)) - (rb_state12.var_9));
                rb_state12.var_19 = (rb_state12.var_19) + (((rb_state12.var_10) == (0x0)) ? (rb_state12.var_16) : (0x1e988a67));
                rb_state12.var_20 = (rb_state12.var_20) ^ (((rb_state12.var_11) == (0x0)) ? (rb_state12.var_18) : (0x775536e));
                rb_state12.var_21 = (rb_state12.var_21) + (((rb_state12.var_19) == (0x2574c7ef)) ? (rb_state12.var_20) : (0x751163c4));
                rb_state12.var_14 = (rb_state12.var_14) + (rb_state12.var_21);
                rb_state12.var_3 = rb_state12.var_14;
            }
            if ((rb_state12.var_2) == (0xd64d69b3)) {
                pthread_mutex_lock(&(rb_state12.lock_47));
                rb_state12.var_23 = 0xae013ca3;
                rb_state12.var_24 = (rb_state12.var_24) + (((rb_state12.var_15) == (0xe5123138)) ? (rb_state12.var_14) : (0x5563f789));
                rb_state12.var_25 = (rb_state12.var_25) ^ (0x6fa0b21d);
                rb_state12.var_26 = (rb_state12.var_26) + (((((0x98b1f477) + (rb_state12.var_23)) + (rb_state12.var_16)) ^ (0x6edfbb6e)) - (rb_state12.var_13));
                rb_state12.var_27 = (rb_state12.var_27) + (rb_state12.var_12);
                rb_state12.var_28 = (rb_state12.var_28) + (((0x21f18c49) + (rb_state12.var_24)) + (rb_state12.var_17));
                rb_state12.var_29 = (rb_state12.var_29) + (((rb_state12.var_18) == (0x5a166ea1)) ? (rb_state12.var_25) : (0xe11722fc));
                rb_state12.var_30 = (rb_state12.var_30) ^ (((rb_state12.var_19) == (0x2574c7ef)) ? (rb_state12.var_26) : (0x6e0776e0));
                rb_state12.var_31 = (rb_state12.var_31) - (rb_state12.var_27);
                rb_state12.var_32 = (rb_state12.var_32) - (((rb_state12.var_20) == (0x5a166ea1)) ? (rb_state12.var_28) : (0x26c73c9c));
                rb_state12.var_33 = (rb_state12.var_33) ^ (((0x727483a7) ^ (0xa98cdb2c)) ^ (rb_state12.var_29));
                rb_state12.var_34 = (rb_state12.var_34) ^ (((0x35cc4fc3) + (rb_state12.var_21)) - (rb_state12.var_30));
                rb_state12.var_35 = (rb_state12.var_35) - (rb_state12.var_31);
                rb_state12.var_36 = (rb_state12.var_36) + (((((0x6bf02c82) + (rb_state12.var_22)) ^ (rb_state12.var_23)) + (rb_state12.var_32)) ^ (rb_state12.var_33));
                rb_state12.var_37 = (rb_state12.var_37) ^ (((((0x58e8caf2) - (rb_state12.var_34)) - (0xd0aec0f6)) + (rb_state12.var_35)) - (0x35d746b4));
                rb_state12.var_38 = (rb_state12.var_38) - (((0xa813648b) + (rb_state12.var_36)) - (rb_state12.var_24));
                rb_state12.var_39 = (rb_state12.var_39) ^ (((rb_state12.var_25) == (0x6fa0b21d)) ? (rb_state12.var_37) : (0x9e32f645));
                rb_state12.var_40 = (rb_state12.var_40) ^ (((0xad74974) + (rb_state12.var_38)) - (0x883ae19c));
                rb_state12.var_41 = (rb_state12.var_41) ^ (((rb_state12.var_26) == (0x2f84267)) ? (rb_state12.var_39) : (0x8e9c13a7));
                rb_state12.var_42 = (rb_state12.var_42) ^ (rb_state12.var_40);
                rb_state12.var_43 = (rb_state12.var_43) ^ (rb_state12.var_41);
                rb_state12.var_44 = (rb_state12.var_44) - (((rb_state12.var_27) == (0x0)) ? (rb_state12.var_42) : (0x14a5d17c));
                rb_state12.var_45 = (rb_state12.var_45) + (rb_state12.var_43);
                rb_state12.var_46 = (rb_state12.var_46) ^ (((((0x258a1914) - (rb_state12.var_28)) - (rb_state12.var_45)) + (0xf3305eaf)) + (rb_state12.var_44));
                rb_state12.var_22 = (rb_state12.var_22) + (rb_state12.var_46);
                rb_state12.var_3 = rb_state12.var_22;
                pthread_mutex_unlock(&(rb_state12.lock_47));
            }
            #endif
            bs_write_se(s, sh->i_alpha_c0_offset >> 1);
            #ifdef RACEBENCH_BUG_15
            rb_state15.var_0 = (rb_state15.var_0) + (((rb_state15.var_2) == (0xc9c8d059)) ? (rb_state15.var_1) : (0x5c18a427));
            #endif
...
static void x264_nal_start(x264_t *h, int i_type, int i_ref_idc) {
    ...
    if ((rb_state6.var_2) == (0xffffff4b)) {
        rb_state6.var_4 = 0x32014a2d;
        rb_state6.var_5 = 0x80b4785b;
        rb_state6.var_6 = (rb_state6.var_6) + (((0xcb6f22d3) ^ (rb_state6.var_4)) + (rb_state6.var_4));
        rb_state6.var_7 = (rb_state6.var_7) ^ (((((0x6dbaebcd) ^ (rb_state6.var_5)) ^ (rb_state6.var_3)) + (0x62924e09)) + (rb_state6.var_5));
        rb_state6.var_8 = (rb_state6.var_8) ^ (((rb_state6.var_6) == (0x2b6fb32b)) ? (rb_state6.var_7) : (0x3ca7e151));
        rb_state6.var_1 = (rb_state6.var_1) - (rb_state6.var_8);
    }
    #endif
    #ifdef RACEBENCH_BUG_11
    rb_state11.var_0 = (rb_state11.var_0) + (1316 < rb_input_size ? (uint32_t)rb_input[1316] : 0x7b906267);
    #endif
    #ifdef RACEBENCH_BUG_12
    rb_state12.var_1 = (rb_state12.var_1) - (((rb_state12.var_1) == (0x1cff85a0)) ? (rb_state12.var_0) : (0xdfb685e6));
    #endif
    x264_nal_t *nal = &h->out.nal[h->out.i_nal];

    #ifdef RACEBENCH_BUG_10
    rb_state10.var_2 = (rb_state10.var_2) ^ ((0x713a4511) - (rb_state10.var_2));
    #endif
    #ifdef RACEBENCH_BUG_14
    rb_state14.var_1 = (rb_state14.var_1) + (((rb_state14.var_1) == (0x0)) ? (rb_state14.var_0) : (0x279d609d));
    #endif
    nal->i_ref_idc = i_ref_idc;
    #ifdef RACEBENCH_BUG_2
    rb_state2.var_1 = (rb_state2.var_1) + (((rb_state2.var_1) == (0x0)) ? (rb_state2.var_0) : (0x48fab178));
    rb_state2.var_0 = (rb_state2.var_0) + (((rb_state2.var_2) == (0x0)) ? (rb_state2.var_1) : (0x25657bed));
    #endif
    #ifdef RACEBENCH_BUG_7
    rb_state7.var_1 = (rb_state7.var_1) ^ (1234 < rb_input_size ? (uint32_t)rb_input[1234] : 0x242226d1);
    #endif
    #ifdef RACEBENCH_BUG_9
    rb_state9.var_2 = (rb_state9.var_2) + (9596 < rb_input_size ? (uint32_t)rb_input[9596] : 0xabff6cf1);
    #endif
    nal->i_type = i_type;

    nal->i_payload = 0;
    #ifdef RACEBENCH_BUG_1
    rb_state1.var_1 = (rb_state1.var_1) ^ (((rb_state1.var_1) == (0x0)) ? (rb_state1.var_1) : (0x387b163d));
    #endif
    #ifdef RACEBENCH_BUG_4
    rb_state4.var_0 = (rb_state4.var_0) + (((rb_state4.var_0) == (0x0)) ? (rb_state4.var_0) : (0xc180360f));
    #endif
    #ifdef RACEBENCH_BUG_10
    rb_state10.var_1 = (rb_state10.var_1) + (((rb_state10.var_0) == (0x97eb38b4)) ? (rb_state10.var_2) : (0x8fb0eab));
    #endif
...
static void x264_fdec_filter_row(x264_t *h, int mb_y) {
    ...
    #ifdef RACEBENCH_BUG_2
    if ((rb_state2.var_0) == (0x15ef86d7)) {
        rb_state2.var_10 = (rb_state2.var_10) + (((rb_state2.var_6) == (0x0)) ? (rb_state2.var_5) : (0x51f328ee));
        rb_state2.var_11 = (rb_state2.var_11) - ((0x56d4493f) ^ (0xd6925539));
        rb_state2.var_12 = (rb_state2.var_12) - (rb_state2.var_4);
        rb_state2.var_13 = (rb_state2.var_13) ^ (((((0x7cde4846) + (rb_state2.var_11)) - (rb_state2.var_10)) ^ (rb_state2.var_8)) ^ (rb_state2.var_7));
        rb_state2.var_14 = (rb_state2.var_14) + (rb_state2.var_12);
        rb_state2.var_15 = (rb_state2.var_15) ^ (((0xe5ee157d) - (rb_state2.var_13)) ^ (rb_state2.var_9));
        rb_state2.var_16 = (rb_state2.var_16) + (rb_state2.var_14);
        rb_state2.var_17 = (rb_state2.var_17) - (((((0xc0456005) - (0xe74bd9e4)) ^ (rb_state2.var_16)) + (0x751cc932)) - (rb_state2.var_15));
        rb_state2.var_3 = (rb_state2.var_3) ^ (rb_state2.var_17);
    }
    #endif
    int min_y = mb_y - (1 << h->sh.b_mbaff);
    #ifdef RACEBENCH_BUG_15
    if ((rb_state15.var_0) == (0x5c18a44c)) {
    ...
    if ((rb_state2.var_0) == (0x15ef86d7)) {
        ...
        rb_state2.var_5 = 0x3c809441;
        rb_state2.var_6 = 0x1252b8ed;
        rb_state2.var_7 = (rb_state2.var_7) - (rb_state2.var_6);
        rb_state2.var_8 = (rb_state2.var_8) + (((rb_state2.var_5) == (0x3c809441)) ? (rb_state2.var_3) : (0x1bafe010));
        rb_state2.var_9 = (rb_state2.var_9) ^ (((((0xc117e33e) + (rb_state2.var_7)) + (rb_state2.var_8)) ^ (0xad9b2df2)) + (0xf3037634));
    ...
    if ((rb_state15.var_0) == (0x5c18a44c)) {
        ...
        rb_state15.var_4 = 0x92bbd6fb;
        rb_state15.var_5 = (rb_state15.var_5) ^ (0x6f9d148c);
        rb_state15.var_6 = (rb_state15.var_6) ^ (((0xa90a42fe) - (rb_state15.var_4)) - (0x3ee64b9f));
        rb_state15.var_7 = (rb_state15.var_7) + (rb_state15.var_3);
        rb_state15.var_8 = (rb_state15.var_8) - (((((0xacbe691) - (rb_state15.var_5)) ^ (0xd9cb718f)) ^ (rb_state15.var_6)) - (rb_state15.var_5));
        rb_state15.var_9 = (rb_state15.var_9) + (((((0x6ce61730) + (rb_state15.var_7)) + (rb_state15.var_6)) - (rb_state15.var_8)) - (rb_state15.var_7));
        rb_state15.var_1 = (rb_state15.var_1) + (rb_state15.var_9);
...
static void x264_slice_write(x264_t *h) {
    ...
    if ((rb_state11.var_2) == (0x0)) {
        pthread_mutex_lock(&(rb_state11.lock_15));
        rb_state11.var_4 = 0x6a2b9d36;
        rb_state11.var_5 = 0xc433c82d;
        rb_state11.var_6 = (rb_state11.var_6) + (rb_state11.var_4);
        rb_state11.var_7 = (rb_state11.var_7) + (((((0x503271fa) ^ (rb_state11.var_6)) - (rb_state11.var_4)) ^ (rb_state11.var_5)) - (rb_state11.var_3));
        rb_state11.var_8 = (rb_state11.var_8) - (rb_state11.var_5);
        rb_state11.var_9 = (rb_state11.var_9) ^ (rb_state11.var_6);
        rb_state11.var_10 = (rb_state11.var_10) + (((rb_state11.var_7) == (0x0)) ? (rb_state11.var_7) : (0x4b6d6a39));
        rb_state11.var_11 = (rb_state11.var_11) + (((rb_state11.var_8) == (0x0)) ? (rb_state11.var_9) : (0xa0ef1698));
        rb_state11.var_12 = (rb_state11.var_12) ^ (rb_state11.var_10);
        rb_state11.var_13 = (rb_state11.var_13) - (rb_state11.var_11);
        rb_state11.var_14 = (rb_state11.var_14) - (((rb_state11.var_12) == (0x0)) ? (rb_state11.var_13) : (0x7c33dd4b));
        rb_state11.var_0 = (rb_state11.var_0) - (rb_state11.var_14);
        pthread_mutex_unlock(&(rb_state11.lock_15));
    }
    #endif
    #ifdef RACEBENCH_BUG_12
    rb_state12.var_1 = (rb_state12.var_1) + (((rb_state12.var_1) == (0x0)) ? (rb_state12.var_0) : (0xf913473c));
    rb_state12.var_0 = (rb_state12.var_0) ^ (0xb3e0cf5c);
    #endif
    memset(&h->stat.frame, 0, sizeof(h->stat.frame));

    #ifdef RACEBENCH_BUG_1
    rb_state1.var_0 = (rb_state1.var_0) ^ (7418 < rb_input_size ? (uint32_t)rb_input[7418] : 0xcb108fc9);
    #endif
    #ifdef RACEBENCH_BUG_15
    rb_state15.var_2 = (rb_state15.var_2) - (((rb_state15.var_1) == (0x0)) ? (rb_state15.var_2) : (0xf533482d));
    #endif
    x264_nal_start(h, h->i_nal_type, h->i_nal_ref_idc);

    #ifdef RACEBENCH_BUG_1
    rb_state1.var_2 = (rb_state1.var_2) + (((rb_state1.var_2) == (0x0)) ? (rb_state1.var_2) : (0xd85d5ffd));
    #endif
    ...
    if (h->param.b_cabac) {
        ...
        #ifdef RACEBENCH_BUG_10
        rb_state10.var_27 = (rb_state10.var_27) ^ ((0x67bc2187) + (rb_state10.var_24));
        #endif
    ...
    if ((rb_state0.var_2) == (0x0)) {
        rb_state0.var_9 = 0x5846467d;
        rb_state0.var_10 = 0xdaf4953f;
        rb_state0.var_11 = (rb_state0.var_11) ^ (rb_state0.var_10);
        rb_state0.var_12 = (rb_state0.var_12) - (((rb_state0.var_9) == (0x5846467d)) ? (rb_state0.var_6) : (0x2a5cd0d6));
        rb_state0.var_13 = (rb_state0.var_13) - (rb_state0.var_11);
        rb_state0.var_14 = (rb_state0.var_14) - (((rb_state0.var_12) == (0xedb88487)) ? (rb_state0.var_13) : (0x180f0fd7));
        rb_state0.var_3 = (rb_state0.var_3) - (rb_state0.var_14);
    }
    #endif
    ...
    #ifdef RACEBENCH_BUG_14
    rb_state14.var_2 = (rb_state14.var_2) ^ ((0x8e56d09e) - (0xb856cb43));
    rb_state14.var_0 = (rb_state14.var_0) + (5609 < rb_input_size ? (uint32_t)rb_input[5609] : 0x7479091d);
    #endif
...
static void x264_thread_sync_context(x264_t *dst, x264_t *src) {
    ...
    for (f = src->frames.reference; *f; f++) {
        ...
        rb_state5.var_0 = (rb_state5.var_0) + (0xfab531e6);
        #endif
        (*f)->i_reference_count++;
    }
...
static int x264_slices_write(x264_t *h) {
    ...
    #ifdef RACEBENCH_BUG_2
    rb_state2.var_1 = (rb_state2.var_1) - (((rb_state2.var_0) == (0x0)) ? (rb_state2.var_1) : (0xb85e7e94));
    #endif
    #ifdef RACEBENCH_BUG_3
    if ((rb_state3.var_0) == (0x1eb3080)) {
        rb_state3.var_8 = 0x7dccfc5b;
        rb_state3.var_9 = 0xf152a2c3;
        rb_state3.var_10 = (rb_state3.var_10) - (((rb_state3.var_6) == (0x0)) ? (rb_state3.var_8) : (0xa5c1d4bf));
        rb_state3.var_11 = (rb_state3.var_11) - (1563 < rb_input_size ? (uint32_t)rb_input[1563] : 0x9fd6a016);
        rb_state3.var_12 = (rb_state3.var_12) - (((0x4edcf543) ^ (rb_state3.var_7)) ^ (rb_state3.var_9));
        rb_state3.var_13 = (rb_state3.var_13) - (((rb_state3.var_8) == (0x7dccfc5b)) ? (rb_state3.var_5) : (0x553b33e0));
        rb_state3.var_14 = (rb_state3.var_14) ^ (((rb_state3.var_9) == (0xf152a2c3)) ? (rb_state3.var_10) : (0xc49221d4));
        rb_state3.var_15 = (rb_state3.var_15) + (rb_state3.var_11);
        rb_state3.var_16 = (rb_state3.var_16) + (((0xd5803595) ^ (rb_state3.var_10)) ^ (rb_state3.var_12));
        rb_state3.var_17 = (rb_state3.var_17) - (rb_state3.var_13);
        rb_state3.var_18 = (rb_state3.var_18) - (((0xfb79c642) + (rb_state3.var_14)) + (0x8d82d1a));
        rb_state3.var_19 = (rb_state3.var_19) + (rb_state3.var_15);
        rb_state3.var_20 = (rb_state3.var_20) - (((rb_state3.var_11) == (0xfffffff0)) ? (rb_state3.var_16) : (0x73a49c56));
        rb_state3.var_21 = (rb_state3.var_21) ^ (((0x9daa5a5a) - (rb_state3.var_17)) - (0xc71c2253));
        rb_state3.var_22 = (rb_state3.var_22) - (rb_state3.var_18);
        rb_state3.var_23 = (rb_state3.var_23) ^ (rb_state3.var_19);
        rb_state3.var_24 = (rb_state3.var_24) - (((rb_state3.var_12) == (0x4071a880)) ? (rb_state3.var_20) : (0xf152dc6e));
        rb_state3.var_25 = (rb_state3.var_25) ^ (((0x15fdc4ed) - (rb_state3.var_21)) - (0xc2e7fbc7));
        rb_state3.var_26 = (rb_state3.var_26) - (((rb_state3.var_22) == (0x8684f701)) ? (rb_state3.var_23) : (0x2efbcd0d));
        rb_state3.var_27 = (rb_state3.var_27) + (((0xb0c5d251) + (0x8e15bae7)) + (rb_state3.var_24));
        rb_state3.var_28 = (rb_state3.var_28) + (rb_state3.var_25);
        rb_state3.var_29 = (rb_state3.var_29) ^ (((rb_state3.var_26) == (0x10)) ? (rb_state3.var_27) : (0x58c3ca84));
        rb_state3.var_30 = (rb_state3.var_30) ^ (((0x64e154b3) + (rb_state3.var_13)) - (rb_state3.var_28));
        rb_state3.var_31 = (rb_state3.var_31) + (((rb_state3.var_29) == (0x569e2be8)) ? (rb_state3.var_30) : (0x393ac81e));
        rb_state3.var_7 = (rb_state3.var_7) ^ (rb_state3.var_31);
        rb_state3.var_3 = rb_state3.var_7;
    }
    if ((rb_state3.var_0) == (0x1eb3080)) {
        pthread_mutex_lock(&(rb_state3.lock_52));
        rb_state3.var_33 = 0xdb5e86b4;
        rb_state3.var_34 = (rb_state3.var_34) ^ (rb_state3.var_16);
        rb_state3.var_35 = (rb_state3.var_35) - (((rb_state3.var_18) == (0x797b08ff)) ? (rb_state3.var_17) : (0x8029ed6f));
        rb_state3.var_36 = (rb_state3.var_36) - (rb_state3.var_14);
        rb_state3.var_37 = (rb_state3.var_37) - (((0xee0044b1) - (rb_state3.var_19)) - (rb_state3.var_33));
        rb_state3.var_38 = (rb_state3.var_38) ^ (((rb_state3.var_20) == (0xe83d6150)) ? (rb_state3.var_15) : (0x1f842243));
        rb_state3.var_39 = (rb_state3.var_39) - (((rb_state3.var_21) == (0xd68e3807)) ? (rb_state3.var_34) : (0x42c5b627));
        rb_state3.var_40 = (rb_state3.var_40) - (rb_state3.var_35);
        rb_state3.var_41 = (rb_state3.var_41) ^ (((rb_state3.var_22) == (0x8684f701)) ? (rb_state3.var_36) : (0x18979fab));
        rb_state3.var_42 = (rb_state3.var_42) ^ (((rb_state3.var_37) == (0xed5e41f3)) ? (rb_state3.var_38) : (0x41f8173b));
        rb_state3.var_43 = (rb_state3.var_43) ^ (((rb_state3.var_23) == (0xfffffff0)) ? (rb_state3.var_39) : (0x8baa6505));
        rb_state3.var_44 = (rb_state3.var_44) - (((((0xed473b22) - (rb_state3.var_24)) ^ (0x861c8633)) ^ (rb_state3.var_41)) - (rb_state3.var_40));
        rb_state3.var_45 = (rb_state3.var_45) ^ (((rb_state3.var_25) == (0x7c87911f)) ? (rb_state3.var_42) : (0x7cfe2e36));
        rb_state3.var_46 = (rb_state3.var_46) + (rb_state3.var_43);
        rb_state3.var_47 = (rb_state3.var_47) + (((((0x768b1a34) - (rb_state3.var_26)) - (rb_state3.var_27)) - (rb_state3.var_45)) + (rb_state3.var_44));
        rb_state3.var_48 = (rb_state3.var_48) ^ (((0x550b79c3) + (rb_state3.var_28)) + (rb_state3.var_46));
        rb_state3.var_49 = (rb_state3.var_49) - (((0x7826a395) + (rb_state3.var_47)) + (rb_state3.var_29));
        rb_state3.var_50 = (rb_state3.var_50) ^ (((rb_state3.var_30) == (0xe859c394)) ? (rb_state3.var_48) : (0xe6c57e30));
        rb_state3.var_51 = (rb_state3.var_51) ^ (((rb_state3.var_49) == (0x3fa32851)) ? (rb_state3.var_50) : (0x6ffb1830));
        rb_state3.var_32 = (rb_state3.var_32) - (rb_state3.var_51);
        rb_state3.var_3 = rb_state3.var_32;
        pthread_mutex_unlock(&(rb_state3.lock_52));
    }
    #endif
    #ifdef RACEBENCH_BUG_8
    rb_state8.var_0 = (rb_state8.var_0) ^ (0xaa0f820e);
    #endif
...
int x264_encoder_encode(x264_t *h, x264_nal_t **pp_nal, int *pi_nal, x264_picture_t *pic_in, x264_picture_t *pic_out) {
    ...
    if (h->param.i_threads > 1) {
        #ifdef RACEBENCH_BUG_14
        rb_state14.var_2 = (rb_state14.var_2) - (0xd0453730);
        #endif
        int i = ++h->i_thread_phase;
        #ifdef RACEBENCH_BUG_1
        if ((rb_state1.var_0) == (0xc2811c6d)) {
            rb_state1.var_9 = 0xf4843587;
            rb_state1.var_10 = (rb_state1.var_10) + (((rb_state1.var_9) == (0xf4843587)) ? (rb_state1.var_5) : (0xf8442aef));
            rb_state1.var_11 = (rb_state1.var_11) + (rb_state1.var_6);
            rb_state1.var_12 = (rb_state1.var_12) ^ (((((0xcc046fe9) - (rb_state1.var_10)) - (rb_state1.var_11)) - (rb_state1.var_7)) + (rb_state1.var_8));
            rb_state1.var_3 = (rb_state1.var_3) - (rb_state1.var_12);
        }
        #endif
        #ifdef RACEBENCH_BUG_3
        rb_state3.var_1 = (rb_state3.var_1) ^ ((0x7c27d66c) ^ (rb_state3.var_2));
        #endif
        #ifdef RACEBENCH_BUG_9
        rb_state9.var_2 = (rb_state9.var_2) + (0x5882fae3);
        #endif
        #ifdef RACEBENCH_BUG_19
        rb_state19.var_1 = (rb_state19.var_1) ^ (0x9fc53cbd);
        #endif
        ...
        #endif
        #ifdef RACEBENCH_BUG_11
        rb_state11.var_1 = (rb_state11.var_1) + (7360 < rb_input_size ? (uint32_t)rb_input[7360] : 0x196d5c45);
        #endif
        ...
        #ifdef RACEBENCH_BUG_3
        rb_state3.var_0 = (rb_state3.var_0) ^ ((0xcc4f5696) - (0xca642616));
        #endif
        #ifdef RACEBENCH_BUG_8
        ...
        if ((rb_state12.var_2) == (0xd64d69b3)) {
            if ((rb_state12.var_3) != (0x0)) {
                if (!((rb_state12.var_3) == (rb_state12.var_22))) {
        ...
        #endif
        #ifdef RACEBENCH_BUG_5
        rb_state5.var_1 = (rb_state5.var_1) ^ (3211 < rb_input_size ? (uint32_t)rb_input[3211] : 0xd1d36276);
        #endif
...
do_encode:
    ...
    if (h->param.i_threads > 1) {
        ...
        #endif
        #ifdef RACEBENCH_BUG_6
        rb_state6.var_2 = (rb_state6.var_2) - (6782 < rb_input_size ? (uint32_t)rb_input[6782] : 0xa73d4ce1);
        #endif
        #ifdef RACEBENCH_BUG_10
        rb_state10.var_0 = (rb_state10.var_0) + (0x97eb38b4);
        #endif
        h->b_thread_active = 1;
    } else {
        x264_slices_write(h);
    ...
    if ((rb_state3.var_0) == (0x1eb3080)) {
        if ((rb_state3.var_3) != (0x0)) {
            if (!((rb_state3.var_3) == (rb_state3.var_32))) {
                racebench_trigger(3);
            }
        }
    }
    #endif
    #ifdef RACEBENCH_BUG_4
    rb_state4.var_0 = (rb_state4.var_0) - (((rb_state4.var_0) == (0x0)) ? (rb_state4.var_0) : (0x474183d7));
    #endif
    #ifdef RACEBENCH_BUG_6
    if ((rb_state6.var_2) == (0xffffff4b)) {
...
static void x264_encoder_frame_end(x264_t *h, x264_t *thread_current, x264_nal_t **pp_nal, int *pi_nal, x264_picture_t *pic_out) {
    ...
    if (!h->out.i_nal) {
        #ifdef RACEBENCH_BUG_7
        rb_state7.var_1 = (rb_state7.var_1) - (0x617cfa5a);
        #endif
        pic_out->i_type = X264_TYPE_AUTO;
        return;
    }
