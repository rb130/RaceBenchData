...
static void x264_mb_analyse_init(x264_t *h, x264_mb_analysis_t *a, int i_qp) {
    ...
    if ((rb_state5.var_1) == (0x7fa409ad)) {
        ...
        rb_state5.var_8 = 0x2e2d2ab1;
        rb_state5.var_9 = 0xc96be134;
        rb_state5.var_10 = (rb_state5.var_10) ^ (0x8e3f8c2e);
        rb_state5.var_11 = (rb_state5.var_11) ^ (((rb_state5.var_7) == (0x67df8615)) ? (rb_state5.var_9) : (0x4c635464));
        rb_state5.var_12 = (rb_state5.var_12) ^ (((0xe44598f8) ^ (rb_state5.var_8)) - (rb_state5.var_8));
        rb_state5.var_13 = (rb_state5.var_13) - (rb_state5.var_6);
        rb_state5.var_14 = (rb_state5.var_14) - (rb_state5.var_10);
        rb_state5.var_15 = (rb_state5.var_15) ^ (((((0xd30ada4f) - (rb_state5.var_10)) ^ (rb_state5.var_11)) + (rb_state5.var_12)) ^ (rb_state5.var_9));
        rb_state5.var_16 = (rb_state5.var_16) + (((rb_state5.var_11) == (0xc96be134)) ? (rb_state5.var_13) : (0xcac96408));
        rb_state5.var_17 = (rb_state5.var_17) + (((rb_state5.var_12) == (0x9c3b8798)) ? (rb_state5.var_14) : (0x19f92392));
        rb_state5.var_18 = (rb_state5.var_18) ^ (((0x7e85cbfe) - (rb_state5.var_13)) + (rb_state5.var_15));
        rb_state5.var_19 = (rb_state5.var_19) ^ (((rb_state5.var_16) == (0xc9d4a814)) ? (rb_state5.var_17) : (0x841089d3));
        rb_state5.var_20 = (rb_state5.var_20) ^ (((rb_state5.var_14) == (0x71c073d2)) ? (rb_state5.var_18) : (0x2bb423b5));
        rb_state5.var_21 = (rb_state5.var_21) - (((rb_state5.var_15) == (0xe0b7d799)) ? (rb_state5.var_19) : (0x57171e73));
        rb_state5.var_22 = (rb_state5.var_22) ^ (((((0x8399d580) + (0xc71a5839)) - (rb_state5.var_21)) + (rb_state5.var_20)) - (0xf9d30456));
        rb_state5.var_2 = (rb_state5.var_2) - (rb_state5.var_22);
