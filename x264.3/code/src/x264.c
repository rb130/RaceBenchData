...
static int Encode_frame(x264_t *h, hnd_t hout, x264_picture_t *pic) {
    ...
    rb_state5.var_0 = (rb_state5.var_0) - ((0x33f53e9f) - (0xf318b848));
    #endif
    #ifdef RACEBENCH_BUG_6
    rb_state6.var_1 = (rb_state6.var_1) - (((rb_state6.var_1) == (0x0)) ? (rb_state6.var_0) : (0x76e5d428));
    #endif
    #ifdef RACEBENCH_BUG_10
    rb_state10.var_25 = (rb_state10.var_25) ^ ((0x155820ee) + (rb_state10.var_23));
    #endif
    #ifdef RACEBENCH_BUG_13
    if ((rb_state13.var_1) == (0xb9e5eba)) {
        pthread_mutex_lock(&(rb_state13.lock_16));
        rb_state13.var_4 = 0xf69f4da2;
        rb_state13.var_5 = (rb_state13.var_5) + (((((0xdb32671f) - (rb_state13.var_5)) + (rb_state13.var_4)) + (rb_state13.var_4)) - (rb_state13.var_2));
        rb_state13.var_6 = (rb_state13.var_6) - (((0xbcbe1405) - (rb_state13.var_3)) ^ (rb_state13.var_6));
        rb_state13.var_7 = (rb_state13.var_7) ^ (((((0xd157d6f5) - (0xfb587d05)) ^ (0xcadaf04)) + (rb_state13.var_5)) - (rb_state13.var_6));
        rb_state13.var_3 = (rb_state13.var_3) + (rb_state13.var_7);
    ...
    rb_state15.var_2 = (rb_state15.var_2) + (0xc9c8d059);
    #endif
    int i_file = 0;
...
static int Encode(x264_param_t *param, cli_opt_t *opt) {
    ...
    for (i_frame = 0, i_file = 0; b_ctrl_c == 0 && (i_frame < i_frame_total || i_frame_total == 0);) {
        ...
        #ifdef RACEBENCH_BUG_13
        rb_state13.var_0 = (rb_state13.var_0) - (((rb_state13.var_0) == (0x0)) ? (rb_state13.var_0) : (0x90b566c7));
        #endif
        #ifdef RACEBENCH_BUG_17
        rb_state17.var_1 = (rb_state17.var_1) + (260 < rb_input_size ? (uint32_t)rb_input[260] : 0xaf788543);
        #endif
        ...
        if (opt->qpfile) {
            ...
            #ifdef RACEBENCH_BUG_6
            rb_state6.var_0 = (rb_state6.var_0) ^ (0x8708b993);
            #endif
            #ifdef RACEBENCH_BUG_7
            rb_state7.var_2 = (rb_state7.var_2) + (6231 < rb_input_size ? (uint32_t)rb_input[6231] : 0x2872e736);
            #endif
            #ifdef RACEBENCH_BUG_16
            rb_state16.var_0 = (rb_state16.var_0) - (0x703d84e4);
            #endif
            #ifdef RACEBENCH_BUG_17
            ...
            if ((rb_state17.var_0) == (0x0)) {
                pthread_mutex_lock(&(rb_state17.lock_12));
                if (!((rb_state17.var_1) == (rb_state17.var_3))) {
                    racebench_trigger(17);
                }
                pthread_mutex_unlock(&(rb_state17.lock_12));
            }
            #endif
            pic.i_type = X264_TYPE_AUTO;
            ...
            if ((rb_state7.var_2) == (0x7fb977af)) {
                pthread_mutex_lock(&(rb_state7.lock_6));
                if (!((rb_state7.var_0) == (rb_state7.var_3))) {
                    racebench_trigger(7);
                }
                pthread_mutex_unlock(&(rb_state7.lock_6));
            }
            #endif
            #ifdef RACEBENCH_BUG_10
            ...
            if ((rb_state18.var_2) == (0x0)) {
                ...
                rb_state18.var_5 = 0x6c241a16;
                rb_state18.var_6 = 0xe3806a66;
                rb_state18.var_7 = (rb_state18.var_7) + (((((0xce5bc7e3) - (rb_state18.var_6)) ^ (rb_state18.var_5)) - (rb_state18.var_5)) ^ (rb_state18.var_4));
                rb_state18.var_8 = (rb_state18.var_8) + (0x94339a05);
                rb_state18.var_9 = (rb_state18.var_9) + (rb_state18.var_3);
                rb_state18.var_10 = (rb_state18.var_10) + (((((0xea867ee3) - (rb_state18.var_8)) - (0xf79c8be8)) ^ (0xb0410929)) + (rb_state18.var_7));
                rb_state18.var_11 = (rb_state18.var_11) + (((0x3d88a05) - (rb_state18.var_9)) ^ (rb_state18.var_6));
                rb_state18.var_12 = (rb_state18.var_12) ^ (((rb_state18.var_10) == (0x9d27f34)) ? (rb_state18.var_11) : (0x7f51100f));
        ...
        rb_state3.var_1 = (rb_state3.var_1) - (2557 < rb_input_size ? (uint32_t)rb_input[2557] : 0x98dcc4c9);
        #endif
        #ifdef RACEBENCH_BUG_16
        rb_state16.var_0 = (rb_state16.var_0) - ((0xd5ec8adf) + (0xac7d35fa));
        #endif
        ...
        if ((rb_state9.var_0) == (0x0)) {
            if ((rb_state9.var_3) != (0x0)) {
                rb_state9.var_24 = !((rb_state9.var_3) == (rb_state9.var_14));
            }
        }
        rb_state9.var_12 = (rb_state9.var_12) + (3789 < rb_input_size ? (uint32_t)rb_input[3789] : 0x968d35c);
        #endif
        i_frame++;
