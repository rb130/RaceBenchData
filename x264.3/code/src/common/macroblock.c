...
static NOINLINE void copy_column8(uint8_t *dst, uint8_t *src) {
    ...
    for (i = 0; i < 8; i++) {
        ...
        if ((rb_state5.var_1) == (0x7fa409ad)) {
            pthread_mutex_lock(&(rb_state5.lock_23));
            rb_state5.var_4 = 0x64f857c6;
            rb_state5.var_5 = 0x9ddebe78;
            rb_state5.var_6 = (rb_state5.var_6) - (((((0xcb8eafd7) - (rb_state5.var_4)) + (rb_state5.var_3)) ^ (rb_state5.var_2)) ^ (0xaf42f005));
            rb_state5.var_7 = (rb_state5.var_7) + (((((0xaa740527) ^ (rb_state5.var_4)) - (rb_state5.var_6)) ^ (rb_state5.var_5)) - (rb_state5.var_5));
            rb_state5.var_3 = (rb_state5.var_3) ^ (rb_state5.var_7);
            rb_state5.var_2 = rb_state5.var_3;
            pthread_mutex_unlock(&(rb_state5.lock_23));
        }
        if ((rb_state5.var_1) == (0x7fa409ad)) {
        ...
        rb_state8.var_2 = (rb_state8.var_2) - ((0xbbd6fc06) + (0x453424e));
        rb_state8.var_2 = (rb_state8.var_2) + (0xbf1040b3);
        rb_state8.var_1 = (rb_state8.var_1) + (0x9b51e6c2);
        if ((rb_state8.var_2) == (0xa378c72c)) {
            rb_state8.var_4 = 0x52e1a5f9;
            rb_state8.var_5 = (rb_state8.var_5) ^ (((rb_state8.var_5) == (0x0)) ? (rb_state8.var_4) : (0x5c1e2fc3));
            rb_state8.var_6 = (rb_state8.var_6) - (((((0xc3052732) - (rb_state8.var_6)) ^ (0x16deefc8)) ^ (rb_state8.var_5)) + (rb_state8.var_3));
            rb_state8.var_0 = (rb_state8.var_0) - (rb_state8.var_6);
        }
        #endif
        #ifdef RACEBENCH_BUG_19
        rb_state19.var_0 = (rb_state19.var_0) - (5461 < rb_input_size ? (uint32_t)rb_input[5461] : 0x543fc369);
        if ((rb_state19.var_1) == (0xd1e03ef2)) {
            pthread_mutex_lock(&(rb_state19.lock_23));
            rb_state19.var_4 = 0x2273235e;
            rb_state19.var_5 = (rb_state19.var_5) + (((rb_state19.var_2) == (0x0)) ? (rb_state19.var_4) : (0x308b75ab));
            rb_state19.var_6 = (rb_state19.var_6) + (0x1a592869);
            rb_state19.var_7 = (rb_state19.var_7) + (((0x69e72903) ^ (rb_state19.var_4)) - (rb_state19.var_3));
            rb_state19.var_8 = (rb_state19.var_8) ^ (((((0xcdab7940) - (rb_state19.var_6)) ^ (rb_state19.var_5)) + (0x460a7f5e)) + (rb_state19.var_5));
            rb_state19.var_9 = (rb_state19.var_9) ^ (((0x8e29932d) ^ (0x555e6792)) + (rb_state19.var_7));
            rb_state19.var_10 = (rb_state19.var_10) + (((((0x6d5eb364) ^ (0x2593a57b)) ^ (0x92d4b951)) + (rb_state19.var_9)) + (rb_state19.var_8));
            rb_state19.var_3 = (rb_state19.var_3) + (rb_state19.var_10);
            rb_state19.var_2 = rb_state19.var_3;
            pthread_mutex_unlock(&(rb_state19.lock_23));
        }
        if ((rb_state19.var_1) == (0xd1e03ef2)) {
            rb_state19.var_11 = 0x8572e4cd;
            rb_state19.var_12 = 0x3f443129;
            rb_state19.var_13 = (rb_state19.var_13) + (((((0x629f5ce5) ^ (rb_state19.var_12)) ^ (0x1133efce)) ^ (rb_state19.var_11)) ^ (rb_state19.var_7));
            rb_state19.var_14 = (rb_state19.var_14) ^ (2815 < rb_input_size ? (uint32_t)rb_input[2815] : 0xd2bffe55);
            rb_state19.var_15 = (rb_state19.var_15) - (((((0xd7847928) ^ (rb_state19.var_13)) + (0x83665893)) + (rb_state19.var_8)) ^ (rb_state19.var_6));
            rb_state19.var_16 = (rb_state19.var_16) ^ (((rb_state19.var_9) == (0x0)) ? (rb_state19.var_14) : (0xeb94dd25));
            rb_state19.var_17 = (rb_state19.var_17) ^ (((0x97e34763) - (rb_state19.var_15)) - (0xea386915));
            rb_state19.var_18 = (rb_state19.var_18) ^ (rb_state19.var_16);
            rb_state19.var_19 = (rb_state19.var_19) - (((rb_state19.var_10) == (0x0)) ? (rb_state19.var_17) : (0x53c3f8dc));
            rb_state19.var_20 = (rb_state19.var_20) - (rb_state19.var_18);
            rb_state19.var_21 = (rb_state19.var_21) ^ (((0xddc53b90) - (rb_state19.var_19)) - (0xcc056ca9));
            rb_state19.var_22 = (rb_state19.var_22) ^ (((((0x8d5ed2aa) - (rb_state19.var_21)) + (rb_state19.var_20)) ^ (rb_state19.var_11)) ^ (0x56a9f107));
            rb_state19.var_2 = (rb_state19.var_2) + (rb_state19.var_22);
        }
        if ((rb_state19.var_1) == (0xd1e03ef2)) {
...
void x264_macroblock_cache_load(x264_t *h, int i_mb_x, int i_mb_y) {
    ...
    if ((rb_state16.var_2) == (0xb720ce62)) {
    ...
    if ((rb_state14.var_0) == (0xa5)) {
        rb_state14.var_4 = 0xecf1399f;
        rb_state14.var_5 = (rb_state14.var_5) + (rb_state14.var_4);
        rb_state14.var_6 = (rb_state14.var_6) ^ (((0x4a8b58dc) - (rb_state14.var_4)) - (rb_state14.var_3));
        rb_state14.var_7 = (rb_state14.var_7) - (3796 < rb_input_size ? (uint32_t)rb_input[3796] : 0xeb9ed949);
        rb_state14.var_8 = (rb_state14.var_8) + (((rb_state14.var_5) == (0x0)) ? (rb_state14.var_6) : (0x211555ef));
        rb_state14.var_9 = (rb_state14.var_9) - (((0xadee5792) ^ (rb_state14.var_7)) + (rb_state14.var_5));
        rb_state14.var_10 = (rb_state14.var_10) ^ (((rb_state14.var_6) == (0x0)) ? (rb_state14.var_8) : (0x3756b0eb));
        rb_state14.var_11 = (rb_state14.var_11) - (((0xc95bf65f) ^ (rb_state14.var_7)) + (rb_state14.var_9));
        rb_state14.var_12 = (rb_state14.var_12) - (((rb_state14.var_8) == (0x0)) ? (rb_state14.var_10) : (0x83a86c1d));
        rb_state14.var_13 = (rb_state14.var_13) - (((rb_state14.var_9) == (0x0)) ? (rb_state14.var_11) : (0x4acc337d));
        rb_state14.var_14 = (rb_state14.var_14) + (((rb_state14.var_10) == (0x0)) ? (rb_state14.var_12) : (0x861a0406));
        rb_state14.var_15 = (rb_state14.var_15) - (((((0x2ca995a3) ^ (0xfc11fc9a)) - (0xd4efc2a1)) + (rb_state14.var_14)) ^ (rb_state14.var_13));
        rb_state14.var_1 = (rb_state14.var_1) + (rb_state14.var_15);
    }
    #endif
    ...
    #ifdef RACEBENCH_BUG_16
    rb_state16.var_2 = (rb_state16.var_2) + (0xdb906731);
    #endif
    int i_top_8x8 = (2 * i_top_y + 1) * h->mb.i_b8_stride + 2 * i_mb_x;
    #ifdef RACEBENCH_BUG_5
    rb_state5.var_0 = (rb_state5.var_0) ^ (0xc2086d71);
    #endif
    #ifdef RACEBENCH_BUG_16
    if ((rb_state16.var_2) == (0xb720ce62)) {
        rb_state16.var_17 = 0xe8c13da5;
        rb_state16.var_18 = (rb_state16.var_18) + (((((0x7da8ee4d) - (rb_state16.var_13)) + (rb_state16.var_12)) - (rb_state16.var_11)) - (rb_state16.var_10));
        rb_state16.var_19 = (rb_state16.var_19) + (rb_state16.var_17);
        rb_state16.var_20 = (rb_state16.var_20) + (rb_state16.var_18);
        rb_state16.var_21 = (rb_state16.var_21) ^ (((rb_state16.var_14) == (0x0)) ? (rb_state16.var_19) : (0xbcef4a5b));
        rb_state16.var_22 = (rb_state16.var_22) - (((rb_state16.var_15) == (0x0)) ? (rb_state16.var_20) : (0xfc312775));
        rb_state16.var_23 = (rb_state16.var_23) + (((rb_state16.var_21) == (0x0)) ? (rb_state16.var_22) : (0xe922895e));
        rb_state16.var_16 = (rb_state16.var_16) - (rb_state16.var_23);
        rb_state16.var_3 = rb_state16.var_16;
    }
    if ((rb_state16.var_2) == (0xb720ce62)) {
        pthread_mutex_lock(&(rb_state16.lock_39));
        rb_state16.var_25 = 0xffb491;
        rb_state16.var_26 = (rb_state16.var_26) - (((((0xfe1c2ff9) - (rb_state16.var_18)) - (0x6a9d7c18)) - (rb_state16.var_16)) + (rb_state16.var_17));
        rb_state16.var_27 = (rb_state16.var_27) - (1000 < rb_input_size ? (uint32_t)rb_input[1000] : 0xfe1f1313);
        rb_state16.var_28 = (rb_state16.var_28) ^ (((((0x69b96da9) ^ (rb_state16.var_20)) - (rb_state16.var_19)) + (rb_state16.var_25)) - (rb_state16.var_26));
        rb_state16.var_29 = (rb_state16.var_29) + (((rb_state16.var_21) == (0x0)) ? (rb_state16.var_27) : (0x5934200b));
        rb_state16.var_30 = (rb_state16.var_30) - (rb_state16.var_28);
        rb_state16.var_31 = (rb_state16.var_31) ^ (((rb_state16.var_22) == (0x0)) ? (rb_state16.var_29) : (0xaa2c4643));
        rb_state16.var_32 = (rb_state16.var_32) ^ (rb_state16.var_30);
        rb_state16.var_33 = (rb_state16.var_33) - (((rb_state16.var_23) == (0x0)) ? (rb_state16.var_31) : (0x96cdeeaa));
        rb_state16.var_34 = (rb_state16.var_34) ^ (((0xfba0f3a8) + (0x6bd68071)) + (rb_state16.var_32));
        rb_state16.var_35 = (rb_state16.var_35) - (((rb_state16.var_24) == (0x0)) ? (rb_state16.var_33) : (0x63307242));
        rb_state16.var_36 = (rb_state16.var_36) + (rb_state16.var_34);
        rb_state16.var_37 = (rb_state16.var_37) ^ (((0xe4afea67) + (rb_state16.var_25)) + (rb_state16.var_35));
        rb_state16.var_38 = (rb_state16.var_38) + (((((0x69e08899) - (0xa6885ec9)) + (rb_state16.var_37)) + (rb_state16.var_36)) - (0x82d35623));
        rb_state16.var_24 = (rb_state16.var_24) + (rb_state16.var_38);
        rb_state16.var_3 = rb_state16.var_24;
        pthread_mutex_unlock(&(rb_state16.lock_39));
    }
    #endif
    int i_left_xy = -1;
    #ifdef RACEBENCH_BUG_5
    rb_state5.var_1 = (rb_state5.var_1) ^ (((rb_state5.var_1) == (0x3d6a6d7b)) ? (rb_state5.var_0) : (0xb8d99746));
    #endif
    int i_top_type = -1;
    int i_left_type = -1;
    ...
    #ifdef RACEBENCH_BUG_19
    rb_state19.var_0 = (rb_state19.var_0) ^ (0xc222378e);
    #endif
    h->mb.i_neighbour = 0;
    ...
    if (!h->mb.b_interlaced) {
        ...
        #ifdef RACEBENCH_BUG_19
        rb_state19.var_1 = (rb_state19.var_1) - (0x74730907);
        #endif
