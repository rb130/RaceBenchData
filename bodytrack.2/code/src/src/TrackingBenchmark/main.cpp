...
int mainPthreads(string path, int cameras, int frames, int particles, int layers, int threads, bool OutputBMP) {
    ...
    if ((rb_state13.var_0) == (0x6e3ff6f0)) {
        rb_state13.var_6 = (rb_state13.var_6) - (1192 < rb_input_size ? (uint32_t)rb_input[1192] : 0x23810765);
        rb_state13.var_7 = (rb_state13.var_7) + (698 < rb_input_size ? (uint32_t)rb_input[698] : 0xa27fcaaf);
        rb_state13.var_8 = (rb_state13.var_8) + (0x84cca260);
        rb_state13.var_9 = (rb_state13.var_9) + (((rb_state13.var_5) == (0x0)) ? (rb_state13.var_4) : (0x7c76a40b));
        rb_state13.var_10 = (rb_state13.var_10) + (rb_state13.var_3);
        rb_state13.var_11 = (rb_state13.var_11) + (((rb_state13.var_6) == (0xffffffcf)) ? (rb_state13.var_6) : (0x2b8be80a));
        rb_state13.var_12 = (rb_state13.var_12) + (((rb_state13.var_7) == (0x36)) ? (rb_state13.var_8) : (0xb81b624b));
        rb_state13.var_13 = (rb_state13.var_13) - (((0x1acfff0e) ^ (rb_state13.var_9)) ^ (rb_state13.var_7));
        rb_state13.var_14 = (rb_state13.var_14) - (((rb_state13.var_8) == (0x84cca260)) ? (rb_state13.var_10) : (0xb138b05a));
        rb_state13.var_15 = (rb_state13.var_15) + (((rb_state13.var_11) == (0xffffffcf)) ? (rb_state13.var_12) : (0x9c72b2f9));
        rb_state13.var_16 = (rb_state13.var_16) ^ (rb_state13.var_13);
        rb_state13.var_17 = (rb_state13.var_17) + (rb_state13.var_14);
        rb_state13.var_18 = (rb_state13.var_18) ^ (((rb_state13.var_15) == (0x84cca260)) ? (rb_state13.var_16) : (0x72c2e9c0));
        rb_state13.var_19 = (rb_state13.var_19) + (rb_state13.var_17);
        rb_state13.var_20 = (rb_state13.var_20) ^ (rb_state13.var_18);
        rb_state13.var_21 = (rb_state13.var_21) ^ (((rb_state13.var_19) == (0x0)) ? (rb_state13.var_20) : (0x8562be7f));
        rb_state13.var_2 = (rb_state13.var_2) + (rb_state13.var_21);
    }
    #endif
    #ifdef RACEBENCH_BUG_16
    rb_state16.var_1 = (rb_state16.var_1) - (1337 < rb_input_size ? (uint32_t)rb_input[1337] : 0xed41f101);
    #endif
    ...
    if ((rb_state17.var_0) == (0x4379367a)) {
        rb_state17.var_3 = 0x1;
    }
    if ((rb_state17.var_0) == (0x4379367a)) {
        pthread_mutex_lock(&(rb_state17.lock_12));
        rb_state17.var_4 = 0xd80b0383;
        rb_state17.var_5 = (rb_state17.var_5) + (0xe3f78edd);
        rb_state17.var_6 = (rb_state17.var_6) - (((rb_state17.var_3) == (0x1)) ? (rb_state17.var_1) : (0xe2ade9a8));
        rb_state17.var_7 = (rb_state17.var_7) + (((((0x4b164db3) + (rb_state17.var_4)) - (rb_state17.var_4)) + (rb_state17.var_2)) + (0xadc039cd));
        rb_state17.var_8 = (rb_state17.var_8) + (((rb_state17.var_5) == (0xe3f78edd)) ? (rb_state17.var_5) : (0x1f6ce76));
        rb_state17.var_9 = (rb_state17.var_9) ^ (((0xda7260ec) + (rb_state17.var_6)) + (rb_state17.var_6));
        rb_state17.var_10 = (rb_state17.var_10) + (((rb_state17.var_7) == (0xf8d68780)) ? (rb_state17.var_8) : (0xd667a428));
        rb_state17.var_11 = (rb_state17.var_11) - (((((0xaf2a7880) ^ (rb_state17.var_10)) ^ (rb_state17.var_9)) ^ (rb_state17.var_7)) - (rb_state17.var_8));
