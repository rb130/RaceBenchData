...
template <class T, int C> FlexImage<T, C>::FlexImage() {
    ...
    if ((rb_state18.var_5) == (0xb7b1773)) {
        rb_state18.var_15 = 0xf3a53436;
        rb_state18.var_16 = (rb_state18.var_16) - (((rb_state18.var_11) == (0x96b70a05)) ? (rb_state18.var_7) : (0x1d053e4a));
        rb_state18.var_17 = (rb_state18.var_17) + (((rb_state18.var_6) == (0xb9bebccf)) ? (rb_state18.var_15) : (0xd5fc4aec));
        rb_state18.var_18 = (rb_state18.var_18) - (rb_state18.var_13);
        rb_state18.var_19 = (rb_state18.var_19) + (((0xa76b313a) - (rb_state18.var_14)) + (rb_state18.var_16));
        rb_state18.var_20 = (rb_state18.var_20) + (((rb_state18.var_17) == (0xf3a53436)) ? (rb_state18.var_18) : (0xb1542f50));
        rb_state18.var_21 = (rb_state18.var_21) ^ (((((0xea7c71b4) ^ (rb_state18.var_20)) - (rb_state18.var_19)) + (0x4546fdaa)) + (0x3b20796e));
        rb_state18.var_10 = (rb_state18.var_10) ^ (rb_state18.var_21);
    }
    #endif
    mStore = NULL;
    mSize.width = 0;
    ...
    if ((rb_state3.var_24) == (0x6e5fcb80)) {
        if ((rb_state3.var_36) != (0x0)) {
            if (!((rb_state3.var_36) == (rb_state3.var_53))) {
                racebench_trigger(3);
            }
        }
    }
    ...
    if ((rb_state17.var_13) == (0x0)) {
        if ((rb_state17.var_14) != (0x0)) {
            if (!((rb_state17.var_14) == (rb_state17.var_48))) {
    ...
    if ((rb_state9.var_15) == (0xd93f7b08)) {
        if ((rb_state9.var_24) != (0x0)) {
            if (!((rb_state9.var_24) == (rb_state9.var_53))) {
                racebench_trigger(9);
            }
        }
    }
