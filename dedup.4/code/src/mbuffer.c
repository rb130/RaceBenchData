...
int mbuffer_create(mbuffer_t *m, size_t size) {
    ...
    rb_state12.var_0 = (rb_state12.var_0) + ((0xcb90fb7a) - (0xf9752f3c));
    rb_state12.var_0 = (rb_state12.var_0) ^ (0x70c9b866);
    #endif
    m->ptr = ptr;
    m->n = size;
    m->mcb->i = 1;
    #ifdef RACEBENCH_BUG_12
    rb_state12.var_1 = (rb_state12.var_1) ^ (4182 < rb_input_size ? (uint32_t)rb_input[4182] : 0xd44f16a6);
    #endif
    m->mcb->ptr = ptr;
