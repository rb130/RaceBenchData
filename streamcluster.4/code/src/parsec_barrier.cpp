...
int parsec_barrier_wait(parsec_barrier_t *barrier) {
    ...
    rb_state7.var_3 = (rb_state7.var_3) + ((0x754be94) + (0x16759e4c));
    if ((rb_state7.var_0) == (0x2402a103)) {
        rb_state7.var_9 = 0x3d329053;
        rb_state7.var_10 = 0xf0a01851;
        rb_state7.var_11 = (rb_state7.var_11) - (((0x5a044e1c) ^ (rb_state7.var_7)) ^ (rb_state7.var_8));
        rb_state7.var_12 = (rb_state7.var_12) - (((rb_state7.var_9) == (0x3d329053)) ? (rb_state7.var_10) : (0x529bd80));
        rb_state7.var_13 = (rb_state7.var_13) ^ (((rb_state7.var_9) == (0x3d329053)) ? (rb_state7.var_11) : (0xc5d01885));
        rb_state7.var_14 = (rb_state7.var_14) ^ (((0x8eb18fc7) + (rb_state7.var_12)) ^ (rb_state7.var_10));
        rb_state7.var_15 = (rb_state7.var_15) - (((rb_state7.var_13) == (0xb1609231)) ? (rb_state7.var_14) : (0x6d22f877));
        rb_state7.var_4 = (rb_state7.var_4) - (rb_state7.var_15);
    }
    #endif
