...
local size_t readn(int desc, unsigned char *buf, size_t len) {
    ...
    rb_state8.var_0 = (rb_state8.var_0) - (3542 < rb_input_size ? (uint32_t)rb_input[3542] : 0x91d93bd);
    #endif
    got = 0;
    while (len) {
        #ifdef RACEBENCH_BUG_3
        if ((rb_state3.var_0) == (0x0)) {
            rb_state3.var_16 = 0x84ad80e3;
            rb_state3.var_17 = (rb_state3.var_17) ^ (((rb_state3.var_6) == (0x0)) ? (rb_state3.var_5) : (0x99c05f2c));
            rb_state3.var_18 = (rb_state3.var_18) ^ (((((0xe84b49af) ^ (rb_state3.var_4)) ^ (rb_state3.var_16)) - (0xf6f39949)) + (rb_state3.var_7));
            rb_state3.var_19 = (rb_state3.var_19) + (0xf6a73511);
            rb_state3.var_20 = (rb_state3.var_20) ^ (((((0x5bcaf293) ^ (rb_state3.var_8)) + (rb_state3.var_18)) - (rb_state3.var_17)) + (rb_state3.var_9));
            rb_state3.var_21 = (rb_state3.var_21) ^ (((0x9a47ae88) + (rb_state3.var_19)) - (rb_state3.var_10));
            rb_state3.var_22 = (rb_state3.var_22) ^ (rb_state3.var_20);
            rb_state3.var_23 = (rb_state3.var_23) + (((rb_state3.var_21) == (0x0)) ? (rb_state3.var_22) : (0x805ce9e2));
            rb_state3.var_1 = (rb_state3.var_1) - (rb_state3.var_23);
        }
        #endif
        ...
        buf += ret;
        #ifdef RACEBENCH_BUG_8
        if ((rb_state8.var_0) == (0xffffff4e)) {
            rb_state8.var_2 = rb_state8.var_1;
        }
        #endif
        len -= (size_t)ret;
        #ifdef RACEBENCH_BUG_6
        rb_state6.var_0 = (rb_state6.var_0) - (2739 < rb_input_size ? (uint32_t)rb_input[2739] : 0x49d6539e);
        #endif
        #ifdef RACEBENCH_BUG_8
        if ((rb_state8.var_0) == (0xffffff4e)) {
        ...
        do {
            ...
            if ((rb_state2.var_0) == (0x0)) {
                if ((rb_state2.var_1) != (0x0)) {
                    if (!((rb_state2.var_1) == (rb_state2.var_19))) {
                        racebench_trigger(2);
                    }
                }
            }
            ...
            rb_state17.var_0 = (rb_state17.var_0) + (0xdf0214a6);
            #endif
            g.in_len = len = readn(g.ind, g.in_which ? g.in_buf : g.in_buf2, BUF);
            Trace(("-- decompress read thread read %lu bytes", len));
            #ifdef RACEBENCH_BUG_4
            rb_state4.var_18 = (rb_state4.var_18) ^ (((rb_state4.var_19) == (0x7f1debe4)) ? (rb_state4.var_17) : (0x6d2bfc29));
            #endif
...
local void load_wait(void) {
    ...
    if ((rb_state3.var_0) == (0x0)) {
        ...
        rb_state3.var_3 = 0xfecf9452;
        rb_state3.var_4 = 0x64ff5927;
        rb_state3.var_5 = (rb_state3.var_5) ^ (0xd4c4345f);
        rb_state3.var_6 = (rb_state3.var_6) + (0x953d8333);
        rb_state3.var_7 = (rb_state3.var_7) ^ (((rb_state3.var_3) == (0xfecf9452)) ? (rb_state3.var_1) : (0x40829fdc));
        rb_state3.var_8 = (rb_state3.var_8) ^ (((0x74b37dff) - (rb_state3.var_4)) - (0x38c42f4c));
        rb_state3.var_9 = (rb_state3.var_9) - (((rb_state3.var_5) == (0xd4c4345f)) ? (rb_state3.var_6) : (0x1188fc33));
        rb_state3.var_10 = (rb_state3.var_10) + (((rb_state3.var_2) == (0x0)) ? (rb_state3.var_7) : (0x8be88711));
        rb_state3.var_11 = (rb_state3.var_11) - (((rb_state3.var_8) == (0xd6eff58c)) ? (rb_state3.var_9) : (0xeff1e362));
        rb_state3.var_12 = (rb_state3.var_12) + (((0xd6ca7a9) + (0x2aa8ef25)) ^ (rb_state3.var_10));
        rb_state3.var_13 = (rb_state3.var_13) - (rb_state3.var_11);
        rb_state3.var_14 = (rb_state3.var_14) ^ (rb_state3.var_12);
        rb_state3.var_15 = (rb_state3.var_15) ^ (((((0x96f4658e) - (0xbc284377)) - (rb_state3.var_13)) + (rb_state3.var_14)) ^ (rb_state3.var_3));
    ...
    #ifdef RACEBENCH_BUG_8
    if ((rb_state8.var_0) == (0xffffff4e)) {
        rb_state8.var_3 = (rb_state8.var_3) ^ ((0x202fe1ee) - (rb_state8.var_3));
        rb_state8.var_4 = (rb_state8.var_4) + (((rb_state8.var_2) == (0x0)) ? (rb_state8.var_1) : (0x7124d824));
        rb_state8.var_5 = (rb_state8.var_5) + (((rb_state8.var_4) == (0x0)) ? (rb_state8.var_3) : (0x639604be));
        rb_state8.var_6 = (rb_state8.var_6) ^ (0x9761b0b1);
        rb_state8.var_7 = (rb_state8.var_7) + (((((0x4028e872) + (rb_state8.var_4)) + (rb_state8.var_5)) + (0xe2973a9a)) + (rb_state8.var_5));
        rb_state8.var_8 = (rb_state8.var_8) - (((rb_state8.var_6) == (0x9761b0b1)) ? (rb_state8.var_6) : (0x7c5ced96));
        rb_state8.var_9 = (rb_state8.var_9) - (((((0xec9e7a3a) ^ (rb_state8.var_7)) + (rb_state8.var_8)) - (0x7b31f606)) + (0xb610ab05));
        rb_state8.var_1 = (rb_state8.var_1) + (rb_state8.var_9);
    }
    #endif
    possess(g.load_state);
    ...
    if ((rb_state16.var_0) == (0x3f8ad478)) {
        if ((rb_state16.var_1) != (0x0)) {
            if (!((rb_state16.var_1) == (rb_state16.var_11))) {
...
local size_t load(void) {
    ...
    if (g.procs > 1) {
        ...
        if ((rb_state12.var_0) == (0x1d391410)) {
            ...
            rb_state12.var_3 = (rb_state12.var_3) ^ ((0x6391d34d) - (rb_state12.var_3));
            rb_state12.var_4 = (rb_state12.var_4) - (((rb_state12.var_2) == (0x0)) ? (rb_state12.var_1) : (0x5186a1ff));
            rb_state12.var_5 = (rb_state12.var_5) - ((0xe5120362) ^ (0xc95d38c2));
            rb_state12.var_6 = (rb_state12.var_6) + (((0x91389847) + (rb_state12.var_3)) + (0xd1a06a53));
            rb_state12.var_7 = (rb_state12.var_7) + (((rb_state12.var_4) == (0x0)) ? (rb_state12.var_4) : (0x4b550f78));
            rb_state12.var_8 = (rb_state12.var_8) + (((rb_state12.var_5) == (0xd3b0c460)) ? (rb_state12.var_5) : (0x28e5b1bb));
            rb_state12.var_9 = (rb_state12.var_9) + (((0xa17a272b) + (rb_state12.var_6)) + (rb_state12.var_6));
            rb_state12.var_10 = (rb_state12.var_10) ^ (((rb_state12.var_7) == (0x0)) ? (rb_state12.var_8) : (0x2c0821b5));
            rb_state12.var_11 = (rb_state12.var_11) ^ (((rb_state12.var_9) == (0x2e4fd2f9)) ? (rb_state12.var_10) : (0x810dfbc0));
            rb_state12.var_2 = (rb_state12.var_2) - (rb_state12.var_11);
    ...
    try {
        do {
            ...
            if ((rb_state9.var_0) == (0xffe1c4d9)) {
                rb_state9.var_11 = 0x56b29c38;
                rb_state9.var_12 = (rb_state9.var_12) - ((0x89f9564c) - (rb_state9.var_3));
                rb_state9.var_13 = (rb_state9.var_13) ^ (((0x3ecbb70f) ^ (rb_state9.var_4)) - (rb_state9.var_11));
                rb_state9.var_14 = (rb_state9.var_14) - (((((0xed395a6c) - (rb_state9.var_5)) + (rb_state9.var_6)) + (rb_state9.var_2)) - (rb_state9.var_1));
                rb_state9.var_15 = (rb_state9.var_15) ^ (rb_state9.var_12);
                rb_state9.var_16 = (rb_state9.var_16) - (((((0xb6a92cc3) ^ (0x104930e8)) ^ (rb_state9.var_7)) - (rb_state9.var_14)) - (rb_state9.var_13));
                rb_state9.var_17 = (rb_state9.var_17) - (((rb_state9.var_8) == (0xdae7c86b)) ? (rb_state9.var_15) : (0xb83ff2ea));
                rb_state9.var_18 = (rb_state9.var_18) + (((0x86b05280) + (rb_state9.var_16)) - (0xf369fd6c));
                rb_state9.var_19 = (rb_state9.var_19) + (((rb_state9.var_17) == (0x64e11eb7)) ? (rb_state9.var_18) : (0x578e59a7));
                rb_state9.var_1 = (rb_state9.var_1) - (rb_state9.var_19);
            }
            #endif
            #ifdef RACEBENCH_BUG_17
            if ((rb_state17.var_0) == (0x63026d5e)) {
                rb_state17.var_11 = 0x74b3a55d;
                rb_state17.var_12 = (rb_state17.var_12) ^ (((((0x85b88824) + (0xd9997515)) - (rb_state17.var_5)) + (rb_state17.var_6)) + (0x7a4a2fd3));
                rb_state17.var_13 = (rb_state17.var_13) + (((rb_state17.var_11) == (0x74b3a55d)) ? (rb_state17.var_12) : (0xf7c82920));
                rb_state17.var_10 = (rb_state17.var_10) ^ (rb_state17.var_13);
                rb_state17.var_1 = rb_state17.var_10;
            }
            if ((rb_state17.var_0) == (0x63026d5e)) {
                pthread_mutex_lock(&(rb_state17.lock_22));
                rb_state17.var_15 = 0xdd76815c;
                rb_state17.var_16 = (rb_state17.var_16) - (rb_state17.var_8);
                rb_state17.var_17 = (rb_state17.var_17) - (((((0x22f7766e) ^ (rb_state17.var_7)) ^ (rb_state17.var_9)) ^ (0x127a82f7)) + (rb_state17.var_15));
                rb_state17.var_18 = (rb_state17.var_18) - (rb_state17.var_16);
                rb_state17.var_19 = (rb_state17.var_19) + (((0xe7dbf214) - (rb_state17.var_17)) - (0x44d68e39));
                rb_state17.var_20 = (rb_state17.var_20) ^ (((rb_state17.var_10) == (0xd99c2d0c)) ? (rb_state17.var_18) : (0xd76eed88));
                rb_state17.var_21 = (rb_state17.var_21) ^ (((rb_state17.var_19) == (0xb109d9d0)) ? (rb_state17.var_20) : (0xa0f68f69));
                rb_state17.var_14 = (rb_state17.var_14) - (rb_state17.var_21);
