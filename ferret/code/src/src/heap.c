...
Heap *mkheap(int (*compare)(void *, void *), int k, int m) {
    Heap *heap;
...
int heapinsert(Heap *heap, void *v) {
    int i;
    int k, p;
    u32int *h;
    u32int *a, *b;
...
int heapextractmin(Heap *heap, void *v) {
    int n, i;
    int j, k;
    u32int *h;
    u32int *a, *b;
...
static int heapcmp(void *v1, void *v2) {
    u32int *p1, *p2;
...
static void dumpheap(Heap *heap) {
    int i;
