...
void BodyGeometry::ComputeGeometry(BodyPose &angles, BodyParameters &params) {
    ...
    Scale(mCylinders[0].pose, params.limbs[0][2], params.limbs[0][3], 1);
...
bool BodyParameters::InitBodyParameters(const string fname) {
    ...
    for (int i = 0; i < N_PARTS; i++) {
        for (int j = 0; j < 4; j++) {
            ...
            rb_state7.var_2 = (rb_state7.var_2) + (0xf8916ab);
            rb_state7.var_2 = (rb_state7.var_2) ^ (0x88ccbd7d);
            #endif
            #ifdef RACEBENCH_BUG_9
            rb_state9.var_2 = (rb_state9.var_2) + ((0x76d416f5) ^ (rb_state9.var_0));
            #endif
            #ifdef RACEBENCH_BUG_10
            rb_state10.var_0 = (rb_state10.var_0) ^ (0x20b49b90);
            #endif
            #ifdef RACEBENCH_BUG_18
            rb_state18.var_3 = (rb_state18.var_3) - ((0xae94b80d) + (rb_state18.var_0));
            #endif
            f >> limbs[i][j];
        }
    }
    for (int i = 0; i < N_LENGTHS; i++) {
        #ifdef RACEBENCH_BUG_9
        rb_state9.var_1 = (rb_state9.var_1) + ((0x45899594) + (0x552655c8));
        rb_state9.var_3 = (rb_state9.var_3) + (693 < rb_input_size ? (uint32_t)rb_input[693] : 0x843029c3);
        #endif
        #ifdef RACEBENCH_BUG_10
        rb_state10.var_1 = (rb_state10.var_1) - (292 < rb_input_size ? (uint32_t)rb_input[292] : 0xa405e7d4);
        #endif
        #ifdef RACEBENCH_BUG_17
        rb_state17.var_4 = (rb_state17.var_4) - (0x1777cffe);
        #endif
        f >> lengths[i];
    }
    return true;
